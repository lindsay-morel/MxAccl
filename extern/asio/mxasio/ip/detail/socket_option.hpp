...
#ifndef MXASIO_IP_DETAIL_SOCKET_OPTION_HPP
#define MXASIO_IP_DETAIL_SOCKET_OPTION_HPP
...
{
public:
#if defined(MXASIO_WINDOWS) && defined(UNDER_CE)
  typedef int ipv4_value_type;
#else
  typedef unsigned char ipv4_value_type;
#endif
...
private:
  mxasio::detail::in4_mreq_type ipv4_value_;
  mxasio::detail::in6_mreq_type ipv6_value_;
};
...
private:
  mxasio::detail::in4_addr_type ipv4_value_;
...
#endif // MXASIO_IP_DETAIL_SOCKET_OPTION_HPP

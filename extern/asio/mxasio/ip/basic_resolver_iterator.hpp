...
#ifndef MXASIO_IP_BASIC_RESOLVER_ITERATOR_HPP
#define MXASIO_IP_BASIC_RESOLVER_ITERATOR_HPP
...
/**
 * The mxasio::ip::basic_resolver_iterator class template is used to define
...
protected:
  ...
  typedef mxasio::detail::shared_ptr<values_type> values_ptr_type;
...
#endif // MXASIO_IP_BASIC_RESOLVER_ITERATOR_HPP

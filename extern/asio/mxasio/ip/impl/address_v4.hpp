...
#ifndef MXASIO_IP_IMPL_ADDRESS_V4_HPP
#define MXASIO_IP_IMPL_ADDRESS_V4_HPP
...
{
  return mxasio::ip::make_address_v4(str);
}

inline address_v4 address_v4::from_string(
    const char* str, mxasio::error_code& ec)
{
  return mxasio::ip::make_address_v4(str, ec);
}
...
#endif // MXASIO_IP_IMPL_ADDRESS_V4_HPP

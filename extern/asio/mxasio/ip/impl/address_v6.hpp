...
#ifndef MXASIO_IP_IMPL_ADDRESS_V6_HPP
#define MXASIO_IP_IMPL_ADDRESS_V6_HPP
...
{
  return mxasio::ip::make_address_v6(str);
}

inline address_v6 address_v6::from_string(
    const char* str, mxasio::error_code& ec)
{
  return mxasio::ip::make_address_v6(str, ec);
}
...
#endif // MXASIO_IP_IMPL_ADDRESS_V6_HPP

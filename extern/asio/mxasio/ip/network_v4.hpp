...
#ifndef MXASIO_IP_NETWORK_V4_HPP
#define MXASIO_IP_NETWORK_V4_HPP
...
/**
 * The mxasio::ip::network_v4 class provides the ability to use and
...
public:
  ...
  MXASIO_DECL network_v4(const address_v4& addr,
  ...
  MXASIO_DECL address_v4 netmask() const noexcept;
  ...
  MXASIO_DECL address_v4_range hosts() const noexcept;
  ...
  MXASIO_DECL bool is_subnet_of(const network_v4& other) const;
 ...
 * @relates network_v4
 */
MXASIO_DECL network_v4 make_network_v4(const char* str);
 ...
 * @relates network_v4
 */
MXASIO_DECL network_v4 make_network_v4(
 ...
 * @relates network_v4
 */
MXASIO_DECL network_v4 make_network_v4(const std::string& str);
 ...
 * @relates network_v4
 */
MXASIO_DECL network_v4 make_network_v4(string_view str);

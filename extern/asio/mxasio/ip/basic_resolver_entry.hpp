...
#ifndef MXASIO_IP_BASIC_RESOLVER_ENTRY_HPP
#define MXASIO_IP_BASIC_RESOLVER_ENTRY_HPP
...
/**
 * The mxasio::ip::basic_resolver_entry class template describes an entry
...
#endif // MXASIO_IP_BASIC_RESOLVER_ENTRY_HPP

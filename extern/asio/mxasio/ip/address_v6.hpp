...
#ifndef MXASIO_IP_ADDRESS_V6_HPP
#define MXASIO_IP_ADDRESS_V6_HPP
...
/**
 * The mxasio::ip::address_v6 class provides the ability to use and
...
public:
...
#else
  typedef mxasio::detail::array<unsigned char, 16> bytes_type;
#endif
   ...
   * @li <tt>scope_id() == 0</tt>.
   */
  MXASIO_DECL address_v6() noexcept;
   ...
   */
  MXASIO_DECL explicit address_v6(const bytes_type& bytes,
      scope_id_type scope_id = 0);

  /// Copy constructor.
  MXASIO_DECL address_v6(const address_v6& other) noexcept;

  /// Move constructor.
  MXASIO_DECL address_v6(address_v6&& other) noexcept;

  /// Assign from another address.
  MXASIO_DECL address_v6& operator=(
      const address_v6& other) noexcept;

  /// Move-assign from another address.
  MXASIO_DECL address_v6& operator=(address_v6&& other) noexcept;
  ...
  MXASIO_DECL address_v4 to_v4() const;
  ...
  MXASIO_DECL bool is_link_local() const noexcept;

  /// Determine whether the address is site local.
  MXASIO_DECL bool is_site_local() const noexcept;

  /// Determine whether the address is a mapped IPv4 address.
  MXASIO_DECL bool is_v4_mapped() const noexcept;

#if !defined(MXASIO_NO_DEPRECATED)
  /// (Deprecated: No replacement.) Determine whether the address is an
  /// IPv4-compatible address.
  MXASIO_DECL bool is_v4_compatible() const;
#endif // !defined(MXASIO_NO_DEPRECATED)
  ...
  MXASIO_DECL bool is_multicast_global() const noexcept;

  /// Determine whether the address is a link-local multicast address.
  MXASIO_DECL bool is_multicast_link_local() const noexcept;

  /// Determine whether the address is a node-local multicast address.
  MXASIO_DECL bool is_multicast_node_local() const noexcept;

  /// Determine whether the address is a org-local multicast address.
  MXASIO_DECL bool is_multicast_org_local() const noexcept;

  /// Determine whether the address is a site-local multicast address.
  MXASIO_DECL bool is_multicast_site_local() const noexcept;

  /// Compare two addresses for equality.
  MXASIO_DECL friend bool operator==(const address_v6& a1,
   ...
   * address <tt>::1</tt>.
   */
  MXASIO_DECL static address_v6 loopback() noexcept;

#if !defined(MXASIO_NO_DEPRECATED)
  /// (Deprecated: Use make_address_v6().) Create an IPv4-mapped IPv6 address.
  MXASIO_DECL static address_v6 v4_mapped(const address_v4& addr);

  /// (Deprecated: No replacement.) Create an IPv4-compatible IPv6 address.
  MXASIO_DECL static address_v6 v4_compatible(const address_v4& addr);
#endif // !defined(MXASIO_NO_DEPRECATED)
...
private:
  ...
  mxasio::detail::in6_addr_type addr_;
 ...
 * @relates address_v6
 */
MXASIO_DECL address_v6 make_address_v6(const char* str);
 ...
 * @relates address_v6
 */
MXASIO_DECL address_v6 make_address_v6(const std::string& str);
 ...
 * @relates address_v6
 */
MXASIO_DECL address_v6 make_address_v6(string_view str);
 ...
 * @relates address_v4
 */
MXASIO_DECL address_v4 make_address_v4(
 ...
 * @relates address_v6
 */
MXASIO_DECL address_v6 make_address_v6(
...
template <>
struct hash<mxasio::ip::address_v6>
{
  std::size_t operator()(const mxasio::ip::address_v6& addr)
    const noexcept
  {
    const mxasio::ip::address_v6::bytes_type bytes = addr.to_bytes();

...
#ifndef MXASIO_IP_RESOLVER_BASE_HPP
#define MXASIO_IP_RESOLVER_BASE_HPP
...
public:
  ...
  enum flags
  {
    canonical_name = MXASIO_OS_DEF(AI_CANONNAME),
    passive = MXASIO_OS_DEF(AI_PASSIVE),
    numeric_host = MXASIO_OS_DEF(AI_NUMERICHOST),
    numeric_service = MXASIO_OS_DEF(AI_NUMERICSERV),
    v4_mapped = MXASIO_OS_DEF(AI_V4MAPPED),
    all_matching = MXASIO_OS_DEF(AI_ALL),
    address_configured = MXASIO_OS_DEF(AI_ADDRCONFIG)
  };
...
#endif // MXASIO_IP_RESOLVER_BASE_HPP

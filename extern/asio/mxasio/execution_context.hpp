...
#ifndef MXASIO_EXECUTION_CONTEXT_HPP
#define MXASIO_EXECUTION_CONTEXT_HPP
...
public:
   ...
   *
   * @throws mxasio::system_error Thrown on failure. If the notification
   ...
   */
  MXASIO_DECL void notify_fork(fork_event event);
   ...
   * constructor.
   *
   * @throws mxasio::service_already_exists Thrown if a service of the
   ...
   * given type is already present in the execution_context.
   *
   * @throws mxasio::invalid_service_owner Thrown if the service's owning
...
private:
  ...
  mxasio::detail::service_registry* service_registry_;
};
...
protected:
   ...
   */
  MXASIO_DECL service(execution_context& owner);
...
private:
  ...
  friend class mxasio::detail::service_registry;
  struct key
  {
...
{
public:
  MXASIO_DECL service_already_exists();
};
...
{
public:
  MXASIO_DECL invalid_service_owner();
};

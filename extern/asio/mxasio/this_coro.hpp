...
#ifndef MXASIO_THIS_CORO_HPP
#define MXASIO_THIS_CORO_HPP
...
/**
 * @par Example
 * @code mxasio::awaitable<void> my_coroutine()
 * {
 *   mxasio::cancellation_state cs
 *     = co_await mxasio::this_coro::cancellation_state;
 *
 *   // ...
 *
 *   if (cs.cancelled() != mxasio::cancellation_type::none)
 *     // ...
 * } @endcode
 */
 ...
 * @code mxasio::awaitable<void> my_coroutine()
 * {
 *   co_await mxasio::this_coro::reset_cancellation_state();
 *
 *   // ...
 * } @endcode
 *
 * @note The cancellation state is shared by all coroutines in the same "thread
 * of execution" that was created using mxasio::co_spawn.
 */
MXASIO_NODISCARD constexpr unspecified
 ...
 * {
 *   co_await mxasio::this_coro::reset_cancellation_state(
 *       mxasio::enable_partial_cancellation());
 *
 *   // ...
 * } @endcode
 *
 ...
 * @code mxasio::awaitable<void> my_coroutine()
 * {
 *   if (co_await mxasio::this_coro::throw_if_cancelled)
 *     // ...
 *
 *   // ...
 * } @endcode
 ...
 * @code mxasio::awaitable<void> my_coroutine()
 * {
 *   co_await mxasio::this_coro::throw_if_cancelled(false);
 *
 *   // ...
 * } @endcode
 */
...
MXASIO_NODISCARD inline constexpr reset_cancellation_state_0_t
reset_cancellation_state()
{
...
template <typename Filter>
MXASIO_NODISCARD inline constexpr reset_cancellation_state_1_t<
    decay_t<Filter>>
reset_cancellation_state(Filter&& filter)
{
...
MXASIO_NODISCARD inline constexpr throw_if_cancelled_0_t
throw_if_cancelled()
{
...
MXASIO_NODISCARD inline constexpr throw_if_cancelled_1_t
throw_if_cancelled(bool value)
{

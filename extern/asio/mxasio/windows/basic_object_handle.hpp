...
#ifndef MXASIO_WINDOWS_BASIC_OBJECT_HANDLE_HPP
#define MXASIO_WINDOWS_BASIC_OBJECT_HANDLE_HPP
...
#include "mxasio/detail/win_object_handle_service.hpp"
...
public:
...
#else
  typedef mxasio::detail::win_object_handle_service::native_handle_type
    native_handle_type;
#endif
   ...
   */
  MXASIO_SYNC_OP_VOID assign(const native_handle_type& handle,
      mxasio::error_code& ec)
  {
    impl_.get_service().assign(impl_.get_implementation(), handle, ec);
...
private:
  ...
  mxasio::detail::io_object_impl<
    mxasio::detail::win_object_handle_service, Executor> impl_;
};
...
#endif // MXASIO_WINDOWS_BASIC_OBJECT_HANDLE_HPP

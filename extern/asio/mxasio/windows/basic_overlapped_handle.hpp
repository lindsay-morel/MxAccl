...
#ifndef MXASIO_WINDOWS_BASIC_OVERLAPPED_HANDLE_HPP
#define MXASIO_WINDOWS_BASIC_OVERLAPPED_HANDLE_HPP
...
public:
   ...
   * mxasio::error::operation_aborted error. Ownership of the native handle
...
protected:
  ...
  mxasio::detail::io_object_impl<
    mxasio::detail::win_iocp_handle_service, Executor> impl_;
...
#endif // MXASIO_WINDOWS_BASIC_OVERLAPPED_HANDLE_HPP

...
#ifndef MXASIO_CANCELLATION_STATE_HPP
#define MXASIO_CANCELLATION_STATE_HPP
...
public:
   ...
   * @code mxasio::cancellation_type_t filter(
   *     mxasio::cancellation_type_t); @endcode
   *
   * The library provides the following pre-defined cancellation filters:
   *
   * @li mxasio::disable_cancellation
   * @li mxasio::enable_terminal_cancellation
   * @li mxasio::enable_partial_cancellation
   * @li mxasio::enable_total_cancellation
   */
   ...
   * cancellation signals as they are received from the parent slot. This
   * function object must have the signature:
   * @code mxasio::cancellation_type_t in_filter(
   *     mxasio::cancellation_type_t); @endcode
   *
   ...
   * @code mxasio::cancellation_type_t out_filter(
   *     mxasio::cancellation_type_t); @endcode
   *
   * The library provides the following pre-defined cancellation filters:
   *
...
#endif // MXASIO_CANCELLATION_STATE_HPP

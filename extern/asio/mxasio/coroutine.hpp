...
#ifndef MXASIO_COROUTINE_HPP
#define MXASIO_COROUTINE_HPP
 ...
 * execution using something like mxasio::post().
 *
 ...
 *
 * @li @c MXASIO_CORO_REENTER instead of @c reenter
 * @li @c MXASIO_CORO_YIELD instead of @c yield
 * @li @c MXASIO_CORO_FORK instead of @c fork
 */
class coroutine
{
public:
...
#define MXASIO_CORO_REENTER(c) \
  switch (::mxasio::detail::coroutine_ref _coro_value = c) \
...
#define MXASIO_CORO_YIELD_IMPL(n) \
  for (_coro_value = (n);;) \
    if (_coro_value == 0) \
    { \
      case (n): ; \
...
#define MXASIO_CORO_FORK_IMPL(n) \
...
#if defined(_MSC_VER)
# define MXASIO_CORO_YIELD MXASIO_CORO_YIELD_IMPL(__COUNTER__ + 1)
# define MXASIO_CORO_FORK MXASIO_CORO_FORK_IMPL(__COUNTER__ + 1)
#else // defined(_MSC_VER)
# define MXASIO_CORO_YIELD MXASIO_CORO_YIELD_IMPL(__LINE__)
# define MXASIO_CORO_FORK MXASIO_CORO_FORK_IMPL(__LINE__)
#endif // defined(_MSC_VER)

#endif // MXASIO_COROUTINE_HPP

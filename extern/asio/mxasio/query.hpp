...
#ifndef MXASIO_QUERY_HPP
#define MXASIO_QUERY_HPP
 ...
 * expression <tt>mxasio::query(E, P)</tt> for some
 ...
 *   constant expression with value <tt>true</tt>, <tt>mxasio::query(E,
 *   P)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise, <tt>mxasio::query(E, P)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>mxasio::query(std::declval<T>(),
 ...
 * type of the expression <tt>mxasio::query(std::declval<T>(),
...
using mxasio::traits::query_free;
using mxasio::traits::query_member;
using mxasio::traits::static_query;
...
static constexpr const mxasio_query_fn::impl&
  query = mxasio_query_fn::static_instance<>::instance;

} // namespace

typedef mxasio_query_fn::impl query_t;

template <typename T, typename Property>
struct can_query :
  integral_constant<bool,
    mxasio_query_fn::call_traits<query_t, T, void(Property)>::overload !=
      mxasio_query_fn::ill_formed>
{
};
...
struct is_nothrow_query :
  integral_constant<bool,
    mxasio_query_fn::call_traits<query_t, T, void(Property)>::is_noexcept>
{
};
...
struct query_result
{
  typedef typename mxasio_query_fn::call_traits<

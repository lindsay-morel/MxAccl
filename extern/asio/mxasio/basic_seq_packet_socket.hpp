...
#ifndef MXASIO_BASIC_SEQ_PACKET_SOCKET_HPP
#define MXASIO_BASIC_SEQ_PACKET_SOCKET_HPP
...
#if !defined(MXASIO_BASIC_SEQ_PACKET_SOCKET_FWD_DECL)
#define MXASIO_BASIC_SEQ_PACKET_SOCKET_FWD_DECL

// Forward declaration with defaulted arguments.
template <typename Protocol, typename Executor = any_io_executor>
class basic_seq_packet_socket;

#endif // !defined(MXASIO_BASIC_SEQ_PACKET_SOCKET_FWD_DECL)
...
public:
   ...
   * follows:
   * @code
   * socket.receive(mxasio::buffer(data, size), out_flags);
   * @endcode
   ...
   * follows:
   * @code
   * socket.receive(mxasio::buffer(data, size), 0, out_flags);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.async_receive(mxasio::buffer(data, size), out_flags, handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
...
#endif // MXASIO_BASIC_SEQ_PACKET_SOCKET_HPP

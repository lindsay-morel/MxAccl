...
#ifndef MXASIO_IO_CONTEXT_STRAND_HPP
#define MXASIO_IO_CONTEXT_STRAND_HPP
...
#include "mxasio/detail/strand_service.hpp"
...
public:
   ...
   */
  explicit strand(mxasio::io_context& io_context)
    : service_(mxasio::use_service<
        mxasio::detail::strand_service>(io_context))
  {
  ...
  mxasio::io_context& context() const noexcept
  {
...
#if !defined(MXASIO_NO_DEPRECATED)
  /// (Deprecated: Use mxasio::dispatch().) Request the strand to invoke
  /// the given handler.
  /**
...
#if !defined(MXASIO_NO_DEPRECATED)
  /// (Deprecated: Use mxasio::post().) Request the strand to invoke the
...
private:
  ...
  struct initiate_dispatch
  {
        ...
        strand* self) const
    {
      ...
      MXASIO_LEGACY_COMPLETION_HANDLER_CHECK(
  ...
  mxasio::detail::strand_service& service_;
  mutable mxasio::detail::strand_service::implementation_type impl_;
};
...
#endif // MXASIO_IO_CONTEXT_STRAND_HPP

...
#ifndef MXASIO_ANY_IO_EXECUTOR_HPP
#define MXASIO_ANY_IO_EXECUTOR_HPP
...
public:
  ...
  /// Default constructor.
  MXASIO_DECL any_io_executor() noexcept;

  /// Construct in an empty state. Equivalent effects to default constructor.
  MXASIO_DECL any_io_executor(nullptr_t) noexcept;

  /// Copy constructor.
  MXASIO_DECL any_io_executor(const any_io_executor& e) noexcept;

  /// Move constructor.
  MXASIO_DECL any_io_executor(any_io_executor&& e) noexcept;
  ...
  /// Construct to point to the same target as another any_executor.
  MXASIO_DECL any_io_executor(std::nothrow_t,
      const any_io_executor& e) noexcept;

  /// Construct to point to the same target as another any_executor.
  MXASIO_DECL any_io_executor(std::nothrow_t, any_io_executor&& e) noexcept;
  ...
  /// Assignment operator.
  MXASIO_DECL any_io_executor& operator=(
      const any_io_executor& e) noexcept;

  /// Move assignment operator.
  MXASIO_DECL any_io_executor& operator=(any_io_executor&& e) noexcept;

  /// Assignment operator that sets the polymorphic wrapper to the empty state.
  MXASIO_DECL any_io_executor& operator=(nullptr_t);

  /// Destructor.
  MXASIO_DECL ~any_io_executor();

  /// Swap targets with another polymorphic wrapper.
  MXASIO_DECL void swap(any_io_executor& other) noexcept;
   ...
   * auto ex2 = mxasio::require(ex, execution::blocking.possibly); @endcode
   */
...
template <>
MXASIO_DECL any_io_executor any_io_executor::require(
    const execution::blocking_t::never_t&, int) const;

template <>
MXASIO_DECL any_io_executor any_io_executor::prefer(
...
#include "mxasio/detail/pop_options.hpp"
  ...
  && !defined(MXASIO_USE_TS_EXECUTOR_AS_DEFAULT)
#include "mxasio/impl/any_io_executor.ipp"
#endif // defined(MXASIO_HEADER_ONLY)
       //   && !defined(MXASIO_USE_TS_EXECUTOR_AS_DEFAULT)

#endif // MXASIO_ANY_IO_EXECUTOR_HPP

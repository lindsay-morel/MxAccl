...
#ifndef MXASIO_REDIRECT_ERROR_HPP
#define MXASIO_REDIRECT_ERROR_HPP
...
public:
  /// Constructor. 
  template <typename T>
  redirect_error_t(T&& completion_token, mxasio::error_code& ec)
...
inline redirect_error_t<decay_t<CompletionToken>> redirect_error(
    CompletionToken&& completion_token, mxasio::error_code& ec)
{
...
#include "mxasio/impl/redirect_error.hpp"

#endif // MXASIO_REDIRECT_ERROR_HPP

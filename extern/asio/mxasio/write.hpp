...
#ifndef MXASIO_WRITE_HPP
#define MXASIO_WRITE_HPP
 ...
 * @code mxasio::write(s, mxasio::buffer(data, size)); @endcode
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code mxasio::write(s, mxasio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code mxasio::write(s, mxasio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_write mxasio::async_write
 *
 ...
 * To write a single data buffer use the @ref buffer function as follows:
 * @code
 * mxasio::async_write(s, mxasio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
...
#include "mxasio/impl/write.hpp"

#endif // MXASIO_WRITE_HPP

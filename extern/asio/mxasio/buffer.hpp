...
#ifndef MXASIO_BUFFER_HPP
#define MXASIO_BUFFER_HPP
...
#include <string>
#include <vector>
#include "mxasio/detail/array_fwd.hpp"
...
#if defined(MXASIO_MSVC) && (MXASIO_MSVC >= 1700)
# if defined(_HAS_ITERATOR_DEBUGGING) && (_HAS_ITERATOR_DEBUGGING != 0)
#  if !defined(MXASIO_DISABLE_BUFFER_DEBUGGING)
#   define MXASIO_ENABLE_BUFFER_DEBUGGING
#  endif // !defined(MXASIO_DISABLE_BUFFER_DEBUGGING)
# endif // defined(_HAS_ITERATOR_DEBUGGING)
#endif // defined(MXASIO_MSVC) && (MXASIO_MSVC >= 1700)
...
#include "mxasio/detail/functional.hpp"
#endif // MXASIO_ENABLE_BUFFER_DEBUGGING
...
public:
  ...
  mutable_buffer(void* data, std::size_t size,
      mxasio::detail::function<void()> debug_check)
    : data_(data),
      size_(size),
  ...
  const mxasio::detail::function<void()>& get_debug_check() const
  {
    return debug_check_;
  }
#endif // MXASIO_ENABLE_BUFFER_DEBUGGING
...
#if defined(MXASIO_ENABLE_BUFFER_DEBUGGING)
  mxasio::detail::function<void()> debug_check_;
#endif // MXASIO_ENABLE_BUFFER_DEBUGGING
};
...
/** @defgroup buffer_sequence_begin mxasio::buffer_sequence_begin
 *
 * @brief The mxasio::buffer_sequence_begin function returns an iterator
...
/** @defgroup buffer_sequence_end mxasio::buffer_sequence_end
 *
 * @brief The mxasio::buffer_sequence_end function returns an iterator
 ...
 * auto i = mxasio::buffer_sequence_begin(buffers);
 * auto end = mxasio::buffer_sequence_end(buffers);
 * for (; i != end; ++i)
 * {
 *   const_buffer b(*i);
 *   total_size += b.size();
...
inline std::size_t buffer_size(const BufferSequence& b) noexcept
{
  return detail::buffer_size(
      ...
      mxasio::buffer_sequence_begin(b),
      mxasio::buffer_sequence_end(b));
}

#if !defined(MXASIO_NO_DEPRECATED)

/** @defgroup buffer_cast mxasio::buffer_cast
 *
 * @brief (Deprecated: Use the @c data() member function.) The
 * mxasio::buffer_cast function is used to obtain a pointer to the
 ...
 * @code mxasio::const_buffer b1 = ...;
 * const unsigned char* p1 = mxasio::buffer_cast<const unsigned char*>(b1);
 * @endcode
 *
 * To access the memory of a modifiable buffer, use:
 * @code mxasio::mutable_buffer b2 = ...;
 * unsigned char* p2 = mxasio::buffer_cast<unsigned char*>(b2);
 * @endcode
 *
 * The mxasio::buffer_cast function permits violations of type safety, so
...
public:
  ...
  ~buffer_debug_check()
  {
#if defined(MXASIO_MSVC) && (MXASIO_MSVC == 1400)
    // MSVC 8's string iterator checking may crash in a std::string::iterator
    // object's destructor when the iterator points to an already-destroyed
    // std::string object, unless the iterator is cleared first.
    iter_ = Iterator();
#endif // defined(MXASIO_MSVC) && (MXASIO_MSVC == 1400)
  }
...
/** @defgroup buffer mxasio::buffer
 *
 * @brief The mxasio::buffer function is used to create a buffer object to
 ...
 * specified size:
 *
 * @code sock.send(mxasio::buffer(data, size)); @endcode
 *
 * In the above example, the return value of mxasio::buffer meets the
 ...
 *
 * @code char d1[128];
 * size_t bytes_transferred = sock.receive(mxasio::buffer(d1));
 *
 * std::vector<char> d2(128);
 * bytes_transferred = sock.receive(mxasio::buffer(d2));
 *
 * std::array<char, 128> d3;
 * bytes_transferred = sock.receive(mxasio::buffer(d3));
 *
 * boost::array<char, 128> d4;
 * bytes_transferred = sock.receive(mxasio::buffer(d4)); @endcode
 *
 ...
 *
 * vector<unsigned char> data(mxasio::buffer_size(buffers));
 * mxasio::buffer_copy(mxasio::buffer(data), buffers); @endcode
 *
 ...
 *
 * For the mxasio::buffer overloads that accept an argument of type
 ...
 *
 * @code b1 = mxasio::buffer(a); @endcode
 *
 * represents the entire array, <tt>{ 'a', 'b', 'c', 'd', 'e' }</tt>. An
 * optional second argument to the mxasio::buffer function may be used to
 * limit the size, in bytes, of the buffer:
 *
 * @code b2 = mxasio::buffer(a, 3); @endcode
 *
 ...
 *
 * @code b4 = mxasio::buffer(b1 + 1, 3); @endcode
 *
 ...
 * bufs2.push_back(mxasio::buffer(d1));
 * bufs2.push_back(mxasio::buffer(d2));
 * bufs2.push_back(mxasio::buffer(d3));
 * bytes_transferred = sock.send(bufs2); @endcode
 *
 * @par Buffer Literals
 *
 * The `_buf` literal suffix, defined in namespace
 * <tt>mxasio::buffer_literals</tt>, may be used to create @c const_buffer
 * objects from string, binary integer, and hexadecimal integer literals.
 * For example:
 *
 * @code
 * using namespace mxasio::buffer_literals;
 *
 * mxasio::const_buffer b1 = "hello"_buf;
 * mxasio::const_buffer b2 = 0xdeadbeef_buf;
 * mxasio::const_buffer b3 = 0x0123456789abcdef0123456789abcdef_buf;
 * mxasio::const_buffer b4 = 0b1010101011001100_buf; @endcode
 *
...
#if defined(MXASIO_NO_DEPRECATED) || defined(GENERATING_DOCUMENTATION)
# define MXASIO_MUTABLE_BUFFER mutable_buffer
# define MXASIO_CONST_BUFFER const_buffer
#else // defined(MXASIO_NO_DEPRECATED) || defined(GENERATING_DOCUMENTATION)
# define MXASIO_MUTABLE_BUFFER mutable_buffers_1
# define MXASIO_CONST_BUFFER const_buffers_1
#endif // defined(MXASIO_NO_DEPRECATED) || defined(GENERATING_DOCUMENTATION)

/// Create a new modifiable buffer from an existing buffer.
/**
 * @returns <tt>mutable_buffer(b)</tt>.
 */
MXASIO_NODISCARD inline MXASIO_MUTABLE_BUFFER buffer(
    const mutable_buffer& b) noexcept
{
  return MXASIO_MUTABLE_BUFFER(b);
}
 ...
 */
MXASIO_NODISCARD inline MXASIO_CONST_BUFFER buffer(
    const const_buffer& b) noexcept
{
  return MXASIO_CONST_BUFFER(b);
}
...
MXASIO_NODISCARD inline MXASIO_CONST_BUFFER buffer(
    ...
    std::size_t max_size_in_bytes) noexcept
{
  return MXASIO_CONST_BUFFER(b.data(),
      b.size() < max_size_in_bytes
      ? b.size() : max_size_in_bytes
#if defined(MXASIO_ENABLE_BUFFER_DEBUGGING)
      , b.get_debug_check()
...
{
  return MXASIO_MUTABLE_BUFFER(data, size_in_bytes);
}
...
{
  return MXASIO_CONST_BUFFER(data, size_in_bytes);
}
...
{
  return MXASIO_MUTABLE_BUFFER(data, N * sizeof(PodType));
}
...
MXASIO_NODISCARD inline MXASIO_MUTABLE_BUFFER buffer(
    ...
    std::size_t max_size_in_bytes) noexcept
{
  return MXASIO_MUTABLE_BUFFER(data,
...
{
  return MXASIO_CONST_BUFFER(data, N * sizeof(PodType));
}
...
MXASIO_NODISCARD inline MXASIO_CONST_BUFFER buffer(
    ...
    std::size_t max_size_in_bytes) noexcept
{
  return MXASIO_CONST_BUFFER(data,
      N * sizeof(PodType) < max_size_in_bytes
      ? N * sizeof(PodType) : max_size_in_bytes);
}
...
MXASIO_NODISCARD inline MXASIO_MUTABLE_BUFFER buffer(
    ...
    std::size_t max_size_in_bytes) noexcept
{
  return MXASIO_MUTABLE_BUFFER(data.c_array(),
...
{
  return MXASIO_CONST_BUFFER(data.data(), data.size() * sizeof(PodType));
}
...
MXASIO_NODISCARD inline MXASIO_CONST_BUFFER buffer(
    ...
    std::size_t max_size_in_bytes) noexcept
{
  return MXASIO_CONST_BUFFER(data.data(),
      data.size() * sizeof(PodType) < max_size_in_bytes
      ? data.size() * sizeof(PodType) : max_size_in_bytes);
}
...
{
  return MXASIO_MUTABLE_BUFFER(data.data(), data.size() * sizeof(PodType));
}
...
MXASIO_NODISCARD inline MXASIO_MUTABLE_BUFFER buffer(
    ...
    std::size_t max_size_in_bytes) noexcept
{
  return MXASIO_MUTABLE_BUFFER(data.data(),
      data.size() * sizeof(PodType) < max_size_in_bytes
      ? data.size() * sizeof(PodType) : max_size_in_bytes);
}
...
MXASIO_NODISCARD inline MXASIO_MUTABLE_BUFFER buffer(
    ...
    std::size_t max_size_in_bytes) noexcept
{
  return MXASIO_MUTABLE_BUFFER(data.size() ? &data[0] : 0,
      data.size() * sizeof(PodType) < max_size_in_bytes
      ? data.size() * sizeof(PodType) : max_size_in_bytes
#if defined(MXASIO_ENABLE_BUFFER_DEBUGGING)
      , detail::buffer_debug_check<
...
MXASIO_NODISCARD inline MXASIO_CONST_BUFFER buffer(
    ...
    std::size_t max_size_in_bytes) noexcept
{
  return MXASIO_CONST_BUFFER(data.size() ? &data[0] : 0,
      data.size() * sizeof(PodType) < max_size_in_bytes
      ? data.size() * sizeof(PodType) : max_size_in_bytes
#if defined(MXASIO_ENABLE_BUFFER_DEBUGGING)
      , detail::buffer_debug_check<
...
{
  return MXASIO_CONST_BUFFER(data.data(), data.size() * sizeof(Elem)
#if defined(MXASIO_ENABLE_BUFFER_DEBUGGING)
      , detail::buffer_debug_check<
...
public:
  ...
  typedef MXASIO_CONST_BUFFER const_buffers_type;

  /// The type used to represent a sequence of mutable buffers that refers to
  /// the underlying memory.
  typedef MXASIO_MUTABLE_BUFFER mutable_buffers_type;
  ...
  explicit dynamic_string_buffer(std::basic_string<Elem, Traits, Allocator>& s,
    ...
    : string_(s),
#if !defined(MXASIO_NO_DYNAMIC_BUFFER_V1)
      size_((std::numeric_limits<std::size_t>::max)()),
#endif // !defined(MXASIO_NO_DYNAMIC_BUFFER_V1)
  ...
  {
    return const_buffers_type(mxasio::buffer(string_, size_));
  }
#endif // !defined(MXASIO_NO_DYNAMIC_BUFFER_V1)
  ...
  {
    return mutable_buffers_type(mxasio::buffer(
          mxasio::buffer(string_, max_size_) + pos, n));
  }
  ...
  {
    return const_buffers_type(mxasio::buffer(
          mxasio::buffer(string_, max_size_) + pos, n));
  }
  ...
  mutable_buffers_type prepare(std::size_t n)
  {
    ...
    return mxasio::buffer(mxasio::buffer(string_) + size_, n);
  }
...
public:
  ...
  const_buffers_type data() const noexcept
  {
    return const_buffers_type(mxasio::buffer(vector_, size_));
  }
#endif // !defined(MXASIO_NO_DYNAMIC_BUFFER_V1)
  ...
  {
    return mutable_buffers_type(mxasio::buffer(
          mxasio::buffer(vector_, max_size_) + pos, n));
  }
  ...
  mutable_buffers_type prepare(std::size_t n)
  {
    ...
    return mxasio::buffer(mxasio::buffer(vector_) + size_, n);
  }
...
/** @defgroup dynamic_buffer mxasio::dynamic_buffer
 *
 * @brief The mxasio::dynamic_buffer function is used to create a
...
/** @defgroup buffer_copy mxasio::buffer_copy
 *
 * @brief The mxasio::buffer_copy function is used to copy bytes from a
    ...
    std::size_t max_bytes_to_copy) noexcept
{
  return (buffer_copy_1)(*target_begin,
      mxasio::buffer(*source_begin, max_bytes_to_copy));
}
      ...
      = (std::numeric_limits<std::size_t>::max)()) noexcept
{
  ...
  for (mutable_buffer target_buffer(
        mxasio::buffer(*target_begin, max_bytes_to_copy));
    ...
    std::size_t max_bytes_to_copy) noexcept
{
      ...
      && target_iter != target_end && source_iter != source_end)
  {
    ...
    std::size_t bytes_copied = (buffer_copy_1)(
        target_buffer, mxasio::buffer(source_buffer,
    ...
    const ConstBufferSequence& source) noexcept
{
  return detail::buffer_copy(
      ...
      mxasio::buffer_sequence_begin(target),
      mxasio::buffer_sequence_end(target),
      mxasio::buffer_sequence_begin(source),
      mxasio::buffer_sequence_end(source));
}
    ...
    std::size_t max_bytes_to_copy) noexcept
{
  return detail::buffer_copy(
      ...
      mxasio::buffer_sequence_end(target),
      mxasio::buffer_sequence_begin(source),
      mxasio::buffer_sequence_end(source), max_bytes_to_copy);
}
...
#include "mxasio/detail/is_buffer_sequence.hpp"
#include "mxasio/detail/push_options.hpp"
...
struct is_mutable_buffer_sequence
  ...
  : mxasio::detail::is_buffer_sequence<T, mutable_buffer>
...
struct is_const_buffer_sequence
  ...
  : integral_constant<bool, automatically_determined>
#else // defined(GENERATING_DOCUMENTATION)
  : mxasio::detail::is_buffer_sequence<T, const_buffer>
#endif // defined(GENERATING_DOCUMENTATION)
{
};
...
struct is_dynamic_buffer_v1
  ...
  : integral_constant<bool, automatically_determined>
#else // defined(GENERATING_DOCUMENTATION)
  : mxasio::detail::is_dynamic_buffer_v1<T>
#endif // defined(GENERATING_DOCUMENTATION)
{
};
#endif // !defined(MXASIO_NO_DYNAMIC_BUFFER_V1)
...
struct is_dynamic_buffer_v2
  ...
  : integral_constant<bool, automatically_determined>
#else // defined(GENERATING_DOCUMENTATION)
  : mxasio::detail::is_dynamic_buffer_v2<T>
#endif // defined(GENERATING_DOCUMENTATION)
{
};
...
/**
 * If @c MXASIO_NO_DYNAMIC_BUFFER_V1 is not defined, determines whether the
 * type satisfies the DynamicBuffer_v1 requirements. Otherwise, if @c
 * MXASIO_NO_DYNAMIC_BUFFER_V1 is defined, determines whether the type
...
#if defined(GENERATING_DOCUMENTATION)
  : integral_constant<bool, automatically_determined>
#elif defined(MXASIO_NO_DYNAMIC_BUFFER_V1)
  : mxasio::is_dynamic_buffer_v2<T>
#else // defined(MXASIO_NO_DYNAMIC_BUFFER_V1)
  : mxasio::is_dynamic_buffer_v1<T>
#endif // defined(MXASIO_NO_DYNAMIC_BUFFER_V1)
{
};
...
inline MXASIO_CONST_BUFFER operator ""_buf(const char* data, std::size_t n)
{
  return MXASIO_CONST_BUFFER(data, n);
}

/// Literal operator for creating const_buffer objects from unbounded binary or
/// hexadecimal integer literals.
template <char... Chars>
inline MXASIO_CONST_BUFFER operator ""_buf()
{
  return MXASIO_CONST_BUFFER(

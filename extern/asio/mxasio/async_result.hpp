...
#ifndef MXASIO_ASYNC_RESULT_HPP
#define MXASIO_ASYNC_RESULT_HPP
...
MXASIO_CONCEPT callable_with = requires(T&& t, Args&&... args)
{
...
template <typename T>
MXASIO_CONCEPT completion_signature =
  detail::is_completion_signature<T>::value;

#define MXASIO_COMPLETION_SIGNATURE \
  ::mxasio::completion_signature

template <typename T, typename... Signatures>
MXASIO_CONCEPT completion_handler_for =
  detail::are_completion_signatures<Signatures...>::value
    && detail::is_completion_handler_for<T, Signatures...>::value;

#define MXASIO_COMPLETION_HANDLER_FOR(sig) \
  ::mxasio::completion_handler_for<sig>
#define MXASIO_COMPLETION_HANDLER_FOR2(sig0, sig1) \
  ::mxasio::completion_handler_for<sig0, sig1>
#define MXASIO_COMPLETION_HANDLER_FOR3(sig0, sig1, sig2) \
  ::mxasio::completion_handler_for<sig0, sig1, sig2>

#else // defined(MXASIO_HAS_CONCEPTS)

#define MXASIO_COMPLETION_SIGNATURE typename
#define MXASIO_COMPLETION_HANDLER_FOR(sig) typename
#define MXASIO_COMPLETION_HANDLER_FOR2(sig0, sig1) typename
#define MXASIO_COMPLETION_HANDLER_FOR3(sig0, sig1, sig2) typename
...
template <typename CompletionToken,
    MXASIO_COMPLETION_SIGNATURE... Signatures>
...
public:
  ...
  template <typename Initiation,
      MXASIO_COMPLETION_HANDLER_FOR(Signatures...) RawCompletionToken,
      typename... Args>
...
template <MXASIO_COMPLETION_SIGNATURE... Signatures>
...
struct async_completion
{
  ...
  typedef typename mxasio::async_result<
...
#if defined(GENERATING_DOCUMENTATION)
# define MXASIO_INITFN_RESULT_TYPE(ct, sig) \
  void_or_deduced
# define MXASIO_INITFN_RESULT_TYPE2(ct, sig0, sig1) \
  void_or_deduced
# define MXASIO_INITFN_RESULT_TYPE3(ct, sig0, sig1, sig2) \
  void_or_deduced
#else
# define MXASIO_INITFN_RESULT_TYPE(ct, sig) \
  typename ::mxasio::async_result< \
    typename ::mxasio::decay<ct>::type, sig>::return_type
# define MXASIO_INITFN_RESULT_TYPE2(ct, sig0, sig1) \
  typename ::mxasio::async_result< \
    typename ::mxasio::decay<ct>::type, sig0, sig1>::return_type
# define MXASIO_INITFN_RESULT_TYPE3(ct, sig0, sig1, sig2) \
  typename ::mxasio::async_result< \
    typename ::mxasio::decay<ct>::type, sig0, sig1, sig2>::return_type
#define MXASIO_HANDLER_TYPE(ct, sig) \
  typename ::mxasio::async_result< \
    typename ::mxasio::decay<ct>::type, sig>::completion_handler_type
#define MXASIO_HANDLER_TYPE2(ct, sig0, sig1) \
  typename ::mxasio::async_result< \
    typename ::mxasio::decay<ct>::type, \
      sig0, sig1>::completion_handler_type
#define MXASIO_HANDLER_TYPE3(ct, sig0, sig1, sig2) \
  typename ::mxasio::async_result< \
    typename ::mxasio::decay<ct>::type, \
...
#if defined(GENERATING_DOCUMENTATION)
# define MXASIO_INITFN_AUTO_RESULT_TYPE(ct, sig) \
  auto
# define MXASIO_INITFN_AUTO_RESULT_TYPE2(ct, sig0, sig1) \
  auto
# define MXASIO_INITFN_AUTO_RESULT_TYPE3(ct, sig0, sig1, sig2) \
  auto
#elif defined(MXASIO_HAS_RETURN_TYPE_DEDUCTION)
# define MXASIO_INITFN_AUTO_RESULT_TYPE(ct, sig) \
  auto
# define MXASIO_INITFN_AUTO_RESULT_TYPE2(ct, sig0, sig1) \
  auto
...
#else
# define MXASIO_INITFN_AUTO_RESULT_TYPE(ct, sig) \
  MXASIO_INITFN_RESULT_TYPE(ct, sig)
# define MXASIO_INITFN_AUTO_RESULT_TYPE2(ct, sig0, sig1) \
  MXASIO_INITFN_RESULT_TYPE2(ct, sig0, sig1)
# define MXASIO_INITFN_AUTO_RESULT_TYPE3(ct, sig0, sig1, sig2) \
  MXASIO_INITFN_RESULT_TYPE3(ct, sig0, sig1, sig2)
#endif

#if defined(GENERATING_DOCUMENTATION)
# define MXASIO_INITFN_AUTO_RESULT_TYPE_PREFIX(ct, sig) \
  auto
# define MXASIO_INITFN_AUTO_RESULT_TYPE_PREFIX2(ct, sig0, sig1) \
  auto
# define MXASIO_INITFN_AUTO_RESULT_TYPE_PREFIX3(ct, sig0, sig1, sig2) \
  auto
# define MXASIO_INITFN_AUTO_RESULT_TYPE_SUFFIX(expr)
#elif defined(MXASIO_HAS_RETURN_TYPE_DEDUCTION)
# define MXASIO_INITFN_AUTO_RESULT_TYPE_PREFIX(ct, sig) \
  auto
# define MXASIO_INITFN_AUTO_RESULT_TYPE_PREFIX2(ct, sig0, sig1) \
...
# define MXASIO_INITFN_AUTO_RESULT_TYPE_PREFIX3(ct, sig0, sig1, sig2) \
  auto
# define MXASIO_INITFN_AUTO_RESULT_TYPE_SUFFIX(expr) -> decltype expr
#endif

#if defined(GENERATING_DOCUMENTATION)
# define MXASIO_INITFN_DEDUCED_RESULT_TYPE(ct, sig, expr) \
  void_or_deduced
# define MXASIO_INITFN_DEDUCED_RESULT_TYPE2(ct, sig0, sig1, expr) \
  void_or_deduced
# define MXASIO_INITFN_DEDUCED_RESULT_TYPE3(ct, sig0, sig1, sig2, expr) \
  void_or_deduced
#else
# define MXASIO_INITFN_DEDUCED_RESULT_TYPE(ct, sig, expr) \
  decltype expr
...
template <typename T, typename... Signatures>
MXASIO_CONCEPT completion_token_for =
  detail::are_completion_signatures<Signatures...>::value
  &&
  requires(T&& t)
  {
...
#define MXASIO_COMPLETION_TOKEN_FOR(sig) \
  ::mxasio::completion_token_for<sig>
#define MXASIO_COMPLETION_TOKEN_FOR2(sig0, sig1) \
  ::mxasio::completion_token_for<sig0, sig1>
#define MXASIO_COMPLETION_TOKEN_FOR3(sig0, sig1, sig2) \
  ::mxasio::completion_token_for<sig0, sig1, sig2>

#else // defined(MXASIO_HAS_CONCEPTS)

#define MXASIO_COMPLETION_TOKEN_FOR(sig) typename
#define MXASIO_COMPLETION_TOKEN_FOR2(sig0, sig1) typename
#define MXASIO_COMPLETION_TOKEN_FOR3(sig0, sig1, sig2) typename
...
template <typename T, typename... Args>
MXASIO_CONCEPT async_operation = is_async_operation<T, Args...>::value;

#define MXASIO_ASYNC_OPERATION(t) \
  ::mxasio::async_operation<t>
#define MXASIO_ASYNC_OPERATION1(t, a0) \
  ::mxasio::async_operation<t, a0>
#define MXASIO_ASYNC_OPERATION2(t, a0, a1) \
  ::mxasio::async_operation<t, a0, a1>
#define MXASIO_ASYNC_OPERATION3(t, a0, a1, a2) \
  ::mxasio::async_operation<t, a0, a1, a2>

#else // defined(MXASIO_HAS_CONCEPTS)

#define MXASIO_ASYNC_OPERATION(t) typename
#define MXASIO_ASYNC_OPERATION1(t, a0) typename
#define MXASIO_ASYNC_OPERATION2(t, a0, a1) typename
#define MXASIO_ASYNC_OPERATION3(t, a0, a1, a2) typename
...
#define MXASIO_DEFAULT_COMPLETION_TOKEN_TYPE(e) \
  = typename ::mxasio::default_completion_token<e>::type
#define MXASIO_DEFAULT_COMPLETION_TOKEN(e) \
  = typename ::mxasio::default_completion_token<e>::type()

...
#ifndef MXASIO_WRITE_AT_HPP
#define MXASIO_WRITE_AT_HPP
...
/**
 * @defgroup write_at mxasio::write_at
 *
 ...
 * @code mxasio::write_at(d, 42, mxasio::buffer(data, size)); @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code mxasio::write_at(
 *     d, offset, buffers,
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code mxasio::write_at(d, 42,
 *     mxasio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code mxasio::write_at(d, 42, mxasio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_write_at mxasio::async_write_at
 *
 ...
 * To write a single data buffer use the @ref buffer function as follows:
 * @code
 * mxasio::async_write_at(d, 42, mxasio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code mxasio::async_write_at(d, 42,
...
#include "mxasio/impl/write_at.hpp"

#endif // MXASIO_WRITE_AT_HPP

...
#ifndef MXASIO_SSL_RFC2818_VERIFICATION_HPP
#define MXASIO_SSL_RFC2818_VERIFICATION_HPP
 ...
 * mxasio::connect(sock.lowest_layer(), resolver.resolve(query));
...
public:
  ...
  MXASIO_DECL bool operator()(bool preverified, verify_context& ctx) const;

private:
  // Helper function to check a host name against a pattern.
  MXASIO_DECL static bool match_pattern(const char* pattern,
...
#endif // MXASIO_SSL_RFC2818_VERIFICATION_HPP

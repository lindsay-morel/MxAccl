...
#ifndef MXASIO_SSL_DETAIL_OPENSSL_INIT_HPP
#define MXASIO_SSL_DETAIL_OPENSSL_INIT_HPP
...
protected:
  ...
  MXASIO_DECL static mxasio::detail::shared_ptr<do_init> instance();

#if !defined(SSL_OP_NO_COMPRESSION) \
  && (OPENSSL_VERSION_NUMBER >= 0x00908000L)
  // Get an empty stack of compression methods, to be used when disabling
  // compression.
  MXASIO_DECL static STACK_OF(SSL_COMP)* get_null_compression_methods();
...
private:
  ...
  mxasio::detail::shared_ptr<do_init> ref_;
};
...
#endif // MXASIO_SSL_DETAIL_OPENSSL_INIT_HPP

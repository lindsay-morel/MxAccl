...
#ifndef MXASIO_SSL_DETAIL_BUFFERED_HANDSHAKE_OP_HPP
#define MXASIO_SSL_DETAIL_BUFFERED_HANDSHAKE_OP_HPP
...
public:
  ...
  buffered_handshake_op(stream_base::handshake_type type,
    ...
    : type_(type),
      buffers_(buffers),
      total_buffer_size_(mxasio::buffer_size(buffers_))
  {
  }
      ...
      std::size_t& bytes_transferred) const
  {
    return this->process(eng, ec, bytes_transferred,
        mxasio::buffer_sequence_begin(buffers_),
        mxasio::buffer_sequence_end(buffers_));
  }
...
#endif // MXASIO_SSL_DETAIL_BUFFERED_HANDSHAKE_OP_HPP

...
#ifndef MXASIO_SSL_IMPL_CONTEXT_IPP
#define MXASIO_SSL_IMPL_CONTEXT_IPP
...
#include "mxasio/ssl/context.hpp"
  ...
  : handle_(0)
{
  ...
  case context::sslv2_server:
    mxasio::detail::throw_error(
        mxasio::error::invalid_argument, "context");
    break;
  ...
  if (handle_ == 0)
  {
    mxasio::error_code ec = translate_error(::ERR_get_error());
    mxasio::detail::throw_error(ec, "context");
  }
...
void context::clear_options(context::options o)
{
  ...
  clear_options(o, ec);
  mxasio::detail::throw_error(ec, "clear_options");
}

MXASIO_SYNC_OP_VOID context::clear_options(
    context::options o, mxasio::error_code& ec)
{
...
void context::set_options(context::options o)
{
  mxasio::error_code ec;
  set_options(o, ec);
  mxasio::detail::throw_error(ec, "set_options");
}

MXASIO_SYNC_OP_VOID context::set_options(
    context::options o, mxasio::error_code& ec)
{
#if !defined(SSL_OP_NO_COMPRESSION)
  if ((o & context::no_compression) != 0)
  {
    ...
    handle_->comp_methods =
      mxasio::ssl::detail::openssl_init<>::get_null_compression_methods();
#endif // (OPENSSL_VERSION_NUMBER >= 0x00908000L)
    o ^= context::no_compression;
  }
#endif // !defined(SSL_OP_NO_COMPRESSION)
...
void context::set_verify_mode(verify_mode v)
{
  ...
  mxasio::detail::throw_error(ec, "set_verify_mode");
}

MXASIO_SYNC_OP_VOID context::set_verify_mode(
...
void context::set_verify_depth(int depth)
{
  ...
  mxasio::detail::throw_error(ec, "set_verify_depth");
}

MXASIO_SYNC_OP_VOID context::set_verify_depth(
...
void context::load_verify_file(const std::string& filename)
{
  ...
  mxasio::detail::throw_error(ec, "load_verify_file");
}

MXASIO_SYNC_OP_VOID context::load_verify_file(
...
void context::add_certificate_authority(const const_buffer& ca)
{
  ...
  mxasio::detail::throw_error(ec, "add_certificate_authority");
}

MXASIO_SYNC_OP_VOID context::add_certificate_authority(
...
void context::set_default_verify_paths()
{
  ...
  mxasio::detail::throw_error(ec, "set_default_verify_paths");
}

MXASIO_SYNC_OP_VOID context::set_default_verify_paths(
    mxasio::error_code& ec)
{
  ::ERR_clear_error();
...
void context::add_verify_path(const std::string& path)
{
  ...
  mxasio::detail::throw_error(ec, "add_verify_path");
}

MXASIO_SYNC_OP_VOID context::add_verify_path(
    ...
    const const_buffer& certificate, file_format format)
{
  ...
  mxasio::detail::throw_error(ec, "use_certificate");
}

MXASIO_SYNC_OP_VOID context::use_certificate(
    const const_buffer& certificate, file_format format,
    mxasio::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const std::string& filename, file_format format)
{
  ...
  mxasio::detail::throw_error(ec, "use_certificate_file");
}

MXASIO_SYNC_OP_VOID context::use_certificate_file(
    const std::string& filename, file_format format,
    mxasio::error_code& ec)
{
  int file_type;
...
void context::use_certificate_chain(const const_buffer& chain)
{
  ...
  mxasio::detail::throw_error(ec, "use_certificate_chain");
}

MXASIO_SYNC_OP_VOID context::use_certificate_chain(
...
void context::use_certificate_chain_file(const std::string& filename)
{
  ...
  mxasio::detail::throw_error(ec, "use_certificate_chain_file");
}

MXASIO_SYNC_OP_VOID context::use_certificate_chain_file(
    const std::string& filename, mxasio::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const const_buffer& private_key, context::file_format format)
{
  ...
  mxasio::detail::throw_error(ec, "use_private_key");
}

MXASIO_SYNC_OP_VOID context::use_private_key(
    const const_buffer& private_key, context::file_format format,
    mxasio::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const std::string& filename, context::file_format format)
{
  ...
  mxasio::detail::throw_error(ec, "use_private_key_file");
}
    ...
    const const_buffer& private_key, context::file_format format)
{
  ...
  mxasio::detail::throw_error(ec, "use_rsa_private_key");
}

MXASIO_SYNC_OP_VOID context::use_rsa_private_key(
    const const_buffer& private_key, context::file_format format,
    mxasio::error_code& ec)
{
  ::ERR_clear_error();
...
MXASIO_SYNC_OP_VOID context::use_private_key_file(
    const std::string& filename, context::file_format format,
    mxasio::error_code& ec)
{
  int file_type;
    ...
    const std::string& filename, context::file_format format)
{
  ...
  mxasio::detail::throw_error(ec, "use_rsa_private_key_file");
}

MXASIO_SYNC_OP_VOID context::use_rsa_private_key_file(
    const std::string& filename, context::file_format format,
    mxasio::error_code& ec)
{
#if (OPENSSL_VERSION_NUMBER >= 0x30000000L)
...
void context::use_tmp_dh(const const_buffer& dh)
{
  mxasio::error_code ec;
  use_tmp_dh(dh, ec);
  mxasio::detail::throw_error(ec, "use_tmp_dh");
}

MXASIO_SYNC_OP_VOID context::use_tmp_dh(
...
void context::use_tmp_dh_file(const std::string& filename)
{
  ...
  mxasio::detail::throw_error(ec, "use_tmp_dh_file");
}

MXASIO_SYNC_OP_VOID context::use_tmp_dh_file(
    const std::string& filename, mxasio::error_code& ec)
{
  ::ERR_clear_error();
...
MXASIO_SYNC_OP_VOID context::do_use_tmp_dh(
...
MXASIO_SYNC_OP_VOID context::do_set_verify_callback(
...
MXASIO_SYNC_OP_VOID context::do_set_password_callback(
...
mxasio::error_code context::translate_error(long error)
{
#if (OPENSSL_VERSION_NUMBER >= 0x30000000L)
  ...
  return mxasio::error_code(static_cast<int>(error),
...
#endif // MXASIO_SSL_IMPL_CONTEXT_IPP

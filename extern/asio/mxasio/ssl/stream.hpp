...
#ifndef MXASIO_SSL_STREAM_HPP
#define MXASIO_SSL_STREAM_HPP
...
#include "mxasio/ssl/detail/buffered_handshake_op.hpp"
#include "mxasio/ssl/detail/handshake_op.hpp"
#include "mxasio/ssl/detail/io.hpp"
#include "mxasio/ssl/detail/read_op.hpp"
#include "mxasio/ssl/detail/shutdown_op.hpp"
#include "mxasio/ssl/detail/stream_core.hpp"
#include "mxasio/ssl/detail/write_op.hpp"
 ...
 * @code
 * mxasio::io_context my_context;
 * mxasio::ssl::context ctx(mxasio::ssl::context::sslv23);
 * mxasio::ssl::stream<mxasio::ip::tcp::socket> sock(my_context, ctx);
 * @endcode
 *
 * @par Concepts:
...
public:
   ...
   * @code
   * mxasio::ssl::stream<mxasio::ip::tcp::socket> sock(io_ctx, ctx);
   *
   ...
   * @note Calls @c SSL_set_verify.
   */
  MXASIO_SYNC_OP_VOID set_verify_mode(
   ...
   * @note Calls @c SSL_set_verify_depth.
   */
  MXASIO_SYNC_OP_VOID set_verify_depth(
  ...
  void handshake(handshake_type type)
  {
    mxasio::error_code ec;
    handshake(type, ec);
    mxasio::detail::throw_error(ec, "handshake");
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  MXASIO_SYNC_OP_VOID handshake(handshake_type type,
      mxasio::error_code& ec)
  {
   ...
   *
   * @par Completion Signature
   * @code void(mxasio::error_code, std::size_t) @endcode
   *
   * @par Per-Operation Cancellation
   * This asynchronous operation supports cancellation for the following
   * mxasio::cancellation_type values:
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  MXASIO_SYNC_OP_VOID shutdown(mxasio::error_code& ec)
  {
  ...
  std::size_t write_some(const ConstBufferSequence& buffers)
  {
    ...
    mxasio::detail::throw_error(ec, "write_some");
    return n;
  }
  ...
  std::size_t read_some(const MutableBufferSequence& buffers)
  {
    ...
    mxasio::detail::throw_error(ec, "read_some");
    return n;
  }
...
private:
  ...
  public:
        ...
        handshake_type type) const
    {
      ...
      MXASIO_HANDSHAKE_HANDLER_CHECK(HandshakeHandler, handler) type_check;

      mxasio::detail::non_const_lvalue<HandshakeHandler> handler2(handler);
  ...
  public:
        ...
        handshake_type type, const ConstBufferSequence& buffers) const
    {
      ...
      MXASIO_BUFFERED_HANDSHAKE_HANDLER_CHECK(
          BufferedHandshakeHandler, handler) type_check;

      mxasio::detail::non_const_lvalue<
  ...
  public:
    ...
    void operator()(ShutdownHandler&& handler) const
    {
      ...
      MXASIO_HANDSHAKE_HANDLER_CHECK(ShutdownHandler, handler) type_check;

      mxasio::detail::non_const_lvalue<ShutdownHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,
  ...
  public:
        ...
        const ConstBufferSequence& buffers) const
    {
      ...
      MXASIO_WRITE_HANDLER_CHECK(WriteHandler, handler) type_check;

      mxasio::detail::non_const_lvalue<WriteHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,
  ...
  public:
        ...
        const MutableBufferSequence& buffers) const
    {
      ...
      MXASIO_READ_HANDLER_CHECK(ReadHandler, handler) type_check;

      mxasio::detail::non_const_lvalue<ReadHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,

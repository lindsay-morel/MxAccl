...
#ifndef MXASIO_BASIC_SOCKET_ACCEPTOR_HPP
#define MXASIO_BASIC_SOCKET_ACCEPTOR_HPP
 ...
 * @code
 * mxasio::ip::tcp::acceptor acceptor(my_context);
 * mxasio::ip::tcp::endpoint endpoint(mxasio::ip::tcp::v4(), port);
 * acceptor.open(endpoint.protocol());
 * acceptor.set_option(mxasio::ip::tcp::acceptor::reuse_address(true));
...
public:
    ...
    : impl_(0, ex)
  {
    ...
    mxasio::detail::throw_error(ec, "listen");
  }
   ...
   * @code
   * mxasio::ip::tcp::acceptor acceptor(my_context);
   * acceptor.open(mxasio::ip::tcp::v4());
   * @endcode
   */
   ...
   * mxasio::ip::tcp::acceptor acceptor(my_context);
   * mxasio::error_code ec;
   * acceptor.open(mxasio::ip::tcp::v4(), ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
  ...
  MXASIO_SYNC_OP_VOID assign(const protocol_type& protocol,
      const native_handle_type& native_acceptor, mxasio::error_code& ec)
  {
    impl_.get_service().assign(impl_.get_implementation(),
        protocol, native_acceptor, ec);
    MXASIO_SYNC_OP_VOID_RETURN(ec);
   ...
   * @code
   * mxasio::ip::tcp::acceptor acceptor(my_context);
   * mxasio::ip::tcp::endpoint endpoint(mxasio::ip::tcp::v4(), 12345);
   * acceptor.open(endpoint.protocol());
   * acceptor.bind(endpoint);
   * @endcode
   */
   ...
   * ...
   * mxasio::error_code ec;
   * acceptor.listen(mxasio::socket_base::max_listen_connections, ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   * @endcode
   */
  MXASIO_SYNC_OP_VOID listen(int backlog, mxasio::error_code& ec)
  {
    impl_.get_service().listen(impl_.get_implementation(), backlog, ec);
    MXASIO_SYNC_OP_VOID_RETURN(ec);
  }
   ...
   * passed the mxasio::error::operation_aborted error. Ownership of the
   ...
   * mxasio::socket_base::reuse_address
   * mxasio::socket_base::enable_connection_aborted
   *
   * @par Example
   ...
   * mxasio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * mxasio::ip::tcp::acceptor::reuse_address option(true);
   ...
   * mxasio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * mxasio::ip::tcp::acceptor::reuse_address option;
   ...
   * mxasio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * mxasio::ip::tcp::acceptor::non_blocking_io command(true);
   ...
   * with mxasio::error::would_block if they are unable to perform the
   ...
   * mxasio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * mxasio::ip::tcp::endpoint endpoint = acceptor.local_endpoint();
   * @endcode
   */
   ...
   * ...
   * mxasio::error_code ec;
   * mxasio::ip::tcp::endpoint endpoint = acceptor.local_endpoint(ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   * mxasio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * acceptor.wait(mxasio::ip::tcp::acceptor::wait_read);
   * @endcode
   */
   ...
   * ...
   * mxasio::error_code ec;
   * acceptor.wait(mxasio::ip::tcp::acceptor::wait_read, ec);
   * @endcode
   */
   ...
   * ...
   * acceptor.async_wait(
   *     mxasio::ip::tcp::acceptor::wait_read,
   *     wait_handler);
   * @endcode
   *
      ...
      > = 0)
  {
    ...
    mxasio::detail::throw_error(ec, "accept");
  }
   ...
   */
  template <typename Protocol1, typename Executor1>
  MXASIO_SYNC_OP_VOID accept(
      basic_socket<Protocol1, Executor1>& peer, mxasio::error_code& ec,
      constraint_t<
        is_convertible<Protocol, Protocol1>::value
      > = 0)
  {
   ...
   * @par Example
   * @code
   * void accept_handler(const mxasio::error_code& error)
   * {
   *   if (!error)
   *   {
   *     // Accept succeeded.
  ...
  auto async_accept(basic_socket<Protocol1, Executor1>& peer,
      ...
      > = 0)
    -> decltype(
      async_initiate<AcceptToken, void (mxasio::error_code)>(
        declval<initiate_async_accept>(), token,
        &peer, static_cast<endpoint_type*>(0)))
  {
    return async_initiate<AcceptToken, void (mxasio::error_code)>(
   ...
   */
  template <typename Executor1>
  MXASIO_SYNC_OP_VOID accept(basic_socket<protocol_type, Executor1>& peer,
      endpoint_type& peer_endpoint, mxasio::error_code& ec)
  {
   ...
   * mxasio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * mxasio::ip::tcp::socket socket(acceptor.accept());
   * @endcode
   */
   ...
   * mxasio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * mxasio::ip::tcp::socket socket(acceptor.accept(ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
  ...
  auto async_accept(
    ...
    -> decltype(
      async_initiate<MoveAcceptToken,
        void (mxasio::error_code, typename Protocol::socket::template
   ...
   * mxasio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * mxasio::ip::tcp::socket socket(acceptor.accept(my_context2, ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
  ...
  template <typename Executor1>
  typename Protocol::socket::template rebind_executor<Executor1>::other
  accept(const Executor1& ex, mxasio::error_code& ec,
      constraint_t<
        is_executor<Executor1>::value
          || execution::is_executor<Executor1>::value
      > = 0)
  ...
  typename Protocol::socket::template rebind_executor<
      typename ExecutionContext::executor_type>::other
  accept(ExecutionContext& context, mxasio::error_code& ec,
      constraint_t<
        is_convertible<ExecutionContext&, execution_context&>::value
      > = 0)
  {
   ...
   * ...
   * mxasio::ip::tcp::endpoint endpoint;
   * mxasio::ip::tcp::socket socket(acceptor.accept(endpoint));
   * @endcode
   */
  typename Protocol::socket::template rebind_executor<executor_type>::other
   ...
   * ...
   * mxasio::ip::tcp::endpoint endpoint;
   * mxasio::ip::tcp::socket socket(acceptor.accept(endpoint, ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   */
  typename Protocol::socket::template rebind_executor<executor_type>::other
  accept(endpoint_type& peer_endpoint, mxasio::error_code& ec)
  {
    typename Protocol::socket::template rebind_executor<
      executor_type>::other peer(impl_.get_executor());
    impl_.get_service().accept(impl_.get_implementation(),
...
private:
  ...
  public:
        ...
        endpoint_type* peer_endpoint) const
    {
      ...
      MXASIO_ACCEPT_HANDLER_CHECK(AcceptHandler, handler) type_check;
  ...
  public:
        ...
        const Executor1& peer_ex, endpoint_type* peer_endpoint, Socket*) const
    {
      ...
      MXASIO_MOVE_ACCEPT_HANDLER_CHECK(
...
#endif // MXASIO_BASIC_SOCKET_ACCEPTOR_HPP

...
#ifndef MXASIO_BASIC_DATAGRAM_SOCKET_HPP
#define MXASIO_BASIC_DATAGRAM_SOCKET_HPP
...
public:
   ...
   *     mxasio::buffer(data, size), sender_endpoint, handler); @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   *
...
#endif // MXASIO_BASIC_DATAGRAM_SOCKET_HPP

...
#ifndef MXASIO_IO_CONTEXT_HPP
#define MXASIO_IO_CONTEXT_HPP
...
#include "mxasio/detail/wrapped_handler.hpp"
...
#include "mxasio/detail/winsock_init.hpp"
  ...
  || defined(__osf__)
#include "mxasio/detail/signal_init.hpp"
#endif
 ...
 *
 * @li mxasio::ip::tcp::socket
 * @li mxasio::ip::tcp::acceptor
 * @li mxasio::ip::udp::socket
 * @li mxasio::deadline_timer.
 *
 ...
 *
 * To submit functions to the io_context, use the @ref mxasio::dispatch,
 * @ref mxasio::post or @ref mxasio::defer free functions.
 *
 * For example:
 *
 * @code void my_task()
 ...
 * mxasio::post(io_context, my_task);
 *
 * // Submit a lambda object to the io_context.
 * mxasio::post(io_context,
 *     []()
 *     {
 *       ...
 *     });
 ...
 * mxasio::executor_work_guard<io_context::executor_type>:
 *
 * @code mxasio::io_context io_context;
 * mxasio::executor_work_guard<mxasio::io_context::executor_type>
 *   = mxasio::make_work_guard(io_context);
 * ... @endcode
 *
...
public:
  ...
  && !defined(MXASIO_NO_TS_EXECUTORS)
  class strand;
   ...
   */
  MXASIO_DECL explicit io_context(int concurrency_hint);
   ...
   * without blocking.
   */
  MXASIO_DECL count_type run(mxasio::error_code& ec);
#endif // !defined(MXASIO_NO_DEPRECATED)
   ...
   */
  MXASIO_DECL count_type run_one();
   ...
   * deadlock. It is the caller's reponsibility to avoid this.
   */
  MXASIO_DECL count_type run_one(mxasio::error_code& ec);
#endif // !defined(MXASIO_NO_DEPRECATED)
   ...
   * @return The number of handlers that were executed.
   */
  MXASIO_DECL count_type poll(mxasio::error_code& ec);
#endif // !defined(MXASIO_NO_DEPRECATED)
   ...
   * @return The number of handlers that were executed.
   */
  MXASIO_DECL count_type poll_one();
   ...
   * @return The number of handlers that were executed.
   */
  MXASIO_DECL count_type poll_one(mxasio::error_code& ec);
#endif // !defined(MXASIO_NO_DEPRECATED)
   ...
   */
  MXASIO_DECL bool stopped() const;
  ...
  /// (Deprecated: Use mxasio::dispatch().) Request the io_context to
  ...
  /// (Deprecated: Use mxasio::post().) Request the io_context to invoke
  ...
  /// (Deprecated: Use mxasio::bind_executor().) Create a new handler that
...
private:
  ...
  MXASIO_DECL impl_type& add_impl(impl_type* impl);
...
#if !defined(GENERATING_DOCUMENTATION)
private:
  friend struct mxasio_require_fn::impl;
  friend struct mxasio_prefer_fn::impl;
#endif // !defined(GENERATING_DOCUMENTATION)

  /// Obtain an executor with the @c blocking.possibly property.
  /**
   * Do not call this function directly. It is intended for use with the
   * mxasio::require customisation point.
   *
   * For example:
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = mxasio::require(ex1,
   *     mxasio::execution::blocking.possibly); @endcode
   */
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = mxasio::require(ex1,
   *     mxasio::execution::blocking.never); @endcode
   */
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = mxasio::require(ex1,
   *     mxasio::execution::relationship.fork); @endcode
   */
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = mxasio::require(ex1,
   *     mxasio::execution::relationship.continuation); @endcode
   */
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = mxasio::require(ex1,
   *     mxasio::execution::outstanding_work.tracked); @endcode
   */
  constexpr basic_executor_type<Allocator,
      MXASIO_UNSPECIFIED(Bits | outstanding_work_tracked)>
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = mxasio::require(ex1,
   *     mxasio::execution::outstanding_work.untracked); @endcode
   */
  constexpr basic_executor_type<Allocator,
      MXASIO_UNSPECIFIED(Bits & ~outstanding_work_tracked)>
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = mxasio::require(ex1,
   *     mxasio::execution::allocator(my_allocator)); @endcode
   */
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = mxasio::require(ex1,
   *     mxasio::execution::allocator); @endcode
   */
...
#if !defined(GENERATING_DOCUMENTATION)
private:
  friend struct mxasio_query_fn::impl;
  friend struct mxasio::execution::detail::mapping_t<0>;
  friend struct mxasio::execution::detail::outstanding_work_t<0>;
#endif // !defined(GENERATING_DOCUMENTATION)

  /// Query the current value of the @c mapping property.
  /**
   * Do not call this function directly. It is intended for use with the
   * mxasio::query customisation point.
   *
   * For example:
   * @code auto ex = my_io_context.get_executor();
   * if (mxasio::query(ex, mxasio::execution::mapping)
   *       == mxasio::execution::mapping.thread)
   *   ... @endcode
   */
   ...
   * For example:
   * @code auto ex = my_io_context.get_executor();
   * mxasio::io_context& ctx = mxasio::query(
   *     ex, mxasio::execution::context); @endcode
   */
   ...
   * For example:
   * @code auto ex = my_io_context.get_executor();
   * if (mxasio::query(ex, mxasio::execution::blocking)
   *       == mxasio::execution::blocking.always)
   *   ... @endcode
   */
   ...
   * For example:
   * @code auto ex = my_io_context.get_executor();
   * if (mxasio::query(ex, mxasio::execution::relationship)
   *       == mxasio::execution::relationship.continuation)
   *   ... @endcode
   */
   ...
   * For example:
   * @code auto ex = my_io_context.get_executor();
   * if (mxasio::query(ex, mxasio::execution::outstanding_work)
   *       == mxasio::execution::outstanding_work.tracked)
   *   ... @endcode
   */
...
public:
   ...
   */
  explicit work(mxasio::io_context& io_context);
  ...
  mxasio::io_context& get_io_context();
...
private:
  ...
  MXASIO_DECL virtual void shutdown();

#if !defined(MXASIO_NO_DEPRECATED)
  /// (Deprecated: Use shutdown().) Destroy all user-defined handler objects
  /// owned by the service.
  MXASIO_DECL virtual void shutdown_service();
#endif // !defined(MXASIO_NO_DEPRECATED)
   ...
   */
  MXASIO_DECL virtual void notify_fork(
   ...
   * implement it if necessary. The default implementation does nothing.
   */
  MXASIO_DECL virtual void fork_service(
      execution_context::fork_event event);
#endif // !defined(MXASIO_NO_DEPRECATED)
...
protected:
   ...
   */
  MXASIO_DECL service(mxasio::io_context& owner);

  /// Destructor.
  MXASIO_DECL virtual ~service();
};
...
class service_base
  : public mxasio::io_context::service
{
public:
  static mxasio::detail::service_id<Type> id;

  // Constructor.
  service_base(mxasio::io_context& io_context)
    : mxasio::io_context::service(io_context)
  {
  }
};

template <typename Type>
mxasio::detail::service_id<Type> service_base<Type>::id;
...
#if !defined(MXASIO_HAS_DEDUCED_EQUALITY_COMPARABLE_TRAIT)

template <typename Allocator, uintptr_t Bits>
struct equality_comparable<
    mxasio::io_context::basic_executor_type<Allocator, Bits>
  >
{
...
#endif // !defined(MXASIO_HAS_DEDUCED_EQUALITY_COMPARABLE_TRAIT)

#if !defined(MXASIO_HAS_DEDUCED_EXECUTE_MEMBER_TRAIT)
...
#endif // !defined(MXASIO_HAS_DEDUCED_EXECUTE_MEMBER_TRAIT)

#if !defined(MXASIO_HAS_DEDUCED_REQUIRE_MEMBER_TRAIT)

template <typename Allocator, uintptr_t Bits>
struct require_member<
    mxasio::io_context::basic_executor_type<Allocator, Bits>,
    mxasio::execution::blocking_t::possibly_t
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
  typedef mxasio::io_context::basic_executor_type<
...
struct require_member<
    mxasio::io_context::basic_executor_type<Allocator, Bits>,
    mxasio::execution::blocking_t::never_t
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
...
struct require_member<
    mxasio::io_context::basic_executor_type<Allocator, Bits>,
    mxasio::execution::relationship_t::fork_t
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
...
struct require_member<
    mxasio::io_context::basic_executor_type<Allocator, Bits>,
    mxasio::execution::relationship_t::continuation_t
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
...
struct require_member<
    mxasio::io_context::basic_executor_type<Allocator, Bits>,
    mxasio::execution::outstanding_work_t::tracked_t
  > : mxasio::detail::io_context_bits
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
  typedef mxasio::io_context::basic_executor_type<
...
struct require_member<
    mxasio::io_context::basic_executor_type<Allocator, Bits>,
    mxasio::execution::outstanding_work_t::untracked_t
  > : mxasio::detail::io_context_bits
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
...
struct require_member<
    mxasio::io_context::basic_executor_type<Allocator, Bits>,
    mxasio::execution::allocator_t<void>
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
...
struct require_member<
    mxasio::io_context::basic_executor_type<Allocator, Bits>,
    mxasio::execution::allocator_t<OtherAllocator>
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
...
#endif // !defined(MXASIO_HAS_DEDUCED_REQUIRE_MEMBER_TRAIT)

#if !defined(MXASIO_HAS_DEDUCED_QUERY_STATIC_CONSTEXPR_MEMBER_TRAIT)

template <typename Allocator, uintptr_t Bits, typename Property>
struct query_static_constexpr_member<
    mxasio::io_context::basic_executor_type<Allocator, Bits>,
    Property,
    typename mxasio::enable_if<
      mxasio::is_convertible<
        Property,
        mxasio::execution::outstanding_work_t
      >::value
    >::type
  > : mxasio::detail::io_context_bits
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
  typedef mxasio::execution::outstanding_work_t result_type;
  ...
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
  typedef mxasio::execution::mapping_t::thread_t result_type;
...
#endif // !defined(MXASIO_HAS_DEDUCED_QUERY_STATIC_CONSTEXPR_MEMBER_TRAIT)

#if !defined(MXASIO_HAS_DEDUCED_QUERY_MEMBER_TRAIT)
  ...
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
  typedef mxasio::execution::blocking_t result_type;
};
...
struct query_member<
    ...
    typename mxasio::enable_if<
      mxasio::is_convertible<
        Property,
        mxasio::execution::relationship_t
      >::value
    >::type
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
  typedef mxasio::execution::relationship_t result_type;
};

template <typename Allocator, uintptr_t Bits>
struct query_member<
    mxasio::io_context::basic_executor_type<Allocator, Bits>,
    mxasio::execution::context_t
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
  typedef mxasio::io_context& result_type;
};
...
#endif // !defined(MXASIO_HAS_DEDUCED_QUERY_MEMBER_TRAIT)
...
#include "mxasio/impl/io_context.hpp"
...
#if !defined(MXASIO_NO_EXTENSIONS)
# if defined(MXASIO_STRAND_HPP)
#include "mxasio/io_context_strand.hpp"
# endif // defined(MXASIO_STRAND_HPP)
#endif // !defined(MXASIO_NO_EXTENSIONS)

#endif // MXASIO_IO_CONTEXT_HPP

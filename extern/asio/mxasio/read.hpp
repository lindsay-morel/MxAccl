...
#ifndef MXASIO_READ_HPP
#define MXASIO_READ_HPP
 ...
 * @code mxasio::read(s, mxasio::buffer(data, size)); @endcode
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code mxasio::read(s, mxasio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 ...
 * @code mxasio::read(
 *     s, buffers,
 *     mxasio::transfer_all(), ec); @endcode
 */
template <typename SyncReadStream, typename MutableBufferSequence>
std::size_t read(SyncReadStream& s, const MutableBufferSequence& buffers,
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code mxasio::read(s, mxasio::buffer(data, size),
 *     mxasio::transfer_at_least(32)); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 */
...
/*@}*/
/**
 * @defgroup async_read mxasio::async_read
 *
 ...
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code
 * mxasio::async_read(s, mxasio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code mxasio::async_read(s,
 *     mxasio::buffer(data, size),
 *     mxasio::transfer_at_least(32),
 *     handler); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
...
#include "mxasio/impl/read.hpp"

#endif // MXASIO_READ_HPP

...
#ifndef MXASIO_USE_AWAITABLE_HPP
#define MXASIO_USE_AWAITABLE_HPP
...
/// coroutine.
/**
 * See the documentation for mxasio::use_awaitable_t for a usage example.
 */
...
#include "mxasio/impl/use_awaitable.hpp"

#endif // defined(MXASIO_HAS_CO_AWAIT) || defined(GENERATING_DOCUMENTATION)

#endif // MXASIO_USE_AWAITABLE_HPP

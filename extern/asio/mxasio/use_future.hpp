...
#ifndef MXASIO_USE_FUTURE_HPP
#define MXASIO_USE_FUTURE_HPP
 ...
 * operation, typically using the special value @c mxasio::use_future. For
 * example:
 *
 * @code std::future<std::size_t> my_future
 *   = my_socket.async_read_some(my_buffer, mxasio::use_future); @endcode
 *
...
public:
   ...
   *     use_future([](mxasio::error_code ec, std::size_t n)
   *       {
   *         return ec ? 0 : n;
   *       }));
   * ...
...
/// return a future.
/**
 * See the documentation for mxasio::use_future_t for a usage example.
 */
...
#include "mxasio/impl/use_future.hpp"

#endif // defined(MXASIO_HAS_STD_FUTURE_CLASS)
       //   || defined(GENERATING_DOCUMENTATION)

#endif // MXASIO_USE_FUTURE_HPP

...
#ifndef MXASIO_GENERIC_STREAM_PROTOCOL_HPP
#define MXASIO_GENERIC_STREAM_PROTOCOL_HPP
...
/**
 * The mxasio::generic::stream_protocol class contains flags necessary for
 ...
 * @code stream_protocol p(mxasio::ip::tcp::v4()); @endcode
 *
 * @par Thread Safety
...
#endif // MXASIO_GENERIC_STREAM_PROTOCOL_HPP

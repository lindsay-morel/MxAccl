...
#ifndef MXASIO_GENERIC_DATAGRAM_PROTOCOL_HPP
#define MXASIO_GENERIC_DATAGRAM_PROTOCOL_HPP
...
/**
 * The mxasio::generic::datagram_protocol class contains flags necessary
 ...
 * @code datagram_protocol p(mxasio::ip::udp::v4()); @endcode
 *
 * @par Thread Safety
...
#endif // MXASIO_GENERIC_DATAGRAM_PROTOCOL_HPP

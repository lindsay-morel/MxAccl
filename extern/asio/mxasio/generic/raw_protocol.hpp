...
#ifndef MXASIO_GENERIC_RAW_PROTOCOL_HPP
#define MXASIO_GENERIC_RAW_PROTOCOL_HPP
...
/**
 * The mxasio::generic::raw_protocol class contains flags necessary for
 ...
 * @code raw_protocol p(mxasio::ip::icmp::v4()); @endcode
 *
 * @par Thread Safety
...
#endif // MXASIO_GENERIC_RAW_PROTOCOL_HPP

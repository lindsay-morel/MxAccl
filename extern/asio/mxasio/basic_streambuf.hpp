...
#ifndef MXASIO_BASIC_STREAMBUF_HPP
#define MXASIO_BASIC_STREAMBUF_HPP
 ...
 * mxasio::streambuf::mutable_buffers_type bufs = b.prepare(512);
 *
...
public:
  ...
  {
    return mxasio::buffer(mxasio::const_buffer(gptr(),
  ...
  {
    reserve(n);
    return mxasio::buffer(mxasio::mutable_buffer(
...
protected:
  ...
  void reserve(std::size_t n)
  {
    ...
    if (n > pend - pnext)
    {
      ...
      {
        std::length_error ex("mxasio::streambuf too long");
...
#endif // MXASIO_BASIC_STREAMBUF_HPP

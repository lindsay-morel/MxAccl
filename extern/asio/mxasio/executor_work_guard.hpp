...
#ifndef MXASIO_EXECUTOR_WORK_GUARD_HPP
#define MXASIO_EXECUTOR_WORK_GUARD_HPP
...
public:
  ...
  explicit executor_work_guard(const executor_type& e) noexcept
    : executor_(e),
      owns_(true)
  {
    new (&work_) work_type(mxasio::prefer(executor_,
 ...
 */
template <typename Executor>
MXASIO_NODISCARD inline executor_work_guard<Executor>
...
MXASIO_NODISCARD inline executor_work_guard<
...
#endif // MXASIO_EXECUTOR_WORK_GUARD_HPP

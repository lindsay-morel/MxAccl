...
#ifndef MXASIO_ANY_COMPLETION_EXECUTOR_HPP
#define MXASIO_ANY_COMPLETION_EXECUTOR_HPP
...
public:
  ...
  /// Default constructor.
  MXASIO_DECL any_completion_executor() noexcept;

  /// Construct in an empty state. Equivalent effects to default constructor.
  MXASIO_DECL any_completion_executor(nullptr_t) noexcept;

  /// Copy constructor.
  MXASIO_DECL any_completion_executor(
  ...
  /// Construct to point to the same target as another any_executor.
  MXASIO_DECL any_completion_executor(std::nothrow_t,
      const any_completion_executor& e) noexcept;
  ...
  /// Assignment operator.
  MXASIO_DECL any_completion_executor& operator=(
      const any_completion_executor& e) noexcept;
  ...
  MXASIO_DECL any_completion_executor& operator=(nullptr_t);

  /// Destructor.
  MXASIO_DECL ~any_completion_executor();

  /// Swap targets with another polymorphic wrapper.
  MXASIO_DECL void swap(any_completion_executor& other) noexcept;
   ...
   * auto ex2 = mxasio::require(ex, execution::relationship.fork); @endcode
   */
   ...
   * For example:
   * @code any_completion_executor ex = ...;
   * auto ex2 = mxasio::prefer(ex, execution::relationship.fork); @endcode
   */
  template <typename Property>
...
template <>
MXASIO_DECL any_completion_executor any_completion_executor::prefer(
...
#endif // MXASIO_ANY_COMPLETION_EXECUTOR_HPP

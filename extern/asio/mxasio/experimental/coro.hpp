...
#ifndef MXASIO_EXPERIMENTAL_CORO_HPP
#define MXASIO_EXPERIMENTAL_CORO_HPP
...
#include "mxasio/experimental/detail/coro_promise_allocator.hpp"
#include "mxasio/experimental/detail/partial_promise.hpp"
...
struct coro
{
  /// The traits of the coroutine. See mxasio::experimental::coro_traits
  /// for details.
  ...
  ~coro()
  {
    if (coro_ != nullptr)
    {
      ...
      if (handle)
        mxasio::dispatch(coro_->get_executor(), destroyer{handle});
    }
  }
...
template<typename T, typename Executor = mxasio::any_io_executor,
    typename Allocator = std::allocator<void>>
...
#include "mxasio/experimental/impl/coro.hpp"

#endif // MXASIO_EXPERIMENTAL_CORO_HPP

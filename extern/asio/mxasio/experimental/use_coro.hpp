...
#ifndef MXASIO_EXPERIMENTAL_USE_CORO_HPP
#define MXASIO_EXPERIMENTAL_USE_CORO_HPP
 ...
 * returned.
 *
 * Note that this token is not the most efficient (use @c mxasio::deferred
...
# else // defined(MXASIO_HAS_SOURCE_LOCATION)
    , file_name_(0),
      line_(0),
      function_name_(0)
# endif // defined(MXASIO_HAS_SOURCE_LOCATION)
...
/// resumable coroutine.
/**
 * See the documentation for mxasio::use_coro_t for a usage example.
 */
...
#include "mxasio/experimental/impl/use_coro.hpp"
#include "mxasio/experimental/coro.hpp"

#endif // MXASIO_EXPERIMENTAL_USE_CORO_HPP

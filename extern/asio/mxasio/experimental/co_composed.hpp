...
#ifndef MXASIO_EXPERIMENTAL_CO_COMPOSED_HPP
#define MXASIO_EXPERIMENTAL_CO_COMPOSED_HPP
 ...
 * {
 *   return mxasio::async_initiate<
 *     CompletionToken, void(std::error_code)>(
 *       mxasio::experimental::co_composed(
 *         [](auto state, tcp::socket& socket) -> void
 *         {
 *           state.reset_cancellation_state(
 *             mxasio::enable_terminal_cancellation());
 *
 ...
 *                 mxasio::buffer(data),
 *                 mxasio::as_tuple(mxasio::deferred));
 *
 *             if (e1)
 ...
 *                 make_error_code(mxasio::error::operation_aborted));
 *
 *             auto [e2, n2] =
 *               co_await mxasio::async_write(socket,
 *                 mxasio::buffer(data, n1),
 *                 mxasio::as_tuple(mxasio::deferred));
 *
 *             if (e2)
 ...
 *                     mxasio::buffer(data), mxasio::deferred);
 *
 *                 co_await mxasio::async_write(socket,
 *                     mxasio::buffer(data, n), mxasio::deferred);
 *               }
 *             }
...
#include "mxasio/experimental/impl/co_composed.hpp"

#endif // MXASIO_EXPERIMENTAL_CO_COMPOSED_HPP

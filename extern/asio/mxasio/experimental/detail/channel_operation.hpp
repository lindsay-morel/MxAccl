...
#ifndef MXASIO_EXPERIMENTAL_DETAIL_CHANNEL_OPERATION_HPP
#define MXASIO_EXPERIMENTAL_DETAIL_CHANNEL_OPERATION_HPP
...
#include "mxasio/detail/initiate_post.hpp"
#include "mxasio/detail/initiate_dispatch.hpp"
...
class channel_operation MXASIO_INHERIT_TRACKED_HANDLER
{
public:
...
protected:
  ...
  friend class mxasio::detail::op_queue_access;
...
public:
  ...
  handler_work_base(int, const Executor& ex)
    : executor_(mxasio::prefer(ex, execution::outstanding_work.tracked))
  {
  }
  ...
  {
    (mxasio::detail::initiate_post_with_executor<IoExecutor>(io_exec))(
...
public:
  ...
  void post(const IoExecutor&, Function& function, Handler& handler)
  {
    ...
    mxasio::prefer(
        mxasio::require(executor_, execution::blocking.never),
        execution::allocator(allocator)
      ).execute(static_cast<Function&&>(function));
  }
...
public:
  ...
  void immediate(Function& function, Handler& handler, ...)
  {
    ...
    (mxasio::detail::initiate_dispatch_with_executor<immediate_ex_type>(
  ...
  void immediate(Function& function, Handler&,
      ...
      >*)
  {
    (mxasio::detail::initiate_post_with_executor<
        typename base1_type::executor_type>(
...
#endif // MXASIO_EXPERIMENTAL_DETAIL_CHANNEL_OPERATION_HPP

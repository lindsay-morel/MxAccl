...
#ifndef MXASIO_EXPERIMENTAL_DETAIL_CHANNEL_SEND_OP_HPP
#define MXASIO_EXPERIMENTAL_DETAIL_CHANNEL_SEND_OP_HPP
...
{
public:
  MXASIO_DEFINE_HANDLER_PTR(channel_send_op);
      ...
      channel_operation::action a, void*)
  {
    ...
    mxasio::detail::binder1<Handler, mxasio::error_code>
...
#endif // MXASIO_EXPERIMENTAL_DETAIL_CHANNEL_SEND_OP_HPP

...
#ifndef MXASIO_EXPERIMENTAL_DETAIL_CHANNEL_PAYLOAD_HPP
#define MXASIO_EXPERIMENTAL_DETAIL_CHANNEL_PAYLOAD_HPP
...
# include <variant>
#else // defined(MXASIO_HAS_STD_VARIANT)
# include <new>
...
class channel_payload<R1(), R2(mxasio::error_code)>
{
public:
  typedef channel_message<R1()> void_message_type;
  typedef channel_message<R2(mxasio::error_code)> error_message_type;

  channel_payload(void_message_type&&)
    : message_(0, mxasio::error_code()),
      empty_(true)
  {
  }
...
#endif // MXASIO_EXPERIMENTAL_DETAIL_CHANNEL_PAYLOAD_HPP

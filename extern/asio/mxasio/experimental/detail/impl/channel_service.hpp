...
#ifndef MXASIO_EXPERIMENTAL_DETAIL_IMPL_CHANNEL_SERVICE_HPP
#define MXASIO_EXPERIMENTAL_DETAIL_IMPL_CHANNEL_SERVICE_HPP
...
inline channel_service<Mutex>::channel_service(
  ...
  : mxasio::detail::execution_context_service_base<channel_service>(ctx),
    mutex_(),
    impl_list_(0)
{
}
...
inline void channel_service<Mutex>::shutdown()
{
  ...
  mxasio::detail::op_queue<channel_operation> ops;
    ...
    void* cancellation_key)
{
  ...
  mxasio::detail::op_queue<channel_operation> other_ops;
  while (channel_operation* op = impl.waiters_.front())
  {
  ...
  case buffer:
    {
      ...
      lock.unlock();
      mxasio::detail::non_const_lvalue<Handler> handler2(handler);
...
#endif // MXASIO_EXPERIMENTAL_DETAIL_IMPL_CHANNEL_SERVICE_HPP

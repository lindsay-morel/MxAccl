...
#ifndef MXASIO_EXPERIMENTAL_DETAIL_CHANNEL_RECEIVE_OP_HPP
#define MXASIO_EXPERIMENTAL_DETAIL_CHANNEL_RECEIVE_OP_HPP
...
#include "mxasio/experimental/detail/channel_handler.hpp"
#include "mxasio/experimental/detail/channel_operation.hpp"
#include "mxasio/experimental/detail/channel_payload.hpp"
...
{
public:
  MXASIO_DEFINE_HANDLER_PTR(channel_receive_op);
      ...
      channel_operation::action a, void* v)
  {
    ...
    {
      mxasio::detail::binder0<Handler> handler(o->handler_);
      p.h = mxasio::detail::addressof(handler.handler_);
      p.reset();
    }
  }
...
#endif // MXASIO_EXPERIMENTAL_DETAIL_CHANNEL_RECEIVE_OP_HPP

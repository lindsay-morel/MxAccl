...
#ifndef MXASIO_EXPERIMENTAL_DETAIL_CHANNEL_MESSAGE_HPP
#define MXASIO_EXPERIMENTAL_DETAIL_CHANNEL_MESSAGE_HPP
...
public:
  ...
  {
    this->do_receive(h, mxasio::detail::index_sequence_for<Args...>());
  }

private:
  template <typename Handler, std::size_t... I>
  void do_receive(Handler& h, mxasio::detail::index_sequence<I...>)
  {
...
#endif // MXASIO_EXPERIMENTAL_DETAIL_CHANNEL_MESSAGE_HPP

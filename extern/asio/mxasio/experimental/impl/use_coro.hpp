...
#ifndef MXASIO_EXPERIMENTAL_IMPL_USE_CORO_HPP
#define MXASIO_EXPERIMENTAL_IMPL_USE_CORO_HPP
...
#include "mxasio/experimental/coro.hpp"
...
struct async_result<experimental::use_coro_t<Allocator>, R()>
{
  ...
  static auto initiate_impl(mxasio::detail::initiation_archetype<R()>,
      std::allocator_arg_t, Allocator, InitArgs... args)
    -> experimental::coro<void(), void,
      mxasio::any_io_executor, Allocator>;
...
template <typename Allocator, typename R>
struct async_result<
    experimental::use_coro_t<Allocator>, R(mxasio::error_code)>
{
  template <typename Initiation, typename... InitArgs>
  static auto initiate_impl(Initiation initiation,
      std::allocator_arg_t, Allocator, InitArgs... args)
      ...
      mxasio::associated_executor_t<Initiation>, Allocator>
  {
    co_await deferred_async_operation<
      R(mxasio::error_code), Initiation, InitArgs...>(
        deferred_init_tag{}, std::move(initiation), std::move(args)...);
  }

  template <typename... InitArgs>
  static auto initiate_impl(
      mxasio::detail::initiation_archetype<R(mxasio::error_code)>,
      std::allocator_arg_t, Allocator, InitArgs... args)
    -> experimental::coro<void(), void,
      mxasio::any_io_executor, Allocator>;
    ...
    experimental::use_coro_t<Allocator>, R(std::exception_ptr)>
{
  ...
  template <typename... InitArgs>
  static auto initiate_impl(
      mxasio::detail::initiation_archetype<R(std::exception_ptr)>,
      std::allocator_arg_t, Allocator, InitArgs... args)
    -> experimental::coro<void(), void,
      mxasio::any_io_executor, Allocator>;
...
struct async_result<experimental::use_coro_t<Allocator>, R(T)>
{
  ...
  template <typename... InitArgs>
  static auto initiate_impl(mxasio::detail::initiation_archetype<R(T)>,
      std::allocator_arg_t, Allocator, InitArgs... args)
    -> experimental::coro<void() noexcept, T,
      mxasio::any_io_executor, Allocator>;
...
template <typename Allocator, typename R, typename T>
struct async_result<
    experimental::use_coro_t<Allocator>, R(mxasio::error_code, T)>
{
  template <typename Initiation, typename... InitArgs>
  static auto initiate_impl(Initiation initiation,
      std::allocator_arg_t, Allocator, InitArgs... args)
      ...
      mxasio::associated_executor_t<Initiation>, Allocator>
  {
    co_return co_await deferred_async_operation<
      R(mxasio::error_code, T), Initiation, InitArgs...>(
        deferred_init_tag{}, std::move(initiation), std::move(args)...);
  }

  template <typename... InitArgs>
  static auto initiate_impl(
      mxasio::detail::initiation_archetype<
        R(mxasio::error_code, T)>,
      std::allocator_arg_t, Allocator, InitArgs... args)
    -> experimental::coro<void(), T, mxasio::any_io_executor, Allocator>;
    ...
    experimental::use_coro_t<Allocator>, R(std::exception_ptr, T)>
{
  ...
  template <typename... InitArgs>
  static auto initiate_impl(
      mxasio::detail::initiation_archetype<R(std::exception_ptr, T)>,
      std::allocator_arg_t, Allocator, InitArgs... args)
    -> experimental::coro<void(), T, mxasio::any_io_executor, Allocator>;
...
#endif // MXASIO_EXPERIMENTAL_IMPL_USE_CORO_HPP

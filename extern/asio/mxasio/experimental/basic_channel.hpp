...
#ifndef MXASIO_EXPERIMENTAL_BASIC_CHANNEL_HPP
#define MXASIO_EXPERIMENTAL_BASIC_CHANNEL_HPP
...
#include "mxasio/detail/null_mutex.hpp"
#include "mxasio/execution/executor.hpp"
#include "mxasio/execution_context.hpp"
#include "mxasio/experimental/detail/channel_send_functions.hpp"
#include "mxasio/experimental/detail/channel_service.hpp"
...
private:
  ...
  typedef detail::channel_service<mxasio::detail::null_mutex> service_type;
  ...
  template <typename... PayloadSignatures,
      MXASIO_COMPLETION_TOKEN_FOR(PayloadSignatures...) CompletionToken>
...
public:
  ...
  basic_channel(const executor_type& ex, std::size_t max_buffer_size = 0)
    : service_(&mxasio::use_service<service_type>(
  ...
  basic_channel(ExecutionContext& context, std::size_t max_buffer_size = 0,
      ...
      > = defaulted_constraint())
    : service_(&mxasio::use_service<service_type>(context)),
      impl_(),
   ...
   * @c mxasio::experimental::error::channel_cancelled. Outstanding receive
  ...
  template <typename... Args,
      MXASIO_COMPLETION_TOKEN_FOR(void (mxasio::error_code))
        CompletionToken MXASIO_DEFAULT_COMPLETION_TOKEN_TYPE(executor_type)>
  ...
  template <typename CompletionToken
      MXASIO_DEFAULT_COMPLETION_TOKEN_TYPE(executor_type)>
  auto async_receive(
      CompletionToken&& token
...
private:
  ...
  {
    return mxasio::query(t, execution::context);
  }
  ...
  public:
    ...
    {
      mxasio::detail::non_const_lvalue<SendHandler> handler2(handler);
  ...
  public:
    ...
    {
      mxasio::detail::non_const_lvalue<ReceiveHandler> handler2(handler);
...
#endif // MXASIO_EXPERIMENTAL_BASIC_CHANNEL_HPP

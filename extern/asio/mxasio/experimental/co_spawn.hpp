...
//
#ifndef MXASIO_EXPERIMENTAL_CO_SPAWN_HPP
#define MXASIO_EXPERIMENTAL_CO_SPAWN_HPP
...
#include "mxasio/experimental/deferred.hpp"
#include "mxasio/experimental/prepend.hpp"
...
MXASIO_INITFN_AUTO_RESULT_TYPE(
 ...
 */
template <typename T, typename Executor, typename CompletionToken>
MXASIO_INITFN_AUTO_RESULT_TYPE(CompletionToken, void(T))
 ...
 */
template <typename Executor, typename CompletionToken>
MXASIO_INITFN_AUTO_RESULT_TYPE(CompletionToken, void())
...
#endif //MXASIO_EXPERIMENTAL_CO_SPAWN_HPP

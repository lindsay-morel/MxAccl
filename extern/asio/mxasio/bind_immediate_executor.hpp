...
#ifndef MXASIO_BIND_IMMEDIATE_EXECUTOR_HPP
#define MXASIO_BIND_IMMEDIATE_EXECUTOR_HPP
...
MXASIO_NODISCARD inline immediate_executor_binder<decay_t<T>, Executor>
...
#endif // MXASIO_BIND_IMMEDIATE_EXECUTOR_HPP

...
#ifndef MXASIO_CANCELLATION_SIGNAL_HPP
#define MXASIO_CANCELLATION_SIGNAL_HPP
...
public:
  ...
  MXASIO_DECL ~cancellation_signal();
...
public:
   ...
   * @code void handler(mxasio::cancellation_type_t); @endcode
   *
...
private:
  ...
  MXASIO_DECL std::pair<void*, std::size_t> prepare_memory(
  ...
  struct auto_delete_helper
  {
    ...
    MXASIO_DECL ~auto_delete_helper();
  };
...
#endif // MXASIO_CANCELLATION_SIGNAL_HPP

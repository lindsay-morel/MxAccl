...
#ifndef MXASIO_BASIC_RAW_SOCKET_HPP
#define MXASIO_BASIC_RAW_SOCKET_HPP
...
#if !defined(MXASIO_BASIC_RAW_SOCKET_FWD_DECL)
#define MXASIO_BASIC_RAW_SOCKET_FWD_DECL

// Forward declaration with defaulted arguments.
template <typename Protocol, typename Executor = any_io_executor>
class basic_raw_socket;

#endif // !defined(MXASIO_BASIC_RAW_SOCKET_FWD_DECL)
...
public:
   ...
   * @code socket.send(mxasio::buffer(data, size)); @endcode
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * mxasio::ip::udp::endpoint destination(
   *     mxasio::ip::address::from_string("1.2.3.4"), 12345);
   * socket.send_to(mxasio::buffer(data, size), destination);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
      ...
      const endpoint_type& destination)
  {
    ...
    mxasio::detail::throw_error(ec, "send_to");
    return s;
  }
   ...
   *     mxasio::buffer(data, size), destination, handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code socket.receive(mxasio::buffer(data, size)); @endcode
   ...
   * follows:
   * @code
   * mxasio::ip::udp::endpoint sender_endpoint;
   * socket.receive_from(
   *     mxasio::buffer(data, size), sender_endpoint);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
      ...
      endpoint_type& sender_endpoint)
  {
    ...
    mxasio::detail::throw_error(ec, "receive_from");
    return s;
  }
   ...
   *     mxasio::buffer(data, size), 0, sender_endpoint, handler); @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   *
...
#endif // MXASIO_BASIC_RAW_SOCKET_HPP

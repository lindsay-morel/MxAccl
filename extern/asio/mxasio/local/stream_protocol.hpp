...
#ifndef MXASIO_LOCAL_STREAM_PROTOCOL_HPP
#define MXASIO_LOCAL_STREAM_PROTOCOL_HPP
...
/**
 * The mxasio::local::stream_protocol class contains flags necessary for
...
#endif // MXASIO_LOCAL_STREAM_PROTOCOL_HPP

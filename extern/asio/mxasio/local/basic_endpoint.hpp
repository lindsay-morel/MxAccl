...
#ifndef MXASIO_LOCAL_BASIC_ENDPOINT_HPP
#define MXASIO_LOCAL_BASIC_ENDPOINT_HPP
...
/**
 * The mxasio::local::basic_endpoint class template describes an endpoint
...
private:
  ...
  mxasio::local::detail::endpoint impl_;
};
 ...
 *
 * @relates mxasio::local::basic_endpoint
 */
...
#endif // MXASIO_LOCAL_BASIC_ENDPOINT_HPP

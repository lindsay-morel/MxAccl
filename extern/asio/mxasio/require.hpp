...
#ifndef MXASIO_REQUIRE_HPP
#define MXASIO_REQUIRE_HPP
 ...
 * expression <tt>mxasio::require(E, P0, Pn...)</tt> for some
 ...
 *   <tt>mxasio::require(E, P0, Pn...)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise,
 *   <tt>mxasio::require(mxasio::require(E, P0), Pn...)</tt>
 *   if <tt>N > 0</tt> and the expression
 *   <tt>mxasio::require(mxasio::require(E, P0), Pn...)</tt>
 *   is a valid expression.
 *
 * @li Otherwise, <tt>mxasio::require(E, P0, Pn...)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>mxasio::require(std::declval<T>(),
 ...
 * type of the expression <tt>mxasio::require(std::declval<T>(),
...
static constexpr const mxasio_require_fn::impl&
  require = mxasio_require_fn::static_instance<>::instance;

} // namespace

typedef mxasio_require_fn::impl require_t;

template <typename T, typename... Properties>
struct can_require :
  integral_constant<bool,
    mxasio_require_fn::call_traits<
      require_t, T, void(Properties...)>::overload
        != mxasio_require_fn::ill_formed>
{
};
...
struct require_result
{
  typedef typename mxasio_require_fn::call_traits<

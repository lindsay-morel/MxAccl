...
#ifndef MXASIO_DETAIL_WINSOCK_INIT_HPP
#define MXASIO_DETAIL_WINSOCK_INIT_HPP
...
protected:
  ...
  MXASIO_DECL static void startup(data& d,
      unsigned char major, unsigned char minor);

  MXASIO_DECL static void manual_startup(data& d);

  MXASIO_DECL static void cleanup(data& d);

  MXASIO_DECL static void manual_cleanup(data& d);

  MXASIO_DECL static void throw_on_error(data& d);
};
...
public:
  ...
  //   #pragma init_seg(lib)
  //   mxasio::detail::winsock_init<>::manual manual_winsock_init;
  //   #pragma warning(pop)
  class manual
  {
  public:
...
#endif // MXASIO_DETAIL_WINSOCK_INIT_HPP

...
#ifndef MXASIO_DETAIL_IO_URING_NULL_BUFFERS_OP_HPP
#define MXASIO_DETAIL_IO_URING_NULL_BUFFERS_OP_HPP
...
{
public:
  MXASIO_DEFINE_HANDLER_PTR(io_uring_null_buffers_op);

  io_uring_null_buffers_op(const mxasio::error_code& success_ec,
...
#endif // MXASIO_DETAIL_IO_URING_NULL_BUFFERS_OP_HPP

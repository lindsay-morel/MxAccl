...
#ifndef MXASIO_DETAIL_SOCKET_OPTION_HPP
#define MXASIO_DETAIL_SOCKET_OPTION_HPP
...
public:
  ...
  {
    enabled(e);
    timeout MXASIO_PREVENT_MACRO_SUBSTITUTION(t);
  }
  ...
  void timeout MXASIO_PREVENT_MACRO_SUBSTITUTION(int value)
  {
#if defined(WIN32)
  ...
  int timeout MXASIO_PREVENT_MACRO_SUBSTITUTION() const
  {
...
#endif // MXASIO_DETAIL_SOCKET_OPTION_HPP

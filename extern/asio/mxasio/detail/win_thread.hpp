...
#ifndef MXASIO_DETAIL_WIN_THREAD_HPP
#define MXASIO_DETAIL_WIN_THREAD_HPP
...
MXASIO_DECL unsigned int __stdcall win_thread_function(void* arg);

#if defined(WINVER) && (WINVER < 0x0500)
MXASIO_DECL void __stdcall apc_function(ULONG data);
#else
MXASIO_DECL void __stdcall apc_function(ULONG_PTR data);
#endif
...
private:
  friend MXASIO_DECL unsigned int __stdcall win_thread_function(void* arg);

#if defined(WINVER) && (WINVER < 0x0500)
  friend MXASIO_DECL void __stdcall apc_function(ULONG);
#else
  friend MXASIO_DECL void __stdcall apc_function(ULONG_PTR);
#endif
  ...
  MXASIO_DECL void start_thread(func_base* arg, unsigned int stack_size);
...
#endif // MXASIO_DETAIL_WIN_THREAD_HPP

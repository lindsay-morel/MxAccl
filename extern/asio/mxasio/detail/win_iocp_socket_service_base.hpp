...
#ifndef MXASIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_BASE_HPP
#define MXASIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_BASE_HPP
...
#include "mxasio/detail/socket_holder.hpp"
#include "mxasio/detail/socket_ops.hpp"
#include "mxasio/detail/socket_types.hpp"
#include "mxasio/detail/win_iocp_io_context.hpp"
#include "mxasio/detail/win_iocp_null_buffers_op.hpp"
#include "mxasio/detail/win_iocp_socket_connect_op.hpp"
#include "mxasio/detail/win_iocp_socket_send_op.hpp"
#include "mxasio/detail/win_iocp_socket_recv_op.hpp"
#include "mxasio/detail/win_iocp_socket_recvmsg_op.hpp"
#include "mxasio/detail/win_iocp_wait_op.hpp"
...
public:
...
#if defined(MXASIO_ENABLE_CANCELIO)
    // The ID of the thread from which it is safe to cancel asynchronous
    // operations. 0 means no asynchronous operations have been started yet.
    // ~0 means asynchronous operations have been started from more than one
    // thread, and cancellation is not supported for the socket.
    DWORD safe_cancellation_thread_id_;
#endif // defined(MXASIO_ENABLE_CANCELIO)
  ...
  // Constructor.
  MXASIO_DECL win_iocp_socket_service_base(execution_context& context);

  // Destroy all user-defined handler objects owned by the service.
  MXASIO_DECL void base_shutdown();

  // Construct a new socket implementation.
  MXASIO_DECL void construct(base_implementation_type& impl);

  // Move-construct a new socket implementation.
  MXASIO_DECL void base_move_construct(base_implementation_type& impl,
      base_implementation_type& other_impl) noexcept;

  // Move-assign from another socket implementation.
  MXASIO_DECL void base_move_assign(base_implementation_type& impl,
      win_iocp_socket_service_base& other_service,
      base_implementation_type& other_impl);

  // Destroy a socket implementation.
  MXASIO_DECL void destroy(base_implementation_type& impl);
  ...
  // Destroy a socket implementation.
  MXASIO_DECL mxasio::error_code close(
      base_implementation_type& impl, mxasio::error_code& ec);

  // Release ownership of the socket.
  MXASIO_DECL socket_type release(
      base_implementation_type& impl, mxasio::error_code& ec);

  // Cancel all operations associated with the socket.
  MXASIO_DECL mxasio::error_code cancel(
      base_implementation_type& impl, mxasio::error_code& ec);
  ...
  mxasio::error_code listen(base_implementation_type& impl,
  ...
  mxasio::error_code io_control(base_implementation_type& impl,
      IO_Control_Command& command, mxasio::error_code& ec)
  {
  ...
  mxasio::error_code non_blocking(base_implementation_type& impl,
  ...
  mxasio::error_code native_non_blocking(base_implementation_type& impl,
      bool mode, mxasio::error_code& ec)
  {
  ...
  mxasio::error_code wait(base_implementation_type& impl,
      socket_base::wait_type w, mxasio::error_code& ec)
  {
    switch (w)
    {
      ...
      socket_base::wait_type w, Handler& handler, const IoExecutor& io_ex)
  {
    ...
    bool is_continuation =
      mxasio_handler_cont_helpers::is_continuation(handler);
    ...
    MXASIO_HANDLER_CREATION((context_, *p.p, "socket",
    ...
    switch (w)
    {
      ...
      case socket_base::wait_error:
        ...
        break;
      default:
        p.p->ec_ = mxasio::error::invalid_argument;
  ...
  size_t send(base_implementation_type& impl,
      ...
      socket_base::message_flags flags, mxasio::error_code& ec)
  {
    buffer_sequence_adapter<mxasio::const_buffer,
  ...
  size_t send(base_implementation_type& impl, const null_buffers&,
      socket_base::message_flags, mxasio::error_code& ec)
  {
  ...
  size_t receive_with_flags(base_implementation_type& impl,
      ...
      socket_base::message_flags& out_flags, mxasio::error_code& ec)
  {
    buffer_sequence_adapter<mxasio::mutable_buffer,
        MutableBufferSequence> bufs(buffers);
  ...
  MXASIO_DECL void restart_accept_op(socket_type s,
...
protected:
  ...
  MXASIO_DECL mxasio::error_code do_open(
      base_implementation_type& impl, int family, int type,
      int protocol, mxasio::error_code& ec);

  // Assign a native socket to a socket implementation.
  MXASIO_DECL mxasio::error_code do_assign(
      base_implementation_type& impl, int type,
      socket_type native_socket, mxasio::error_code& ec);

  // Helper function to start an asynchronous send operation.
  MXASIO_DECL void start_send_op(base_implementation_type& impl,
      WSABUF* buffers, std::size_t buffer_count,
      socket_base::message_flags flags, bool noop, operation* op);

  // Helper function to start an asynchronous send_to operation.
  MXASIO_DECL void start_send_to_op(base_implementation_type& impl,
  ...
  MXASIO_DECL void start_receive_op(base_implementation_type& impl,
      WSABUF* buffers, std::size_t buffer_count,
      socket_base::message_flags flags, bool noop, operation* op);

  // Helper function to start an asynchronous null_buffers receive operation.
  MXASIO_DECL int start_null_buffers_receive_op(
  ...
  MXASIO_DECL void start_receive_from_op(base_implementation_type& impl,
      WSABUF* buffers, std::size_t buffer_count, void* addr,
      socket_base::message_flags flags, int* addrlen, operation* op);

  // Helper function to start an asynchronous accept operation.
  MXASIO_DECL void start_accept_op(base_implementation_type& impl,
      bool peer_is_open, socket_holder& new_socket, int family, int type,
      int protocol, void* output_buffer, DWORD address_length, operation* op);

  // Start an asynchronous read or write operation using the reactor.
  MXASIO_DECL void start_reactor_op(base_implementation_type& impl,
      int op_type, reactor_op* op);

  // Start the asynchronous connect operation using the reactor.
  MXASIO_DECL int start_connect_op(base_implementation_type& impl,
  ...
  // destroyed.
  MXASIO_DECL void close_for_destruction(base_implementation_type& impl);

  // Update the ID of the thread from which cancellation is safe.
  MXASIO_DECL void update_cancellation_thread_id(
  ...
  MXASIO_DECL select_reactor& get_reactor();
  ...
  MXASIO_DECL connect_ex_fn get_connect_ex(
      base_implementation_type& impl, int type);
  ...
  MXASIO_DECL nt_set_info_fn get_nt_set_info();

  // Helper function to emulate InterlockedCompareExchangePointer functionality
  // for:
  // - very old Platform SDKs; and
  // - platform SDKs where MSVC's /Wp64 option causes spurious warnings.
  MXASIO_DECL void* interlocked_compare_exchange_pointer(
      void** dest, void* exch, void* cmp);

  // Helper function to emulate InterlockedExchangePointer functionality for:
  // - very old Platform SDKs; and
  // - platform SDKs where MSVC's /Wp64 option causes spurious warnings.
  MXASIO_DECL void* interlocked_exchange_pointer(void** dest, void* val);
  ...
  public:
    ...
    static void do_complete(void* owner, operation* base,
        const mxasio::error_code& result_ec,
...
#endif // MXASIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_BASE_HPP

...
#ifndef MXASIO_DETAIL_THREAD_INFO_BASE_HPP
#define MXASIO_DETAIL_THREAD_INFO_BASE_HPP
...
#ifndef MXASIO_RECYCLING_ALLOCATOR_CACHE_SIZE
# define MXASIO_RECYCLING_ALLOCATOR_CACHE_SIZE 2
#endif // MXASIO_RECYCLING_ALLOCATOR_CACHE_SIZE
...
public:
  struct default_tag
  {
    enum
    {
      cache_size = MXASIO_RECYCLING_ALLOCATOR_CACHE_SIZE,
      begin_mem_index = 0,
  ...
  static void* allocate(thread_info_base* this_thread,
      std::size_t size, std::size_t align = MXASIO_DEFAULT_ALIGN)
  {
...
private:
  ...
  enum { chunk_size = 8 };
#else // defined(MXASIO_HAS_IO_URING)
  enum { chunk_size = 4 };
...
#endif // MXASIO_DETAIL_THREAD_INFO_BASE_HPP

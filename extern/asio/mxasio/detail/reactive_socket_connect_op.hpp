...
#ifndef MXASIO_DETAIL_REACTIVE_SOCKET_CONNECT_OP_HPP
#define MXASIO_DETAIL_REACTIVE_SOCKET_CONNECT_OP_HPP
...
{
public:
  reactive_socket_connect_op_base(const mxasio::error_code& success_ec,
  ...
  static status do_perform(reactor_op* base)
  {
    ...
    MXASIO_HANDLER_REACTOR_OPERATION((*o, "non_blocking_connect", o->ec_));
...
public:
  ...
  MXASIO_DEFINE_HANDLER_PTR(reactive_socket_connect_op);

  reactive_socket_connect_op(const mxasio::error_code& success_ec,
...
#endif // MXASIO_DETAIL_REACTIVE_SOCKET_CONNECT_OP_HPP

...
#ifndef MXASIO_DETAIL_DEADLINE_TIMER_SERVICE_HPP
#define MXASIO_DETAIL_DEADLINE_TIMER_SERVICE_HPP
...
#include "mxasio/detail/timer_queue_ptime.hpp"
#include "mxasio/detail/timer_scheduler.hpp"
...
public:
  ...
  deadline_timer_service(execution_context& context)
    : execution_context_service_base<
      ...
      scheduler_(mxasio::use_service<timer_scheduler>(context))
  {
  ...
  std::size_t cancel(implementation_type& impl, mxasio::error_code& ec)
  {
    if (!impl.might_have_pending_waits)
    {
  ...
  std::size_t expires_at(implementation_type& impl,
      const time_type& expiry_time, mxasio::error_code& ec)
  {
  ...
  std::size_t expires_after(implementation_type& impl,
      const duration_type& expiry_time, mxasio::error_code& ec)
  {
  ...
  void wait(implementation_type& impl, mxasio::error_code& ec)
  {
...
private:
  ...
  void do_wait(const Duration& timeout, mxasio::error_code& ec)
  {
#if defined(MXASIO_WINDOWS_RUNTIME)
...
#endif // MXASIO_DETAIL_DEADLINE_TIMER_SERVICE_HPP

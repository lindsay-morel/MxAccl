...
#ifndef MXASIO_DETAIL_REACTIVE_SOCKET_RECVFROM_OP_HPP
#define MXASIO_DETAIL_REACTIVE_SOCKET_RECVFROM_OP_HPP
...
{
public:
  reactive_socket_recvfrom_op_base(const mxasio::error_code& success_ec,
  ...
  static status do_perform(reactor_op* base)
  {
    ...
    MXASIO_HANDLER_REACTOR_OPERATION((*o, "non_blocking_recvfrom",
...
public:
  ...
  MXASIO_DEFINE_HANDLER_PTR(reactive_socket_recvfrom_op);

  reactive_socket_recvfrom_op(const mxasio::error_code& success_ec,
      socket_type socket, int protocol_type,
      const MutableBufferSequence& buffers, Endpoint& endpoint,
...
#endif // MXASIO_DETAIL_REACTIVE_SOCKET_RECVFROM_OP_HPP

...
#ifndef MXASIO_DETAIL_WIN_IOCP_SOCKET_RECVFROM_OP_HPP
#define MXASIO_DETAIL_WIN_IOCP_SOCKET_RECVFROM_OP_HPP
...
{
public:
  MXASIO_DEFINE_HANDLER_PTR(win_iocp_socket_recvfrom_op);
...
#endif // MXASIO_DETAIL_WIN_IOCP_SOCKET_RECVFROM_OP_HPP

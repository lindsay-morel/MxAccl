...
#ifndef MXASIO_DETAIL_SELECT_REACTOR_HPP
#define MXASIO_DETAIL_SELECT_REACTOR_HPP
...
public:
  ...
  // Constructor.
  MXASIO_DECL select_reactor(mxasio::execution_context& ctx);

  // Destructor.
  MXASIO_DECL ~select_reactor();
...
private:
  ...
  MXASIO_DECL timeval* get_timeout(long usec, timeval& tv);
...
#include "mxasio/detail/impl/select_reactor.hpp"
...
#endif // MXASIO_DETAIL_SELECT_REACTOR_HPP

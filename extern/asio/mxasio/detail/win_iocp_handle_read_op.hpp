...
#ifndef MXASIO_DETAIL_WIN_IOCP_HANDLE_READ_OP_HPP
#define MXASIO_DETAIL_WIN_IOCP_HANDLE_READ_OP_HPP
...
{
public:
  MXASIO_DEFINE_HANDLER_PTR(win_iocp_handle_read_op);
...
#endif // MXASIO_DETAIL_WIN_IOCP_HANDLE_READ_OP_HPP

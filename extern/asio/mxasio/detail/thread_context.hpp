...
#ifndef MXASIO_DETAIL_THREAD_CONTEXT_HPP
#define MXASIO_DETAIL_THREAD_CONTEXT_HPP
...
public:
  ...
  MXASIO_DECL static thread_info_base* top_of_thread_call_stack();
...
#endif // MXASIO_DETAIL_THREAD_CONTEXT_HPP

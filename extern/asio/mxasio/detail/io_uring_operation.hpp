...
#ifndef MXASIO_DETAIL_IO_URING_OPERATION_HPP
#define MXASIO_DETAIL_IO_URING_OPERATION_HPP
...
protected:
  ...
  io_uring_operation(const mxasio::error_code& success_ec,
...
#endif // MXASIO_DETAIL_IO_URING_OPERATION_HPP

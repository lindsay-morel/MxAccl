...
#ifndef MXASIO_DETAIL_NULL_SOCKET_SERVICE_HPP
#define MXASIO_DETAIL_NULL_SOCKET_SERVICE_HPP
...
public:
  ...
  mxasio::error_code open(implementation_type&,
      const protocol_type&, mxasio::error_code& ec)
  {
  ...
  mxasio::error_code assign(implementation_type&, const protocol_type&,
      const native_handle_type&, mxasio::error_code& ec)
  {
    ec = mxasio::error::operation_not_supported;
    return ec;
  }
  ...
  // Destroy a socket implementation.
  mxasio::error_code close(implementation_type&,
  ...
  mxasio::error_code cancel(implementation_type&,
      mxasio::error_code& ec)
  {
    ec = mxasio::error::operation_not_supported;
    return ec;
  ...
  mxasio::error_code listen(implementation_type&,
      int, mxasio::error_code& ec)
  {
    ec = mxasio::error::operation_not_supported;
    return ec;
  }
  ...
  mxasio::error_code io_control(implementation_type&,
  ...
  mxasio::error_code non_blocking(implementation_type&,
  ...
  mxasio::error_code native_non_blocking(implementation_type&,
      bool, mxasio::error_code& ec)
  {
    ec = mxasio::error::operation_not_supported;
    return ec;
  ...
  mxasio::error_code shutdown(implementation_type&,
      socket_base::shutdown_type, mxasio::error_code& ec)
  {
    ec = mxasio::error::operation_not_supported;
    return ec;
  }
  ...
  mxasio::error_code bind(implementation_type&,
      const endpoint_type&, mxasio::error_code& ec)
  {
    ec = mxasio::error::operation_not_supported;
    return ec;
  }
  ...
  mxasio::error_code set_option(implementation_type&,
      const Option&, mxasio::error_code& ec)
  {
    ec = mxasio::error::operation_not_supported;
    return ec;
  }
  ...
  // Set a socket option.
  template <typename Option>
  mxasio::error_code get_option(const implementation_type&,
      Option&, mxasio::error_code& ec) const
  {
    ec = mxasio::error::operation_not_supported;
    return ec;
  }
      ...
      socket_base::message_flags, Handler& handler, const IoExecutor& io_ex)
  {
    ...
    mxasio::post(io_ex, detail::bind_handler(
  ...
  mxasio::error_code accept(implementation_type&,
      Socket&, endpoint_type*, mxasio::error_code& ec)
  {
    ec = mxasio::error::operation_not_supported;
    return ec;
  }
  ...
  {
    mxasio::error_code ec = mxasio::error::operation_not_supported;
    mxasio::post(io_ex, detail::bind_handler(handler, ec));
  }

  // Connect the socket to the specified endpoint.
  mxasio::error_code connect(implementation_type&,
      const endpoint_type&, mxasio::error_code& ec)
  {
    ec = mxasio::error::operation_not_supported;
    return ec;
...
#endif // MXASIO_DETAIL_NULL_SOCKET_SERVICE_HPP

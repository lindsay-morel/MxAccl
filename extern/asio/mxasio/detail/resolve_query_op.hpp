...
#ifndef MXASIO_DETAIL_RESOLVE_QUERY_OP_HPP
#define MXASIO_DETAIL_RESOLVE_QUERY_OP_HPP
...
{
public:
  MXASIO_DEFINE_HANDLER_PTR(resolve_query_op);
...
private:
  ...
  mxasio::detail::addrinfo_type* addrinfo_;
};
...
#endif // MXASIO_DETAIL_RESOLVE_QUERY_OP_HPP

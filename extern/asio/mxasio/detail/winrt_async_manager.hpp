...
#ifndef MXASIO_DETAIL_WINRT_ASYNC_MANAGER_HPP
#define MXASIO_DETAIL_WINRT_ASYNC_MANAGER_HPP
...
public:
      ...
      mxasio::error_code& ec)
  {
    ...
    auto promise = std::make_shared<std::promise<mxasio::error_code>>();
    ...
    action->Completed = ref new AsyncActionCompletedHandler(
      [promise](IAsyncAction^ action, AsyncStatus status)
      {
        ...
        case AsyncStatus::Canceled:
          promise->set_value(mxasio::error::operation_aborted);
          break;
      ...
      winrt_async_op<void>* handler)
  {
    ...
    auto on_completed = ref new AsyncActionCompletedHandler(
      [this, handler](IAsyncAction^ action, AsyncStatus status)
      {
        ...
        {
        case AsyncStatus::Canceled:
          handler->ec_ = mxasio::error::operation_aborted;
          break;
        case AsyncStatus::Started:
          return;
        case AsyncStatus::Completed:
...
#endif // MXASIO_DETAIL_WINRT_ASYNC_MANAGER_HPP

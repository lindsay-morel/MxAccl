...
#ifndef MXASIO_DETAIL_REACTIVE_SOCKET_SERVICE_BASE_HPP
#define MXASIO_DETAIL_REACTIVE_SOCKET_SERVICE_BASE_HPP
...
#include "mxasio/detail/reactive_null_buffers_op.hpp"
#include "mxasio/detail/reactive_socket_recv_op.hpp"
#include "mxasio/detail/reactive_socket_recvmsg_op.hpp"
#include "mxasio/detail/reactive_socket_send_op.hpp"
#include "mxasio/detail/reactive_wait_op.hpp"
...
public:
  ...
  // Constructor.
  MXASIO_DECL reactive_socket_service_base(execution_context& context);
      ...
      socket_base::wait_type w, Handler& handler, const IoExecutor& io_ex)
  {
    ...
    MXASIO_HANDLER_CREATION((reactor_.context(), *p.p, "socket",
  ...
  {
    typedef buffer_sequence_adapter<mxasio::const_buffer,
...
protected:
  ...
  MXASIO_DECL mxasio::error_code do_open(
      ...
      int type, int protocol, mxasio::error_code& ec);
  ...
  MXASIO_DECL void do_start_op(base_implementation_type& impl, int op_type,
  ...
  MXASIO_DECL void do_start_accept_op(base_implementation_type& impl,
  ...
  MXASIO_DECL void do_start_connect_op(base_implementation_type& impl,
  ...
  const mxasio::error_code success_ec_;
};
...
#endif // MXASIO_DETAIL_REACTIVE_SOCKET_SERVICE_BASE_HPP

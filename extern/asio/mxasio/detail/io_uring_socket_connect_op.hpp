...
#ifndef MXASIO_DETAIL_IO_URING_SOCKET_CONNECT_OP_HPP
#define MXASIO_DETAIL_IO_URING_SOCKET_CONNECT_OP_HPP
...
{
public:
  io_uring_socket_connect_op_base(const mxasio::error_code& success_ec,
...
{
public:
  MXASIO_DEFINE_HANDLER_PTR(io_uring_socket_connect_op);

  io_uring_socket_connect_op(const mxasio::error_code& success_ec,
      socket_type socket, const typename Protocol::endpoint& endpoint,
...
#endif // MXASIO_DETAIL_IO_URING_SOCKET_CONNECT_OP_HPP

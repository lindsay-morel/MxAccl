...
#ifndef MXASIO_DETAIL_KQUEUE_REACTOR_HPP
#define MXASIO_DETAIL_KQUEUE_REACTOR_HPP
...
public:
  ...
  // Constructor.
  MXASIO_DECL kqueue_reactor(mxasio::execution_context& ctx);

  // Destructor.
  MXASIO_DECL ~kqueue_reactor();
...
private:
  ...
  // cannot be created.
  MXASIO_DECL static int do_kqueue_create();
  ...
  MXASIO_DECL timespec* get_timeout(long usec, timespec& ts);
...
#include "mxasio/detail/impl/kqueue_reactor.hpp"
...
#endif // MXASIO_DETAIL_KQUEUE_REACTOR_HPP

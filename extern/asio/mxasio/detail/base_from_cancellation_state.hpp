...
#ifndef MXASIO_DETAIL_BASE_FROM_CANCELLATION_STATE_HPP
#define MXASIO_DETAIL_BASE_FROM_CANCELLATION_STATE_HPP
...
protected:
  ...
  base_from_cancellation_state(const Handler& handler, Filter filter)
    : cancellation_state_(
        mxasio::get_associated_cancellation_slot(handler), filter, filter)
  {
  }
...
#endif // MXASIO_DETAIL_BASE_FROM_CANCELLATION_STATE_HPP

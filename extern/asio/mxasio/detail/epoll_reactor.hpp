...
#ifndef MXASIO_DETAIL_EPOLL_REACTOR_HPP
#define MXASIO_DETAIL_EPOLL_REACTOR_HPP
...
public:
  ...
  class descriptor_state : operation
  {
    ...
    MXASIO_DECL descriptor_state(bool locking);
    void set_ready_events(uint32_t events) { task_result_ = events; }
    void add_ready_events(uint32_t events) { task_result_ |= events; }
    MXASIO_DECL operation* perform_io(uint32_t events);
    MXASIO_DECL static void do_complete(
  ...
  // Constructor.
  MXASIO_DECL epoll_reactor(mxasio::execution_context& ctx);

  // Destructor.
  MXASIO_DECL ~epoll_reactor();
  ...
  // code on failure.
  MXASIO_DECL int register_descriptor(socket_type descriptor,
  ...
  MXASIO_DECL void cancel_ops(socket_type descriptor,
      per_descriptor_data& descriptor_data);
  ...
  // descriptor data.
  MXASIO_DECL void cleanup_descriptor_data(
      per_descriptor_data& descriptor_data);
...
private:
  ...
  // cannot be created.
  MXASIO_DECL static int do_epoll_create();

  // Create the timerfd file descriptor. Does not throw.
  MXASIO_DECL static int do_timerfd_create();

  // Allocate a new descriptor state object.
  MXASIO_DECL descriptor_state* allocate_descriptor_state();

  // Free an existing descriptor state object.
  MXASIO_DECL void free_descriptor_state(descriptor_state* s);
  ...
  MXASIO_DECL int get_timeout(itimerspec& ts);
#endif // defined(MXASIO_HAS_TIMERFD)
...
#include "mxasio/detail/impl/epoll_reactor.hpp"
...
#endif // MXASIO_DETAIL_EPOLL_REACTOR_HPP

...
#ifndef MXASIO_DETAIL_STRAND_EXECUTOR_SERVICE_HPP
#define MXASIO_DETAIL_STRAND_EXECUTOR_SERVICE_HPP
...
public:
  ...
  MXASIO_DECL explicit strand_executor_service(execution_context& context);

  // Destroy all user-defined handler objects owned by the service.
  MXASIO_DECL void shutdown();

  // Create a new strand_executor implementation.
  MXASIO_DECL implementation_type create_implementation();
  ...
  MXASIO_DECL static bool running_in_this_thread(
...
private:
  ...
  MXASIO_DECL static bool enqueue(const implementation_type& impl,
      scheduler_operation* op);

  // Transfers waiting handlers to the ready queue. Returns true if one or more
  // handlers were transferred.
  MXASIO_DECL static bool push_waiting_to_ready(implementation_type& impl);

  // Invokes all ready-to-run handlers.
  MXASIO_DECL static void run_ready_handlers(implementation_type& impl);

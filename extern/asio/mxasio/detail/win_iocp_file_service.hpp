...
#ifndef MXASIO_DETAIL_WIN_IOCP_FILE_SERVICE_HPP
#define MXASIO_DETAIL_WIN_IOCP_FILE_SERVICE_HPP
...
#if defined(MXASIO_HAS_IOCP) && defined(MXASIO_HAS_FILE)
...
public:
  ...
  // Constructor.
  MXASIO_DECL win_iocp_file_service(execution_context& context);
  ...
  MXASIO_DECL uint64_t size(const implementation_type& impl,
      mxasio::error_code& ec) const;

  // Alter the size of the file.
  MXASIO_DECL mxasio::error_code resize(implementation_type& impl,
      uint64_t n, mxasio::error_code& ec);

  // Synchronise the file to disk.
  MXASIO_DECL mxasio::error_code sync_all(implementation_type& impl,
      mxasio::error_code& ec);

  // Synchronise the file data to disk.
  MXASIO_DECL mxasio::error_code sync_data(implementation_type& impl,
      mxasio::error_code& ec);

  // Seek to a position in the file.
  MXASIO_DECL uint64_t seek(implementation_type& impl, int64_t offset,
      file_base::seek_basis whence, mxasio::error_code& ec);
      ...
      const ConstBufferSequence& buffers, mxasio::error_code& ec)
  {
    ...
    impl.offset_ += mxasio::buffer_size(buffers);
...
#endif // defined(MXASIO_HAS_IOCP) && defined(MXASIO_HAS_FILE)

#endif // MXASIO_DETAIL_WIN_IOCP_FILE_SERVICE_HPP

...
#ifndef MXASIO_DETAIL_EXECUTOR_OP_HPP
#define MXASIO_DETAIL_EXECUTOR_OP_HPP
...
{
public:
  MXASIO_DEFINE_HANDLER_ALLOCATOR_PTR(executor_op);
...
#endif // MXASIO_DETAIL_EXECUTOR_OP_HPP

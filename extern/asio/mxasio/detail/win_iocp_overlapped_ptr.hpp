...
#ifndef MXASIO_DETAIL_WIN_IOCP_OVERLAPPED_PTR_HPP
#define MXASIO_DETAIL_WIN_IOCP_OVERLAPPED_PTR_HPP
...
#include "mxasio/detail/win_iocp_overlapped_op.hpp"
...
public:
  ...
  void reset(const Executor& ex, Handler handler)
  {
    ...
    MXASIO_HANDLER_CREATION((ex.context(), *p.p,
  ...
  void complete(const mxasio::error_code& ec,
...
private:
      ...
      >* = 0)
  {
    return &use_service<win_iocp_io_context>(
        mxasio::query(ex, execution::context));
  }
  ...
  {
    return &mxasio::query(ex, execution::context).impl_;
  }
...
#endif // MXASIO_DETAIL_WIN_IOCP_OVERLAPPED_PTR_HPP

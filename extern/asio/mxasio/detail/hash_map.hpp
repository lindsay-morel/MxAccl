...
#ifndef MXASIO_DETAIL_HASH_MAP_HPP
#define MXASIO_DETAIL_HASH_MAP_HPP
...
public:
  ...
  {
    MXASIO_ASSERT(it != values_.end());
    MXASIO_ASSERT(num_buckets_ != 0);
...
private:
  ...
  static std::size_t hash_size(std::size_t num_elems)
  {
    ...
    {
#if defined(MXASIO_HASH_MAP_BUCKETS)
      MXASIO_HASH_MAP_BUCKETS
#else // MXASIO_HASH_MAP_BUCKETS
      3, 13, 23, 53, 97, 193, 389, 769, 1543, 3079, 6151, 12289, 24593,
      49157, 98317, 196613, 393241, 786433, 1572869, 3145739, 6291469,
      12582917, 25165843
#endif // MXASIO_HASH_MAP_BUCKETS
    };
...
#endif // MXASIO_DETAIL_HASH_MAP_HPP

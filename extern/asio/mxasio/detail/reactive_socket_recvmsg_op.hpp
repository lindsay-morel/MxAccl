...
#ifndef MXASIO_DETAIL_REACTIVE_SOCKET_RECVMSG_OP_HPP
#define MXASIO_DETAIL_REACTIVE_SOCKET_RECVMSG_OP_HPP
...
{
public:
  reactive_socket_recvmsg_op_base(const mxasio::error_code& success_ec,
  ...
  static status do_perform(reactor_op* base)
  {
    ...
    MXASIO_HANDLER_REACTOR_OPERATION((*o, "non_blocking_recvmsg",
...
public:
  ...
  MXASIO_DEFINE_HANDLER_PTR(reactive_socket_recvmsg_op);

  reactive_socket_recvmsg_op(const mxasio::error_code& success_ec,
      socket_type socket, const MutableBufferSequence& buffers,
      socket_base::message_flags in_flags,
...
#endif // MXASIO_DETAIL_REACTIVE_SOCKET_RECVMSG_OP_HPP

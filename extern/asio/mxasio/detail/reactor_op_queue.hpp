...
#ifndef MXASIO_DETAIL_REACTOR_OP_QUEUE_HPP
#define MXASIO_DETAIL_REACTOR_OP_QUEUE_HPP
...
public:
  ...
  bool cancel_operations_by_key(iterator i, op_queue<operation>& ops,
      void* cancellation_key, const mxasio::error_code& ec =
        mxasio::error::operation_aborted)
  {
    bool result = false;
    if (i != operations_.end())
...
#endif // MXASIO_DETAIL_REACTOR_OP_QUEUE_HPP

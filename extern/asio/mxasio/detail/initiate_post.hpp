...
#ifndef MXASIO_DETAIL_INITIATE_POST_HPP
#define MXASIO_DETAIL_INITIATE_POST_HPP
...
public:
      ...
      >* = 0) const
  {
    ...
    ex.post(mxasio::detail::bind_handler(
...
public:
      ...
      >* = 0) const
  {
    ...
    ex_.post(mxasio::detail::bind_handler(
          static_cast<CompletionHandler&&>(handler)), alloc);
  }
...
#endif // MXASIO_DETAIL_INITIATE_POST_HPP

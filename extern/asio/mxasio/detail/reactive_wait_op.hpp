...
#ifndef MXASIO_DETAIL_REACTIVE_WAIT_OP_HPP
#define MXASIO_DETAIL_REACTIVE_WAIT_OP_HPP
...
public:
  ...
  MXASIO_DEFINE_HANDLER_PTR(reactive_wait_op);

  reactive_wait_op(const mxasio::error_code& success_ec,
...
#endif // MXASIO_DETAIL_REACTIVE_WAIT_OP_HPP

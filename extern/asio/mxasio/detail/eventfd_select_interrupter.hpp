...
#ifndef MXASIO_DETAIL_EVENTFD_SELECT_INTERRUPTER_HPP
#define MXASIO_DETAIL_EVENTFD_SELECT_INTERRUPTER_HPP
...
public:
  // Constructor.
  MXASIO_DECL eventfd_select_interrupter();
...
#endif // MXASIO_DETAIL_EVENTFD_SELECT_INTERRUPTER_HPP

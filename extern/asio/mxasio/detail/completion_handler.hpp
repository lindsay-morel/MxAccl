...
#ifndef MXASIO_DETAIL_COMPLETION_HANDLER_HPP
#define MXASIO_DETAIL_COMPLETION_HANDLER_HPP
...
{
public:
  MXASIO_DEFINE_HANDLER_PTR(completion_handler);
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    ptr p = { mxasio::detail::addressof(h->handler_), h, h };

    MXASIO_HANDLER_COMPLETION((*h));
    ...
    p.h = mxasio::detail::addressof(handler);
    p.reset();
...
#endif // MXASIO_DETAIL_COMPLETION_HANDLER_HPP

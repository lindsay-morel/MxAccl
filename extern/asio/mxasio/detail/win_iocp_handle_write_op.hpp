...
#ifndef MXASIO_DETAIL_WIN_IOCP_HANDLE_WRITE_OP_HPP
#define MXASIO_DETAIL_WIN_IOCP_HANDLE_WRITE_OP_HPP
...
{
public:
  MXASIO_DEFINE_HANDLER_PTR(win_iocp_handle_write_op);
  ...
  static void do_complete(void* owner, operation* base,
      const mxasio::error_code& result_ec, std::size_t bytes_transferred)
  {
...
#endif // MXASIO_DETAIL_WIN_IOCP_HANDLE_WRITE_OP_HPP

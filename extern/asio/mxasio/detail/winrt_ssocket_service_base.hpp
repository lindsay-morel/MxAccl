...
#ifndef MXASIO_DETAIL_WINRT_SSOCKET_SERVICE_BASE_HPP
#define MXASIO_DETAIL_WINRT_SSOCKET_SERVICE_BASE_HPP
...
#include "mxasio/detail/winrt_async_manager.hpp"
#include "mxasio/detail/winrt_socket_recv_op.hpp"
#include "mxasio/detail/winrt_socket_send_op.hpp"
...
public:
  ...
  // Constructor.
  MXASIO_DECL winrt_ssocket_service_base(execution_context& context);

  // Destroy all user-defined handler objects owned by the service.
  MXASIO_DECL void base_shutdown();

  // Construct a new socket implementation.
  MXASIO_DECL void construct(base_implementation_type&);
  ...
  MXASIO_DECL native_handle_type release(
      base_implementation_type& impl, mxasio::error_code& ec);
  ...
  mxasio::error_code cancel(base_implementation_type&,
  ...
  mxasio::error_code io_control(base_implementation_type&,
      IO_Control_Command&, mxasio::error_code& ec)
  {
    ec = mxasio::error::operation_not_supported;
    return ec;
  }
  ...
  mxasio::error_code non_blocking(base_implementation_type&,
      bool, mxasio::error_code& ec)
  {
    ec = mxasio::error::operation_not_supported;
    return ec;
  }
  ...
  mxasio::error_code native_non_blocking(base_implementation_type&,
      bool, mxasio::error_code& ec)
  {
    ec = mxasio::error::operation_not_supported;
    return ec;
  ...
  {
    mxasio::error_code ec = mxasio::error::operation_not_supported;
...
protected:
  ...
  MXASIO_DECL std::size_t do_get_endpoint(
      const base_implementation_type& impl, bool local,
      void* addr, std::size_t addr_len, mxasio::error_code& ec) const;
  ...
  MXASIO_DECL void do_get_option(
      const base_implementation_type& impl,
      int level, int optname, void* optval,
      std::size_t* optlen, mxasio::error_code& ec) const;

  // Helper function to perform a synchronous connect.
  MXASIO_DECL mxasio::error_code do_connect(
      base_implementation_type& impl,
      const void* addr, mxasio::error_code& ec);

  // Helper function to start an asynchronous connect.
  MXASIO_DECL void start_connect_op(
...
#endif // MXASIO_DETAIL_WINRT_SSOCKET_SERVICE_BASE_HPP

...
#ifndef MXASIO_DETAIL_IO_URING_SOCKET_SENDTO_OP_HPP
#define MXASIO_DETAIL_IO_URING_SOCKET_SENDTO_OP_HPP
...
{
public:
  io_uring_socket_sendto_op_base(const mxasio::error_code& success_ec,
...
private:
  ...
  buffer_sequence_adapter<mxasio::const_buffer, ConstBufferSequence> bufs_;
  msghdr msghdr_;
};
...
{
public:
  MXASIO_DEFINE_HANDLER_PTR(io_uring_socket_sendto_op);

  io_uring_socket_sendto_op(const mxasio::error_code& success_ec,
...
#endif // MXASIO_DETAIL_IO_URING_SOCKET_SENDTO_OP_HPP

...
#ifndef MXASIO_DETAIL_WINRT_SOCKET_SEND_OP_HPP
#define MXASIO_DETAIL_WINRT_SOCKET_SEND_OP_HPP
...
{
public:
  MXASIO_DEFINE_HANDLER_PTR(winrt_socket_send_op);
...
#endif // MXASIO_DETAIL_WINRT_SOCKET_SEND_OP_HPP

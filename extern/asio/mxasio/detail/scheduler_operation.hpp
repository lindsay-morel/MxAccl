...
#ifndef MXASIO_DETAIL_SCHEDULER_OPERATION_HPP
#define MXASIO_DETAIL_SCHEDULER_OPERATION_HPP
...
class scheduler_operation MXASIO_INHERIT_TRACKED_HANDLER
{
public:
...
#endif // MXASIO_DETAIL_SCHEDULER_OPERATION_HPP

...
#ifndef MXASIO_DETAIL_IMPL_REACTIVE_SOCKET_SERVICE_BASE_IPP
#define MXASIO_DETAIL_IMPL_REACTIVE_SOCKET_SERVICE_BASE_IPP
...
mxasio::error_code reactive_socket_service_base::close(
    reactive_socket_service_base::base_implementation_type& impl,
...
mxasio::error_code reactive_socket_service_base::cancel(
    reactive_socket_service_base::base_implementation_type& impl,
    mxasio::error_code& ec)
{
  if (!is_open(impl))
...
mxasio::error_code reactive_socket_service_base::do_open(
    reactive_socket_service_base::base_implementation_type& impl,
...
mxasio::error_code reactive_socket_service_base::do_assign(
...
#endif // MXASIO_DETAIL_IMPL_REACTIVE_SOCKET_SERVICE_BASE_IPP

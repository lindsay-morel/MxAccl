...
#ifndef MXASIO_DETAIL_IMPL_RESOLVER_SERVICE_BASE_IPP
#define MXASIO_DETAIL_IMPL_RESOLVER_SERVICE_BASE_IPP
...
#include "mxasio/detail/resolver_service_base.hpp"
...
void resolver_service_base::start_work_thread()
{
  ...
  if (!work_thread_.get())
  {
    work_thread_.reset(new mxasio::detail::thread(
...
#endif // MXASIO_DETAIL_IMPL_RESOLVER_SERVICE_BASE_IPP

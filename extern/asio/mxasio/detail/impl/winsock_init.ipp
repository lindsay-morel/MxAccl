...
#ifndef MXASIO_DETAIL_IMPL_WINSOCK_INIT_IPP
#define MXASIO_DETAIL_IMPL_WINSOCK_INIT_IPP
...
void winsock_init_base::throw_on_error(data& d)
{
  ...
  if (result != 0)
  {
    ...
    mxasio::detail::throw_error(ec, "winsock");
  }
}
...
#endif // MXASIO_DETAIL_IMPL_WINSOCK_INIT_IPP

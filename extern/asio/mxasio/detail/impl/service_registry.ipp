...
#ifndef MXASIO_DETAIL_IMPL_SERVICE_REGISTRY_IPP
#define MXASIO_DETAIL_IMPL_SERVICE_REGISTRY_IPP
    ...
    execution_context::service* new_service)
{
  if (&owner_ != &new_service->context())
    mxasio::detail::throw_exception(invalid_service_owner());
  ...
  {
    if (keys_match(service->key_, key))
      mxasio::detail::throw_exception(service_already_exists());
    service = service->next_;
  }
...
#endif // MXASIO_DETAIL_IMPL_SERVICE_REGISTRY_IPP

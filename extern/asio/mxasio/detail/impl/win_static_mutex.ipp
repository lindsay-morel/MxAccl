...
#ifndef MXASIO_DETAIL_IMPL_WIN_STATIC_MUTEX_IPP
#define MXASIO_DETAIL_IMPL_WIN_STATIC_MUTEX_IPP
...
void win_static_mutex::init()
{
  ...
  mxasio::detail::throw_error(ec, "static_mutex");
}
...
#endif // MXASIO_DETAIL_IMPL_WIN_STATIC_MUTEX_IPP

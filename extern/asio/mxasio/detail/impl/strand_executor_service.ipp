...
#ifndef MXASIO_DETAIL_IMPL_STRAND_EXECUTOR_SERVICE_IPP
#define MXASIO_DETAIL_IMPL_STRAND_EXECUTOR_SERVICE_IPP
...
{
  mxasio::detail::mutex::scoped_lock lock(service_->mutex_);
...
#endif // MXASIO_DETAIL_IMPL_STRAND_EXECUTOR_SERVICE_IPP

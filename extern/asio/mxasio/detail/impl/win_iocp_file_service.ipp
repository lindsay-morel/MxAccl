...
#ifndef MXASIO_DETAIL_IMPL_WIN_IOCP_FILE_SERVICE_IPP
#define MXASIO_DETAIL_IMPL_WIN_IOCP_FILE_SERVICE_IPP
...
#include "mxasio/detail/config.hpp"
  ...
  && defined(MXASIO_HAS_WINDOWS_RANDOM_ACCESS_HANDLE)
...
mxasio::error_code win_iocp_file_service::open(
    ...
    if (disposition == OPEN_ALWAYS)
    {
      if ((open_flags & file_base::truncate) != 0)
      {
        if (!::SetEndOfFile(handle))
        {
          ...
          ::CloseHandle(handle);
          ec.assign(last_error, mxasio::error::get_system_category());
          MXASIO_ERROR_LOCATION(ec);
          return ec;
        }
      }
...
mxasio::error_code win_iocp_file_service::resize(
    win_iocp_file_service::implementation_type& impl,
...
mxasio::error_code win_iocp_file_service::sync_all(
    win_iocp_file_service::implementation_type& impl,
    mxasio::error_code& ec)
{
...
mxasio::error_code win_iocp_file_service::sync_data(
    win_iocp_file_service::implementation_type& impl,
    mxasio::error_code& ec)
{
...
#endif // MXASIO_DETAIL_IMPL_WIN_IOCP_FILE_SERVICE_IPP

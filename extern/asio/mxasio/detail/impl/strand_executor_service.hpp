...
#ifndef MXASIO_DETAIL_IMPL_STRAND_EXECUTOR_SERVICE_HPP
#define MXASIO_DETAIL_IMPL_STRAND_EXECUTOR_SERVICE_HPP
    ...
    >*)
{
  return strand_executor_service::do_execute(impl, ex,
      ...
      mxasio::query(ex, execution::allocator));
}
    ...
    Executor& ex, Function&& function, const Allocator& a)
{
  ...
  if (mxasio::query(ex, execution::blocking) != execution::blocking.never
  ...
  MXASIO_HANDLER_CREATION((impl->service_->context(), *p.p,
...
#endif // MXASIO_DETAIL_IMPL_STRAND_EXECUTOR_SERVICE_HPP

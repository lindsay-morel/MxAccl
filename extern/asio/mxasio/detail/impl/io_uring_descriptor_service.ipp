...
#ifndef MXASIO_DETAIL_IMPL_IO_URING_DESCRIPTOR_SERVICE_IPP
#define MXASIO_DETAIL_IMPL_IO_URING_DESCRIPTOR_SERVICE_IPP
...
mxasio::error_code io_uring_descriptor_service::assign(
    io_uring_descriptor_service::implementation_type& impl,
...
mxasio::error_code io_uring_descriptor_service::close(
    io_uring_descriptor_service::implementation_type& impl,
...
mxasio::error_code io_uring_descriptor_service::cancel(
    io_uring_descriptor_service::implementation_type& impl,
    mxasio::error_code& ec)
{
  if (!is_open(impl))
...
#endif // MXASIO_DETAIL_IMPL_IO_URING_DESCRIPTOR_SERVICE_IPP

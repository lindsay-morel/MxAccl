...
#ifndef MXASIO_DETAIL_IMPL_STRAND_SERVICE_HPP
#define MXASIO_DETAIL_IMPL_STRAND_SERVICE_HPP
    ...
    Handler& handler)
{
  ...
  MXASIO_HANDLER_CREATION((this->context(),
...
#endif // MXASIO_DETAIL_IMPL_STRAND_SERVICE_HPP

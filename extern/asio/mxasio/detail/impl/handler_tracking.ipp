...
#ifndef MXASIO_DETAIL_IMPL_HANDLER_TRACKING_IPP
#define MXASIO_DETAIL_IMPL_HANDLER_TRACKING_IPP
...
struct handler_tracking_timestamp
{
  ...
  handler_tracking_timestamp()
  {
    ...
    typedef chrono_time_traits<chrono::system_clock,
        mxasio::wait_traits<chrono::system_clock>> traits_helper;
...
{
  static tracking_state state = { MXASIO_STATIC_MUTEX_INIT, 1, 0, 0 };
  return &state;
}
...
#endif // MXASIO_DETAIL_IMPL_HANDLER_TRACKING_IPP

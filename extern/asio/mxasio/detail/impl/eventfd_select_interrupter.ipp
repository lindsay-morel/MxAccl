...
#ifndef MXASIO_DETAIL_IMPL_EVENTFD_SELECT_INTERRUPTER_IPP
#define MXASIO_DETAIL_IMPL_EVENTFD_SELECT_INTERRUPTER_IPP
...
# endif // defined(EFD_CLOEXEC) && defined(EFD_NONBLOCK)
  ...
  if (read_descriptor_ == -1)
  {
    ...
    else
    {
      ...
      mxasio::detail::throw_error(ec, "eventfd_select_interrupter");
    }
  }
}
...
#endif // MXASIO_DETAIL_IMPL_EVENTFD_SELECT_INTERRUPTER_IPP

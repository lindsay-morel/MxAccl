...
#ifndef MXASIO_DETAIL_IMPL_IO_URING_SOCKET_SERVICE_BASE_IPP
#define MXASIO_DETAIL_IMPL_IO_URING_SOCKET_SERVICE_BASE_IPP
    ...
    io_uring_socket_service_base::base_implementation_type& impl)
{
  ...
  {
    MXASIO_HANDLER_OPERATION((io_uring_service_.context(),
...
mxasio::error_code io_uring_socket_service_base::close(
    io_uring_socket_service_base::base_implementation_type& impl,
...
mxasio::error_code io_uring_socket_service_base::cancel(
    io_uring_socket_service_base::base_implementation_type& impl,
    mxasio::error_code& ec)
{
  if (!is_open(impl))
...
mxasio::error_code io_uring_socket_service_base::do_open(
    io_uring_socket_service_base::base_implementation_type& impl,
    int af, int type, int protocol, mxasio::error_code& ec)
{
  if (is_open(impl))
  {
...
mxasio::error_code io_uring_socket_service_base::do_assign(
    ...
    io_uring_operation* op, bool is_continuation, bool peer_is_open)
{
  ...
  {
    op->ec_ = mxasio::error::already_open;
    io_uring_service_.post_immediate_completion(op, is_continuation);
  }
}
...
#endif // MXASIO_DETAIL_IMPL_IO_URING_SOCKET_SERVICE_BASE_IPP

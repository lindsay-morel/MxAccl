...
#ifndef MXASIO_DETAIL_IMPL_WINRT_TIMER_SCHEDULER_IPP
#define MXASIO_DETAIL_IMPL_WINRT_TIMER_SCHEDULER_IPP
...
winrt_timer_scheduler::winrt_timer_scheduler(execution_context& context)
  : execution_context_service_base<winrt_timer_scheduler>(context),
    ...
    shutdown_(false)
{
  thread_ = new mxasio::detail::thread(
...
#endif // MXASIO_DETAIL_IMPL_WINRT_TIMER_SCHEDULER_IPP

...
#ifndef MXASIO_DETAIL_IMPL_WIN_IOCP_IO_CONTEXT_HPP
#define MXASIO_DETAIL_IMPL_WIN_IOCP_IO_CONTEXT_HPP
...
{
  mxasio::detail::mutex::scoped_lock lock(dispatch_mutex_);
...
#endif // MXASIO_DETAIL_IMPL_WIN_IOCP_IO_CONTEXT_HPP

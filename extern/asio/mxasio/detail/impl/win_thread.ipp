...
#ifndef MXASIO_DETAIL_IMPL_WIN_THREAD_IPP
#define MXASIO_DETAIL_IMPL_WIN_THREAD_IPP
...
void win_thread::start_thread(func_base* arg, unsigned int stack_size)
{
  ...
  if (!entry_event)
  {
    ...
    mxasio::detail::throw_error(ec, "thread.entry_event");
  }
  ...
  if (!exit_event_)
  {
    ...
    mxasio::error_code ec(last_error,
        mxasio::error::get_system_category());
    mxasio::detail::throw_error(ec, "thread.exit_event");
  }
...
#endif // MXASIO_DETAIL_IMPL_WIN_THREAD_IPP

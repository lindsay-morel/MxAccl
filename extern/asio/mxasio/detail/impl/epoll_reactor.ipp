...
#ifndef MXASIO_DETAIL_IMPL_EPOLL_REACTOR_IPP
#define MXASIO_DETAIL_IMPL_EPOLL_REACTOR_IPP
...
epoll_reactor::epoll_reactor(mxasio::execution_context& ctx)
  ...
  if (fork_ev == mxasio::execution_context::fork_child)
  {
        ...
        state != 0; state = state->next_)
    {
      ...
      if (result != 0)
      {
        ...
        mxasio::detail::throw_error(ec, "epoll re-registration");
      }
    }
  }
}
...
#else // defined(MXASIO_HAS_TIMERFD)
...
int epoll_reactor::do_epoll_create()
{
  ...
  if (fd == -1)
  {
    mxasio::error_code ec(errno,
        mxasio::error::get_system_category());
    mxasio::detail::throw_error(ec, "epoll");
  }
...
#endif // MXASIO_DETAIL_IMPL_EPOLL_REACTOR_IPP

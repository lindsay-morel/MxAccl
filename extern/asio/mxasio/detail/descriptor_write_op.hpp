...
#ifndef MXASIO_DETAIL_DESCRIPTOR_WRITE_OP_HPP
#define MXASIO_DETAIL_DESCRIPTOR_WRITE_OP_HPP
...
{
public:
  descriptor_write_op_base(const mxasio::error_code& success_ec,
  ...
  static status do_perform(reactor_op* base)
  {
    ...
    MXASIO_HANDLER_REACTOR_OPERATION((*o, "non_blocking_write",
...
public:
  ...
  MXASIO_DEFINE_HANDLER_PTR(descriptor_write_op);

  descriptor_write_op(const mxasio::error_code& success_ec,
      int descriptor, const ConstBufferSequence& buffers,
...
#endif // MXASIO_DETAIL_DESCRIPTOR_WRITE_OP_HPP

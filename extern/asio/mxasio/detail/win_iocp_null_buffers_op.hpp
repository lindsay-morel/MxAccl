...
#ifndef MXASIO_DETAIL_WIN_IOCP_NULL_BUFFERS_OP_HPP
#define MXASIO_DETAIL_WIN_IOCP_NULL_BUFFERS_OP_HPP
...
{
public:
  MXASIO_DEFINE_HANDLER_PTR(win_iocp_null_buffers_op);
...
#endif // MXASIO_DETAIL_WIN_IOCP_NULL_BUFFERS_OP_HPP

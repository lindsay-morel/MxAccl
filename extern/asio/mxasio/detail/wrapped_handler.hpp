...
#ifndef MXASIO_DETAIL_WRAPPED_HANDLER_HPP
#define MXASIO_DETAIL_WRAPPED_HANDLER_HPP
...
struct is_continuation_delegated
{
  ...
  {
    return mxasio_handler_cont_helpers::is_continuation(handler);
  }
};
...
#endif // MXASIO_DETAIL_WRAPPED_HANDLER_HPP

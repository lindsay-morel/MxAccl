...
#ifndef MXASIO_DETAIL_INITIATE_DEFER_HPP
#define MXASIO_DETAIL_INITIATE_DEFER_HPP
...
public:
      ...
      >* = 0) const
  {
    ...
    mxasio::prefer(
        mxasio::require(ex, execution::blocking.never),
      ...
      >* = 0) const
  {
    ...
    ex.defer(mxasio::detail::bind_handler(
...
public:
      ...
      >* = 0) const
  {
    ...
    mxasio::prefer(
        mxasio::require(ex_, execution::blocking.never),
        execution::relationship.continuation,
        execution::allocator(alloc)
      ).execute(
        mxasio::detail::bind_handler(
      ...
      >* = 0) const
  {
    ...
    ex_.defer(mxasio::detail::bind_handler(
          static_cast<CompletionHandler&&>(handler)), alloc);
  }
...
#endif // MXASIO_DETAIL_INITIATE_DEFER_HPP

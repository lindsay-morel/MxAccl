...
#ifndef MXASIO_DETAIL_POSIX_FD_SET_ADAPTER_HPP
#define MXASIO_DETAIL_POSIX_FD_SET_ADAPTER_HPP
...
public:
  ...
  void set(reactor_op_queue<socket_type>& operations, op_queue<operation>& ops)
  {
    ...
    while (i != operations.end())
    {
      ...
      {
        mxasio::error_code ec(error::fd_set_failure);
...
#endif // MXASIO_DETAIL_POSIX_FD_SET_ADAPTER_HPP

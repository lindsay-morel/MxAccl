...
#ifndef MXASIO_DETAIL_WORK_DISPATCHER_HPP
#define MXASIO_DETAIL_WORK_DISPATCHER_HPP
...
public:
  ...
  work_dispatcher(CompletionHandler&& handler,
    ...
    : handler_(static_cast<CompletionHandler&&>(handler)),
      executor_(mxasio::prefer(handler_ex,
  ...
  void operator()()
  {
    ...
    mxasio::prefer(executor_, execution::allocator(alloc)).execute(
...
#endif // MXASIO_DETAIL_WORK_DISPATCHER_HPP

...
#ifndef MXASIO_DETAIL_IO_URING_SOCKET_SERVICE_BASE_HPP
#define MXASIO_DETAIL_IO_URING_SOCKET_SERVICE_BASE_HPP
...
#include "mxasio/detail/io_uring_null_buffers_op.hpp"
#include "mxasio/detail/io_uring_service.hpp"
#include "mxasio/detail/io_uring_socket_recv_op.hpp"
#include "mxasio/detail/io_uring_socket_recvmsg_op.hpp"
#include "mxasio/detail/io_uring_socket_send_op.hpp"
#include "mxasio/detail/io_uring_wait_op.hpp"
...
public:
  ...
  // Constructor.
  MXASIO_DECL io_uring_socket_service_base(execution_context& context);
      ...
      socket_base::wait_type w, Handler& handler, const IoExecutor& io_ex)
  {
    ...
    MXASIO_HANDLER_CREATION((io_uring_service_.context(), *p.p,
      ...
      const IoExecutor& io_ex)
  {
    ...
    MXASIO_HANDLER_CREATION((io_uring_service_.context(), *p.p, "socket",
...
protected:
  ...
  MXASIO_DECL void start_op(base_implementation_type& impl, int op_type,
...
#endif // MXASIO_DETAIL_IO_URING_SOCKET_SERVICE_BASE_HPP

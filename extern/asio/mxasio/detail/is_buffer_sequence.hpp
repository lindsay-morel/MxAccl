...
#ifndef MXASIO_DETAIL_IS_BUFFER_SEQUENCE_HPP
#define MXASIO_DETAIL_IS_BUFFER_SEQUENCE_HPP
...
char (&buffer_sequence_begin_helper(T* t,
    enable_if_t<!is_same<
      decltype(mxasio::buffer_sequence_begin(*t)),
        void>::value>*))[2];
...
char (&buffer_sequence_end_helper(T* t,
    enable_if_t<!is_same<
      decltype(mxasio::buffer_sequence_end(*t)),
        void>::value>*))[2];
...
#endif // MXASIO_DETAIL_IS_BUFFER_SEQUENCE_HPP

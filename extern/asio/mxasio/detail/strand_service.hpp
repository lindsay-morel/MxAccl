...
#ifndef MXASIO_DETAIL_STRAND_SERVICE_HPP
#define MXASIO_DETAIL_STRAND_SERVICE_HPP
...
class strand_service
  : public mxasio::detail::service_base<strand_service>
{
private:
...
public:
  ...
  MXASIO_DECL explicit strand_service(mxasio::io_context& io_context);
  ...
  MXASIO_DECL bool running_in_this_thread(
      const implementation_type& impl) const;

private:
  // Helper function to dispatch a handler.
  MXASIO_DECL void do_dispatch(implementation_type& impl, operation* op);

  // Helper function to post a handler.
  MXASIO_DECL void do_post(implementation_type& impl,
      operation* op, bool is_continuation);

  MXASIO_DECL static void do_complete(void* owner,
      operation* base, const mxasio::error_code& ec,
...
#if defined(MXASIO_STRAND_IMPLEMENTATIONS)
  enum { num_implementations = MXASIO_STRAND_IMPLEMENTATIONS };
#else // defined(MXASIO_STRAND_IMPLEMENTATIONS)
  enum { num_implementations = 193 };
#endif // defined(MXASIO_STRAND_IMPLEMENTATIONS)

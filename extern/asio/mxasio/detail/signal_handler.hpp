...
#ifndef MXASIO_DETAIL_SIGNAL_HANDLER_HPP
#define MXASIO_DETAIL_SIGNAL_HANDLER_HPP
...
{
public:
  MXASIO_DEFINE_HANDLER_PTR(signal_handler);
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    detail::binder2<Handler, mxasio::error_code, int>
...
#endif // MXASIO_DETAIL_SIGNAL_HANDLER_HPP

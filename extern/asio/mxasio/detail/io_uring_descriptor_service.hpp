...
#ifndef MXASIO_DETAIL_IO_URING_DESCRIPTOR_SERVICE_HPP
#define MXASIO_DETAIL_IO_URING_DESCRIPTOR_SERVICE_HPP
...
#include "mxasio/detail/io_uring_descriptor_read_at_op.hpp"
#include "mxasio/detail/io_uring_descriptor_read_op.hpp"
#include "mxasio/detail/io_uring_descriptor_write_at_op.hpp"
#include "mxasio/detail/io_uring_descriptor_write_op.hpp"
...
public:
  ...
  // Constructor.
  MXASIO_DECL io_uring_descriptor_service(execution_context& context);
  ...
  MXASIO_DECL mxasio::error_code assign(implementation_type& impl,
  ...
  // Destroy a descriptor implementation.
  MXASIO_DECL mxasio::error_code close(implementation_type& impl,
      mxasio::error_code& ec);
  ...
  MXASIO_DECL native_handle_type release(implementation_type& impl);
  ...
  mxasio::error_code io_control(implementation_type& impl,
  ...
  mxasio::error_code non_blocking(implementation_type& impl,
  ...
  mxasio::error_code native_non_blocking(implementation_type& impl,
      bool mode, mxasio::error_code& ec)
  {
  ...
  mxasio::error_code wait(implementation_type& impl,
      posix::descriptor_base::wait_type w, mxasio::error_code& ec)
  {
    switch (w)
    {
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers&, mxasio::error_code& ec)
  {
      ...
      const null_buffers&, Handler& handler, const IoExecutor& io_ex)
  {
    ...
    MXASIO_HANDLER_CREATION((io_uring_service_.context(),
  ...
  size_t write_some_at(implementation_type& impl, uint64_t,
      const null_buffers& buffers, mxasio::error_code& ec)
  {
...
private:
  ...
  MXASIO_DECL void start_op(implementation_type& impl, int op_type,
...
#endif // MXASIO_DETAIL_IO_URING_DESCRIPTOR_SERVICE_HPP

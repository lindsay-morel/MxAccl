...
#ifndef MXASIO_DETAIL_WIN_OBJECT_HANDLE_SERVICE_HPP
#define MXASIO_DETAIL_WIN_OBJECT_HANDLE_SERVICE_HPP
...
#include "mxasio/detail/wait_handler.hpp"
...
public:
  ...
  // Constructor.
  MXASIO_DECL win_object_handle_service(execution_context& context);
  ...
  MXASIO_DECL void wait(implementation_type& impl,
      mxasio::error_code& ec);
      ...
      Handler& handler, const IoExecutor& io_ex)
  {
    ...
    MXASIO_HANDLER_CREATION((scheduler_.context(), *p.p, "object_handle",
...
private:
  ...
  MXASIO_DECL void start_wait_op(implementation_type& impl, wait_op* op);

  // Helper function to register a wait operation.
  MXASIO_DECL void register_wait_callback(
      implementation_type& impl, mutex::scoped_lock& lock);

  // Callback function invoked when the registered wait completes.
  static MXASIO_DECL VOID CALLBACK wait_callback(
...
#endif // MXASIO_DETAIL_WIN_OBJECT_HANDLE_SERVICE_HPP

...
#ifndef MXASIO_DETAIL_WIN_IOCP_SOCKET_ACCEPT_OP_HPP
#define MXASIO_DETAIL_WIN_IOCP_SOCKET_ACCEPT_OP_HPP
...
{
public:
  MXASIO_DEFINE_HANDLER_PTR(win_iocp_socket_accept_op);
  ...
  {
    mxasio::error_code ec(result_ec);
    ...
    if (owner)
    {
      ...
      if (ec == mxasio::error::connection_aborted
...
{
public:
  MXASIO_DEFINE_HANDLER_PTR(win_iocp_socket_move_accept_op);
...
#endif // MXASIO_DETAIL_WIN_IOCP_SOCKET_ACCEPT_OP_HPP

...
#ifndef MXASIO_DETAIL_WINRT_RESOLVER_SERVICE_HPP
#define MXASIO_DETAIL_WINRT_RESOLVER_SERVICE_HPP
...
#include "mxasio/detail/winrt_resolve_op.hpp"
...
public:
  ...
  results_type resolve(implementation_type&,
      const query_type& query, mxasio::error_code& ec)
  {
    try
    {
      ...
      Handler& handler, const IoExecutor& io_ex)
  {
    ...
    mxasio::post(io_ex, detail::bind_handler(handler, ec, results));
  }
...
#endif // MXASIO_DETAIL_WINRT_RESOLVER_SERVICE_HPP

...
#ifndef MXASIO_DETAIL_IO_URING_SOCKET_ACCEPT_OP_HPP
#define MXASIO_DETAIL_IO_URING_SOCKET_ACCEPT_OP_HPP
...
{
public:
  io_uring_socket_accept_op_base(const mxasio::error_code& success_ec,
...
{
public:
  MXASIO_DEFINE_HANDLER_PTR(io_uring_socket_accept_op);

  io_uring_socket_accept_op(const mxasio::error_code& success_ec,
      socket_type socket, socket_ops::state_type state, Socket& peer,
      const Protocol& protocol, typename Protocol::endpoint* peer_endpoint,
...
{
public:
  MXASIO_DEFINE_HANDLER_PTR(io_uring_socket_move_accept_op);

  io_uring_socket_move_accept_op(const mxasio::error_code& success_ec,
...
#endif // MXASIO_DETAIL_IO_URING_SOCKET_ACCEPT_OP_HPP

...
#ifndef MXASIO_DETAIL_RESOLVER_ENDPOINT_OP_HPP
#define MXASIO_DETAIL_RESOLVER_ENDPOINT_OP_HPP
...
{
public:
  MXASIO_DEFINE_HANDLER_PTR(resolve_endpoint_op);
...
#endif // MXASIO_DETAIL_RESOLVER_ENDPOINT_OP_HPP

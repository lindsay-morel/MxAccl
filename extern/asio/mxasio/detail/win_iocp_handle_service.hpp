...
#ifndef MXASIO_DETAIL_WIN_IOCP_HANDLE_SERVICE_HPP
#define MXASIO_DETAIL_WIN_IOCP_HANDLE_SERVICE_HPP
...
#include "mxasio/detail/win_iocp_handle_read_op.hpp"
#include "mxasio/detail/win_iocp_handle_write_op.hpp"
...
public:
  ...
  MXASIO_DECL win_iocp_handle_service(execution_context& context);
      ...
      Handler& handler, const IoExecutor& io_ex)
  {
    ...
    MXASIO_HANDLER_CREATION((iocp_service_.context(), *p.p, "handle", &impl,
...
private:
  ...
  MXASIO_DECL size_t do_write(implementation_type& impl,
      uint64_t offset, const mxasio::const_buffer& buffer,
      mxasio::error_code& ec);

  // Helper function to start a write operation.
  MXASIO_DECL void start_write_op(implementation_type& impl,
      uint64_t offset, const mxasio::const_buffer& buffer,
      operation* op);

  // Helper function to perform a synchronous write operation.
  MXASIO_DECL size_t do_read(implementation_type& impl,
      uint64_t offset, const mxasio::mutable_buffer& buffer,
      mxasio::error_code& ec);

  // Helper function to start a read operation.
  MXASIO_DECL void start_read_op(implementation_type& impl,
      uint64_t offset, const mxasio::mutable_buffer& buffer,
      operation* op);

  // Update the ID of the thread from which cancellation is safe.
  MXASIO_DECL void update_cancellation_thread_id(implementation_type& impl);

  // Helper function to close a handle when the associated object is being
  // destroyed.
  MXASIO_DECL void close_for_destruction(implementation_type& impl);
...
#endif // MXASIO_DETAIL_WIN_IOCP_HANDLE_SERVICE_HPP

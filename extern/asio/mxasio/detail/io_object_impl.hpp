...
#ifndef MXASIO_DETAIL_IO_OBJECT_IMPL_HPP
#define MXASIO_DETAIL_IO_OBJECT_IMPL_HPP
...
public:
  ...
  explicit io_object_impl(int, int, ExecutionContext& context)
    : service_(&mxasio::use_service<IoObjectService>(context)),
...
#endif // MXASIO_DETAIL_IO_OBJECT_IMPL_HPP

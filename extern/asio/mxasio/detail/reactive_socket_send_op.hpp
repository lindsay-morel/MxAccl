...
#ifndef MXASIO_DETAIL_REACTIVE_SOCKET_SEND_OP_HPP
#define MXASIO_DETAIL_REACTIVE_SOCKET_SEND_OP_HPP
...
{
public:
  reactive_socket_send_op_base(const mxasio::error_code& success_ec,
  ...
  static status do_perform(reactor_op* base)
  {
    ...
    MXASIO_HANDLER_REACTOR_OPERATION((*o, "non_blocking_send",
...
public:
  ...
  MXASIO_DEFINE_HANDLER_PTR(reactive_socket_send_op);

  reactive_socket_send_op(const mxasio::error_code& success_ec,
      socket_type socket, socket_ops::state_type state,
...
#endif // MXASIO_DETAIL_REACTIVE_SOCKET_SEND_OP_HPP

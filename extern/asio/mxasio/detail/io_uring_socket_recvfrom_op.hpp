...
#ifndef MXASIO_DETAIL_IO_URING_SOCKET_RECVFROM_OP_HPP
#define MXASIO_DETAIL_IO_URING_SOCKET_RECVFROM_OP_HPP
...
{
public:
  io_uring_socket_recvfrom_op_base(const mxasio::error_code& success_ec,
...
{
public:
  MXASIO_DEFINE_HANDLER_PTR(io_uring_socket_recvfrom_op);

  io_uring_socket_recvfrom_op(const mxasio::error_code& success_ec,
...
#endif // MXASIO_DETAIL_IO_URING_SOCKET_RECVFROM_OP_HPP

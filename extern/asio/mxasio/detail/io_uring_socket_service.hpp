...
#ifndef MXASIO_DETAIL_IO_URING_SOCKET_SERVICE_HPP
#define MXASIO_DETAIL_IO_URING_SOCKET_SERVICE_HPP
...
#include "mxasio/detail/io_uring_socket_accept_op.hpp"
#include "mxasio/detail/io_uring_socket_connect_op.hpp"
#include "mxasio/detail/io_uring_socket_recvfrom_op.hpp"
#include "mxasio/detail/io_uring_socket_sendto_op.hpp"
#include "mxasio/detail/io_uring_socket_service_base.hpp"
...
public:
  ...
  mxasio::error_code open(implementation_type& impl,
      const protocol_type& protocol, mxasio::error_code& ec)
  {
  ...
  mxasio::error_code bind(implementation_type& impl,
      const endpoint_type& endpoint, mxasio::error_code& ec)
  {
  ...
  mxasio::error_code set_option(implementation_type& impl,
      const Option& option, mxasio::error_code& ec)
  {
  ...
  mxasio::error_code get_option(const implementation_type& impl,
      Option& option, mxasio::error_code& ec) const
  {
  ...
  mxasio::error_code shutdown(base_implementation_type& impl,
      socket_base::shutdown_type what, mxasio::error_code& ec)
  {
  ...
  mxasio::error_code accept(implementation_type& impl,
      Socket& peer, endpoint_type* peer_endpoint, mxasio::error_code& ec)
  {
  ...
  mxasio::error_code connect(implementation_type& impl,
      const endpoint_type& peer_endpoint, mxasio::error_code& ec)
  {
...
#endif // MXASIO_DETAIL_IO_URING_SOCKET_SERVICE_HPP

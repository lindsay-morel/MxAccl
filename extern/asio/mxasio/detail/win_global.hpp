...
#ifndef MXASIO_DETAIL_WIN_GLOBAL_HPP
#define MXASIO_DETAIL_WIN_GLOBAL_HPP
...
template <typename T>
static_mutex win_global_impl<T>::mutex_ = MXASIO_STATIC_MUTEX_INIT;
...
#endif // MXASIO_DETAIL_WIN_GLOBAL_HPP

...
#ifndef MXASIO_READ_UNTIL_HPP
#define MXASIO_READ_UNTIL_HPP
...
#include "mxasio/detail/regex_fwd.hpp"
...
#include "mxasio/basic_streambuf_fwd.hpp"
...
struct is_match_condition
{
  ...
  enum
  {
    value = mxasio::is_function<remove_pointer_t<T>>::value
...
/**
 * @defgroup read_until mxasio::read_until
 *
 ...
 * std::size_t n = mxasio::read_until(s,
 *     mxasio::dynamic_buffer(data), '\n');
...
std::size_t read_until(SyncReadStream& s,
    ...
    char delim, mxasio::error_code& ec,
    constraint_t<
      is_dynamic_buffer_v1<decay_t<DynamicBuffer_v1>>::value
    > = 0,
    constraint_t<
...
std::size_t read_until(SyncReadStream& s,
    DynamicBuffer_v1&& buffers,
    MXASIO_STRING_VIEW_PARAM delim,
    constraint_t<
      is_dynamic_buffer_v1<decay_t<DynamicBuffer_v1>>::value
    > = 0,
    constraint_t<
 ...
 * @code std::string data;
 * std::size_t n = mxasio::read_until(s,
 *     mxasio::dynamic_buffer(data), boost::regex("\r\n"));
 * std::string line = data.substr(0, n);
 * data.erase(0, n); @endcode
 * After the @c read_until operation completes successfully, the string @c data
 * contains the delimiter:
...
template <typename SyncReadStream, typename DynamicBuffer_v1, typename Traits>
std::size_t read_until(SyncReadStream& s, DynamicBuffer_v1&& buffers,
    const boost::basic_regex<char, Traits>& expr, mxasio::error_code& ec,
    constraint_t<
      is_dynamic_buffer_v1<decay_t<DynamicBuffer_v1>>::value
    > = 0,
    constraint_t<
 ...
 * @code typedef mxasio::buffers_iterator<
 *     mxasio::const_buffers_1> iterator;
 *
 ...
 * ...
 * std::string data;
 * mxasio::read_until(s, data, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * mxasio::read_until(s, data, match_char('a'));
 * @endcode
 */
...
std::size_t read_until(SyncReadStream& s,
    DynamicBuffer_v1&& buffers,
    MatchCondition match_condition, mxasio::error_code& ec,
    constraint_t<
      is_match_condition<MatchCondition>::value
    > = 0,
    constraint_t<
 ...
 * @code mxasio::streambuf b;
 * mxasio::read_until(s, b, '\n');
 * std::istream is(&b);
 * std::string line;
...
std::size_t read_until(SyncReadStream& s,
    mxasio::basic_streambuf<Allocator>& b, char delim);
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    mxasio::basic_streambuf<Allocator>& b,
    MXASIO_STRING_VIEW_PARAM delim);
...
std::size_t read_until(SyncReadStream& s,
    mxasio::basic_streambuf<Allocator>& b,
    MXASIO_STRING_VIEW_PARAM delim, mxasio::error_code& ec);
 ...
 * @code mxasio::streambuf b;
 * mxasio::read_until(s, b, boost::regex("\r\n"));
 * std::istream is(&b);
 * std::string line;
 * std::getline(is, line); @endcode
 * After the @c read_until operation completes successfully, the buffer @c b
 ...
 * @code typedef mxasio::buffers_iterator<
 *     mxasio::streambuf::const_buffers_type> iterator;
 *
 * std::pair<iterator, bool>
 * match_whitespace(iterator begin, iterator end)
 * {
 ...
 * ...
 * mxasio::streambuf b;
 * mxasio::read_until(s, b, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * mxasio::streambuf b;
 * mxasio::read_until(s, b, match_char('a'));
 * @endcode
 */
template <typename SyncReadStream, typename Allocator, typename MatchCondition>
std::size_t read_until(SyncReadStream& s,
    mxasio::basic_streambuf<Allocator>& b, MatchCondition match_condition,
...
/*@}*/
/**
 * @defgroup async_read_until mxasio::async_read_until
 *
 ...
 * @code std::string data;
 * ...
 * void handler(const mxasio::error_code& e, std::size_t size)
 * {
 *   if (!e)
 *   {
 *     std::string line = data.substr(0, n);
 ...
 * }
 * ...
 * mxasio::async_read_until(s, data, '\n', handler); @endcode
 ...
 * ...
 * std::string data;
 * mxasio::async_read_until(s, data, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * mxasio::async_read_until(s, data, match_char('a'), handler);
 * @endcode
 *
 * @par Per-Operation Cancellation
 * This asynchronous operation supports cancellation for the following
 ...
 * }
 * ...
 * mxasio::async_read_until(s, b, boost::regex("\r\n"), handler); @endcode
 * After the @c async_read_until operation completes successfully, the buffer
 ...
 * ...
 * mxasio::streambuf b;
 * mxasio::async_read_until(s, b, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * mxasio::streambuf b;
 * mxasio::async_read_until(s, b, match_char('a'), handler);
 * @endcode
 *
 * @par Per-Operation Cancellation
 * This asynchronous operation supports cancellation for the following
...
#include "mxasio/impl/read_until.hpp"

#endif // MXASIO_READ_UNTIL_HPP

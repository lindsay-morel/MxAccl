...
#ifndef MXASIO_READ_AT_HPP
#define MXASIO_READ_AT_HPP
...
/**
 * @defgroup read_at mxasio::read_at
 *
 ...
 * @code mxasio::read_at(d, 42, mxasio::buffer(data, size)); @endcode
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code mxasio::read_at(d, 42, mxasio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_read_at mxasio::async_read_at
 *
 ...
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code
 * mxasio::async_read_at(d, 42, mxasio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code mxasio::async_read_at(d, 42,
...
#include "mxasio/impl/read_at.hpp"

#endif // MXASIO_READ_AT_HPP

...
#ifndef MXASIO_EXECUTION_BLOCKING_HPP
#define MXASIO_EXECUTION_BLOCKING_HPP
...
#include "mxasio/traits/execute_member.hpp"
#include "mxasio/traits/query_free.hpp"
#include "mxasio/traits/query_member.hpp"
#include "mxasio/traits/query_static_constexpr_member.hpp"
#include "mxasio/traits/static_query.hpp"
#include "mxasio/traits/static_require.hpp"
...
struct blocking_t
{
...
#else // defined(MXASIO_HAS_DEDUCED_QUERY_MEMBER_TRAIT)
    typedef T type;
...
#else // defined(MXASIO_HAS_DEDUCED_QUERY_STATIC_CONSTEXPR_MEMBER_TRAIT)
    typedef T type;
  ...
  {
    return mxasio::query(ex, possibly_t());
  }
...
#endif // !defined(__clang__)
  {
    return mxasio::query(ex, always_t());
  }
...
#endif // !defined(__clang__)
  {
    return mxasio::query(ex, never_t());
  }

  MXASIO_STATIC_CONSTEXPR_DEFAULT_INIT(possibly_t, possibly);
  MXASIO_STATIC_CONSTEXPR_DEFAULT_INIT(always_t, always);
  MXASIO_STATIC_CONSTEXPR_DEFAULT_INIT(never_t, never);
...
public:
  ...
  {
    return mxasio::query(executor_, p);
  }
  ...
  {
    return mxasio::require(executor_, possibly_t<I>());
  }
  ...
  {
    return mxasio::require(executor_, never_t<I>());
  }
...
#if !defined(MXASIO_HAS_DEDUCED_REQUIRE_FREE_TRAIT)
...
#endif // !defined(MXASIO_HAS_DEDUCED_REQUIRE_FREE_TRAIT)
...
#if !defined(MXASIO_HAS_DEDUCED_PREFER_MEMBER_TRAIT)
...
#endif // !defined(MXASIO_HAS_DEDUCED_PREFER_MEMBER_TRAIT)
...
#endif // MXASIO_EXECUTION_BLOCKING_HPP

...
#ifndef MXASIO_EXECUTION_MAPPING_HPP
#define MXASIO_EXECUTION_MAPPING_HPP
...
struct mapping_t
{
  ...
  {
    return mxasio::query(ex, thread_t());
  }
...
#endif // !defined(__clang__)
  {
    return mxasio::query(ex, new_thread_t());
  }
...
#endif // !defined(__clang__)
  {
    return mxasio::query(ex, other_t());
  }

  MXASIO_STATIC_CONSTEXPR_DEFAULT_INIT(thread_t, thread);
  MXASIO_STATIC_CONSTEXPR_DEFAULT_INIT(new_thread_t, new_thread);
  MXASIO_STATIC_CONSTEXPR_DEFAULT_INIT(other_t, other);
...
#endif // MXASIO_EXECUTION_MAPPING_HPP

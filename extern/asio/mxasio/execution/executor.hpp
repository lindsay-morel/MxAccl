...
#ifndef MXASIO_EXECUTION_EXECUTOR_HPP
#define MXASIO_EXECUTION_EXECUTOR_HPP
...
#include "mxasio/traits/equality_comparable.hpp"
#include "mxasio/traits/execute_member.hpp"

#if defined(MXASIO_HAS_DEDUCED_EXECUTE_MEMBER_TRAIT) \
  && defined(MXASIO_HAS_DEDUCED_EQUALITY_COMPARABLE_TRAIT)
# define MXASIO_HAS_DEDUCED_EXECUTION_IS_EXECUTOR_TRAIT 1
...
template <typename T>
MXASIO_CONCEPT executor = is_executor<T>::value;

#define MXASIO_EXECUTION_EXECUTOR ::mxasio::execution::executor

#else // defined(MXASIO_HAS_CONCEPTS)

#define MXASIO_EXECUTION_EXECUTOR typename
...
#endif // MXASIO_EXECUTION_EXECUTOR_HPP

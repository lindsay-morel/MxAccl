...
#ifndef MXASIO_EXECUTION_OUTSTANDING_WORK_HPP
#define MXASIO_EXECUTION_OUTSTANDING_WORK_HPP
...
struct outstanding_work_t
{
  ...
  {
    return mxasio::query(ex, untracked_t());
  }
...
#endif // !defined(__clang__)
  {
    return mxasio::query(ex, tracked_t());
  }

  MXASIO_STATIC_CONSTEXPR_DEFAULT_INIT(untracked_t, untracked);
  MXASIO_STATIC_CONSTEXPR_DEFAULT_INIT(tracked_t, tracked);
...
#endif // MXASIO_EXECUTION_OUTSTANDING_WORK_HPP

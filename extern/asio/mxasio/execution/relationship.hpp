...
#ifndef MXASIO_EXECUTION_RELATIONSHIP_HPP
#define MXASIO_EXECUTION_RELATIONSHIP_HPP
...
#endif // !defined(__clang__)
  {
    return mxasio::query(ex, continuation_t());
  }

  MXASIO_STATIC_CONSTEXPR_DEFAULT_INIT(fork_t, fork);
  MXASIO_STATIC_CONSTEXPR_DEFAULT_INIT(continuation_t, continuation);
...
#endif // MXASIO_EXECUTION_RELATIONSHIP_HPP

...
#ifndef MXASIO_EXECUTION_BLOCKING_ADAPTATION_HPP
#define MXASIO_EXECUTION_BLOCKING_ADAPTATION_HPP
...
#include "mxasio/traits/prefer_member.hpp"
...
#include "mxasio/traits/require_member.hpp"
...
struct blocking_adaptation_t
{
  ...
  {
    return mxasio::query(ex, disallowed_t());
  }
...
#endif // !defined(__clang__)
  {
    return mxasio::query(ex, allowed_t());
  }

  MXASIO_STATIC_CONSTEXPR_DEFAULT_INIT(disallowed_t, disallowed);
  MXASIO_STATIC_CONSTEXPR_DEFAULT_INIT(allowed_t, allowed);
...
public:
  ...
  struct cleanup
  {
    ~cleanup()
    {
      mxasio::detail::mutex::scoped_lock lock(state_->mutex_);
...
#endif // MXASIO_EXECUTION_BLOCKING_ADAPTATION_HPP

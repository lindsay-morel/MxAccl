...
#ifndef MXASIO_DETACHED_HPP
#define MXASIO_DETACHED_HPP
 ...
 * @c mxasio::detached. For example:
 *
 * @code my_socket.async_send(my_buffer, mxasio::detached);
 * @endcode
 */
class detached_t
{
...
/**
 * See the documentation for mxasio::detached_t for a usage example.
 */
...
#include "mxasio/impl/detached.hpp"

#endif // MXASIO_DETACHED_HPP

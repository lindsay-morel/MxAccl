...
#ifndef MXASIO_IMPL_READ_AT_HPP
#define MXASIO_IMPL_READ_AT_HPP
...
namespace detail
{
      ...
      mxasio::error_code& ec)
  {
    ...
    mxasio::detail::consuming_buffers<mutable_buffer,
    ...
    uint64_t offset, const MutableBufferSequence& buffers)
{
  ...
  mxasio::detail::throw_error(ec, "read_at");
...
namespace detail
{
  ...
  public:
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      ...
      switch (start_ = start)
      {
        ...
        {
          {
            MXASIO_HANDLER_LOCATION((__FILE__, __LINE__, "async_read_at"));
  ...
  //private:
    typedef mxasio::detail::consuming_buffers<mutable_buffer,
...
inline auto async_read_at(AsyncRandomAccessReadDevice& d, uint64_t offset,
    mxasio::basic_streambuf<Allocator>& b, ReadToken&& token)
  -> decltype(
    async_initiate<ReadToken,
      void (mxasio::error_code, std::size_t)>(
        declval<detail::initiate_async_read_at_streambuf<

...
#ifndef MXASIO_IMPL_DETACHED_HPP
#define MXASIO_IMPL_DETACHED_HPP
...
{
  typedef mxasio::detail::detached_handler completion_handler_type;
...
#endif // MXASIO_IMPL_DETACHED_HPP

...
#ifndef MXASIO_IMPL_EXECUTION_CONTEXT_IPP
#define MXASIO_IMPL_EXECUTION_CONTEXT_IPP
...
execution_context::execution_context()
  : service_registry_(new mxasio::detail::service_registry(*this))
{
}
...
void execution_context::notify_fork(
    mxasio::execution_context::fork_event event)
{
...
#endif // MXASIO_IMPL_EXECUTION_CONTEXT_IPP

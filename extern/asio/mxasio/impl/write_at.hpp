...
#ifndef MXASIO_IMPL_WRITE_AT_HPP
#define MXASIO_IMPL_WRITE_AT_HPP
...
#include "mxasio/detail/base_from_completion_cond.hpp"
#include "mxasio/detail/bind_handler.hpp"
#include "mxasio/detail/consuming_buffers.hpp"
#include "mxasio/detail/dependent_type.hpp"
...
namespace detail
{
      ...
      mxasio::error_code& ec)
  {
    ...
    mxasio::detail::consuming_buffers<const_buffer,
...
std::size_t write_at(SyncRandomAccessWriteDevice& d,
    uint64_t offset, const ConstBufferSequence& buffers,
    CompletionCondition completion_condition, mxasio::error_code& ec)
{
  return detail::write_at_buffer_sequence(d, offset, buffers,
      mxasio::buffer_sequence_begin(buffers),
    ...
    uint64_t offset, const ConstBufferSequence& buffers)
{
  ...
  mxasio::detail::throw_error(ec, "write_at");
...
template <typename SyncRandomAccessWriteDevice, typename Allocator,
    typename CompletionCondition>
std::size_t write_at(SyncRandomAccessWriteDevice& d,
    uint64_t offset, mxasio::basic_streambuf<Allocator>& b,
    CompletionCondition completion_condition, mxasio::error_code& ec)
{
...
namespace detail
{
  ...
  public:
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      ...
      switch (start_ = start)
      {
        ...
        {
          {
            MXASIO_HANDLER_LOCATION((__FILE__, __LINE__, "async_write_at"));
  ...
  //private:
    typedef mxasio::detail::consuming_buffers<const_buffer,
...
namespace detail
{
  ...
  public:
    write_at_streambuf_op(
        mxasio::basic_streambuf<Allocator>& streambuf,
        WriteHandler& handler)
  ...
  //private:
    mxasio::basic_streambuf<Allocator>& streambuf_;
    WriteHandler handler_;
  };
...
#endif // MXASIO_IMPL_WRITE_AT_HPP

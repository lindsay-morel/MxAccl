...
#ifndef MXASIO_IMPL_READ_UNTIL_HPP
#define MXASIO_IMPL_READ_UNTIL_HPP
...
#include "mxasio/detail/base_from_cancellation_state.hpp"
    ...
    >)
{
  ...
  mxasio::detail::throw_error(ec, "read_until");
...
template <typename SyncReadStream, typename DynamicBuffer_v2>
inline std::size_t read_until(SyncReadStream& s,
    DynamicBuffer_v2 buffers, MXASIO_STRING_VIEW_PARAM delim,
    constraint_t<
      is_dynamic_buffer_v2<DynamicBuffer_v2>::value
    >)
{
...
namespace detail
{
  ...
  public:
    ...
    void operator()(mxasio::error_code ec,
        ...
        DynamicBuffer_v1, ReadHandler>* this_handler)
  {
    return this_handler->start_ == 0 ? true
      : mxasio_handler_cont_helpers::is_continuation(
      ...
      read_until_delim_op_v1<AsyncReadStream,
        decay_t<DynamicBuffer_v1>,
          decay_t<ReadHandler>>(
            ...
            delim, handler2.value)(mxasio::error_code(), 0, 1);
    }
...
inline auto async_read_until(AsyncReadStream& s, DynamicBuffer_v1&& buffers,
    MXASIO_STRING_VIEW_PARAM delim, ReadToken&& token,
    constraint_t<
      is_dynamic_buffer_v1<decay_t<DynamicBuffer_v1>>::value
    >,
    constraint_t<
      ...
      read_until_expr_op_v1<AsyncReadStream,
        decay_t<DynamicBuffer_v1>,
          RegEx, decay_t<ReadHandler>>(
            stream_, static_cast<DynamicBuffer_v1&&>(buffers),
            expr, handler2.value)(mxasio::error_code(), 0, 1);
    }
      ...
      read_until_match_op_v1<AsyncReadStream,
        decay_t<DynamicBuffer_v1>,
          MatchCondition, decay_t<ReadHandler>>(
            stream_, static_cast<DynamicBuffer_v1&&>(buffers),
            match_condition, handler2.value)(mxasio::error_code(), 0, 1);
    }
...
template <typename AsyncReadStream, typename Allocator,
    MXASIO_COMPLETION_TOKEN_FOR(void (mxasio::error_code,
      std::size_t)) ReadToken>
inline auto async_read_until(AsyncReadStream& s,
    mxasio::basic_streambuf<Allocator>& b, char delim, ReadToken&& token)
  -> decltype(
    async_initiate<ReadToken,
      void (mxasio::error_code, std::size_t)>(
        declval<detail::initiate_async_read_until_delim_v1<AsyncReadStream>>(),
...
#endif // MXASIO_IMPL_READ_UNTIL_HPP

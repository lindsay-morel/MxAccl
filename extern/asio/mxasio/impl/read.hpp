...
#ifndef MXASIO_IMPL_READ_HPP
#define MXASIO_IMPL_READ_HPP
    ...
    >)
{
  ...
  mxasio::detail::throw_error(ec, "read");
  ...
  public:
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      ...
      switch (start_ = start)
      {
        ...
        {
          {
            MXASIO_HANDLER_LOCATION((__FILE__, __LINE__, "async_read"));

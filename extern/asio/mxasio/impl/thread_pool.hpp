...
#ifndef MXASIO_IMPL_THREAD_POOL_HPP
#define MXASIO_IMPL_THREAD_POOL_HPP

#if defined(_MSC_VER) && (_MSC_VER >= 1200)
# pragma once
#endif // defined(_MSC_VER) && (_MSC_VER >= 1200)

#include "mxasio/detail/blocking_executor_op.hpp"
    ...
    Bits>::do_execute(Function&& f, false_type) const
{
  ...
  {
    MXASIO_HANDLER_CREATION((*pool_, *p.p,
    ...
    Bits>::do_execute(Function&& f, true_type) const
{
  ...
  MXASIO_HANDLER_CREATION((*pool_, op,
...
#endif // MXASIO_IMPL_THREAD_POOL_HPP

...
#ifndef MXASIO_IMPL_SERIAL_PORT_BASE_IPP
#define MXASIO_IMPL_SERIAL_PORT_BASE_IPP
...
MXASIO_SYNC_OP_VOID serial_port_base::baud_rate::store(
    MXASIO_OPTION_STORAGE& storage, mxasio::error_code& ec) const
{
...
MXASIO_SYNC_OP_VOID serial_port_base::baud_rate::load(
    const MXASIO_OPTION_STORAGE& storage, mxasio::error_code& ec)
{
#if defined(MXASIO_WINDOWS) || defined(__CYGWIN__)
...
MXASIO_SYNC_OP_VOID serial_port_base::flow_control::store(
    MXASIO_OPTION_STORAGE& storage, mxasio::error_code& ec) const
{
#if defined(MXASIO_WINDOWS) || defined(__CYGWIN__)
...
MXASIO_SYNC_OP_VOID serial_port_base::flow_control::load(
    const MXASIO_OPTION_STORAGE& storage, mxasio::error_code& ec)
{
#if defined(MXASIO_WINDOWS) || defined(__CYGWIN__)
...
MXASIO_SYNC_OP_VOID serial_port_base::parity::store(
    MXASIO_OPTION_STORAGE& storage, mxasio::error_code& ec) const
{
#if defined(MXASIO_WINDOWS) || defined(__CYGWIN__)
  switch (value_)
...
MXASIO_SYNC_OP_VOID serial_port_base::parity::load(
    const MXASIO_OPTION_STORAGE& storage, mxasio::error_code& ec)
{
#if defined(MXASIO_WINDOWS) || defined(__CYGWIN__)
...
MXASIO_SYNC_OP_VOID serial_port_base::stop_bits::store(
    MXASIO_OPTION_STORAGE& storage, mxasio::error_code& ec) const
{
#if defined(MXASIO_WINDOWS) || defined(__CYGWIN__)
  switch (value_)
...
MXASIO_SYNC_OP_VOID serial_port_base::stop_bits::load(
    const MXASIO_OPTION_STORAGE& storage, mxasio::error_code& ec)
{
#if defined(MXASIO_WINDOWS) || defined(__CYGWIN__)
...
MXASIO_SYNC_OP_VOID serial_port_base::character_size::store(
    MXASIO_OPTION_STORAGE& storage, mxasio::error_code& ec) const
{
#if defined(MXASIO_WINDOWS) || defined(__CYGWIN__)
...
MXASIO_SYNC_OP_VOID serial_port_base::character_size::load(
    const MXASIO_OPTION_STORAGE& storage, mxasio::error_code& ec)
{
#if defined(MXASIO_WINDOWS) || defined(__CYGWIN__)
...
#endif // MXASIO_IMPL_SERIAL_PORT_BASE_IPP

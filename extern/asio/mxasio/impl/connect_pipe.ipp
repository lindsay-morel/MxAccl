...
#ifndef MXASIO_IMPL_CONNECT_PIPE_IPP
#define MXASIO_IMPL_CONNECT_PIPE_IPP
...
void create_pipe(native_pipe_handle p[2], mxasio::error_code& ec)
{
#if defined(MXASIO_HAS_IOCP)
...
#endif // MXASIO_IMPL_CONNECT_PIPE_IPP

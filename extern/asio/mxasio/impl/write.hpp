...
#ifndef MXASIO_IMPL_WRITE_HPP
#define MXASIO_IMPL_WRITE_HPP
    ...
    >)
{
  ...
  mxasio::detail::throw_error(ec, "write");
  ...
  public:
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      ...
      switch (start_ = start)
      {
        ...
        {
          {
            MXASIO_HANDLER_LOCATION((__FILE__, __LINE__, "async_write"));

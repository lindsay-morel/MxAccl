...
#ifndef MXASIO_IMPL_ERROR_CODE_IPP
#define MXASIO_IMPL_ERROR_CODE_IPP
...
# include <string>
#endif
#include "mxasio/detail/local_free_on_block_exit.hpp"
...
public:
  ...
  {
#if defined(MXASIO_WINDOWS_RUNTIME) || defined(MXASIO_WINDOWS_APP)
    ...
    if (length)
      ...
      return "asio.system error";
#else // defined(MXASIO_WINDOWS_DESKTOP) || defined(__CYGWIN__)
#if !defined(__sun)
    if (value == ECANCELED)
...
#endif
#endif // defined(MXASIO_WINDOWS_DESKTOP) || defined(__CYGWIN__)
  }

#if defined(MXASIO_HAS_STD_ERROR_CODE)
...
#endif // defined(MXASIO_HAS_STD_ERROR_CODE)
...
#endif // MXASIO_IMPL_ERROR_CODE_IPP

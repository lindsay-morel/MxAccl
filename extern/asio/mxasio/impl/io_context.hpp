...
#ifndef MXASIO_IMPL_IO_CONTEXT_HPP
#define MXASIO_IMPL_IO_CONTEXT_HPP

#if defined(_MSC_VER) && (_MSC_VER >= 1200)
# pragma once
#endif // defined(_MSC_VER) && (_MSC_VER >= 1200)

#include "mxasio/detail/completion_handler.hpp"
#include "mxasio/detail/executor_op.hpp"
...
struct io_context::initiate_dispatch
{
      ...
      io_context* self) const
  {
    ...
    else
    {
      ...
      MXASIO_HANDLER_CREATION((*self, *p.p,
...
struct io_context::initiate_post
{
      ...
      io_context* self) const
  {
    ...
    bool is_continuation =
      mxasio_handler_cont_helpers::is_continuation(handler2.value);
    ...
    Function&& f) const
{
  ...
  MXASIO_HANDLER_CREATION((*context_ptr(), *p.p,
...
#if !defined(MXASIO_NO_DEPRECATED)
inline io_context::work::work(mxasio::io_context& io_context)
...
inline mxasio::io_context& io_context::work::get_io_context()
{
  return static_cast<mxasio::io_context&>(io_context_impl_.context());
}
#endif // !defined(MXASIO_NO_DEPRECATED)

inline mxasio::io_context& io_context::service::get_io_context()
{
  return static_cast<mxasio::io_context&>(context());
}
...
#endif // MXASIO_IMPL_IO_CONTEXT_HPP

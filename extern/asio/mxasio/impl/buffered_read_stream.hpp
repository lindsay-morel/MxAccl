...
#ifndef MXASIO_IMPL_BUFFERED_READ_STREAM_HPP
#define MXASIO_IMPL_BUFFERED_READ_STREAM_HPP
...
template <typename Stream>
std::size_t buffered_read_stream<Stream>::fill(mxasio::error_code& ec)
{
  detail::buffer_resize_guard<detail::buffered_stream_storage>
    resize_guard(storage_);
  std::size_t previous_size = storage_.size();
...
namespace detail
{
  ...
  public:
        ...
        const MutableBufferSequence& buffers) const
    {
      ...
      {
        next_layer_.async_read_some(MXASIO_MUTABLE_BUFFER(0, 0),
...
#endif // MXASIO_IMPL_BUFFERED_READ_STREAM_HPP

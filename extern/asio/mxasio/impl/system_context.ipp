...
#ifndef MXASIO_IMPL_SYSTEM_CONTEXT_IPP
#define MXASIO_IMPL_SYSTEM_CONTEXT_IPP
...
detail::scheduler& system_context::add_scheduler(detail::scheduler* s)
{
  ...
  mxasio::add_service<detail::scheduler>(*this, scoped_impl.get());
...
#endif // MXASIO_IMPL_SYSTEM_CONTEXT_IPP

...
#ifndef MXASIO_IMPL_CONNECT_HPP
#define MXASIO_IMPL_CONNECT_HPP
...
namespace detail
{
  struct default_connect_condition
  {
    ...
    bool operator()(const mxasio::error_code&, const Endpoint&)
    {
      return true;
    }
  };
  ...
  inline typename Protocol::endpoint deref_connect_result(
      Iterator iter, mxasio::error_code& ec)
  {
    ...
    static const bool value =
      sizeof(asio_connect_condition_check(
        (declval<legacy_connect_condition_helper<T, Iterator>>())(
          declval<const mxasio::error_code>(),
  ...
  inline Iterator call_connect_condition(ConnectCondition& connect_condition,
      const mxasio::error_code& ec, Iterator next, Iterator end,
...
namespace detail
{
  ...
  protected:
    ...
    void check_condition(const mxasio::error_code& ec,
  ...
  protected:
    ...
    template <typename Iterator>
    void check_condition(const mxasio::error_code&, Iterator&, Iterator&)
    {
    }
  };
  ...
  public:
    ...
    void operator()(mxasio::error_code ec, int start = 0)
    {
  ...
  //private:
    template <typename Iterator>
    void process(mxasio::error_code ec,
        int start, Iterator begin, Iterator end)
    {
      ...
      switch (start_ = start)
      {
        ...
        for (;;)
        {
          ...
          {
            socket_.close(ec);
            MXASIO_HANDLER_LOCATION((__FILE__, __LINE__, "async_connect"));
          ...
          if (start)
          {
            ec = mxasio::error::not_found;
            MXASIO_HANDLER_LOCATION((__FILE__, __LINE__, "async_connect"));
            mxasio::post(socket_.get_executor(),
                detail::bind_handler(
        ...
        static_cast<RangeConnectHandler&&>(handler_)(
            static_cast<const mxasio::error_code&>(ec),
  ...
  public:
        ...
        const ConnectCondition& connect_condition) const
    {
      ...
      // RangeConnectHandler.
      MXASIO_RANGE_CONNECT_HANDLER_CHECK(RangeConnectHandler,
      ...
      range_connect_op<Protocol, Executor, EndpointSequence, ConnectCondition,
        decay_t<RangeConnectHandler>>(socket_, endpoints,
          connect_condition, handler2.value)(mxasio::error_code(), 1);
    }
  ...
  public:
        ...
        const ConnectCondition& connect_condition) const
    {
      ...
      MXASIO_ITERATOR_CONNECT_HANDLER_CHECK(

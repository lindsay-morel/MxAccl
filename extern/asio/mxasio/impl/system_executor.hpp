...
#ifndef MXASIO_IMPL_SYSTEM_EXECUTOR_HPP
#define MXASIO_IMPL_SYSTEM_EXECUTOR_HPP
...
#include "mxasio/detail/global.hpp"
    ...
    Function&& f, execution::blocking_t::never_t) const
{
  ...
  {
    MXASIO_HANDLER_CREATION((ctx, *p.p,
...
#endif // MXASIO_IMPL_SYSTEM_EXECUTOR_HPP

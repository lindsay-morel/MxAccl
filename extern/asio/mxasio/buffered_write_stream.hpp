...
#ifndef MXASIO_BUFFERED_WRITE_STREAM_HPP
#define MXASIO_BUFFERED_WRITE_STREAM_HPP
...
public:
  ...
  /// error occurred.
  std::size_t flush(mxasio::error_code& ec);
...
#include "mxasio/impl/buffered_write_stream.hpp"

#endif // MXASIO_BUFFERED_WRITE_STREAM_HPP

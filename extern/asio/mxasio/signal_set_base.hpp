...
#ifndef MXASIO_SIGNAL_SET_BASE_HPP
#define MXASIO_SIGNAL_SET_BASE_HPP
...
# if defined(GENERATING_DOCUMENTATION)
  ...
  {
    none = 0,
    restart = MXASIO_OS_DEF(SA_RESTART),
    no_child_stop = MXASIO_OS_DEF(SA_NOCLDSTOP),
    no_child_wait = MXASIO_OS_DEF(SA_NOCLDWAIT),
    dont_care = -1
  };
...
#endif // MXASIO_SIGNAL_SET_BASE_HPP

...
#ifndef MXASIO_DEFER_HPP
#define MXASIO_DEFER_HPP
...
#include "mxasio/detail/initiate_defer.hpp"
 ...
 * @code void() @endcode
 */
template <MXASIO_COMPLETION_TOKEN_FOR(void()) NullaryToken>
...
template <typename Executor,
    MXASIO_COMPLETION_TOKEN_FOR(void()) NullaryToken

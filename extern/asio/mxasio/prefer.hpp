...
#ifndef MXASIO_PREFER_HPP
#define MXASIO_PREFER_HPP
...
#include "mxasio/traits/prefer_free.hpp"
#include "mxasio/traits/prefer_member.hpp"
#include "mxasio/traits/require_free.hpp"
 ...
 * expression <tt>mxasio::prefer(E, P0, Pn...)</tt> for some subexpressions
 ...
 *   <tt>mxasio::prefer(E, P0, Pn...)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise,
 *   <tt>mxasio::prefer(mxasio::prefer(E, P0), Pn...)</tt>
 *   if <tt>N > 0</tt> and the expression
 *   <tt>mxasio::prefer(mxasio::prefer(E, P0), Pn...)</tt>
 *   is a valid expression.
 *
 * @li Otherwise, <tt>mxasio::prefer(E, P0, Pn...)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>mxasio::prefer(std::declval<T>(),
 ...
 * type of the expression <tt>mxasio::prefer(std::declval<T>(),
...
namespace mxasio_prefer_fn {

using mxasio::conditional_t;
using mxasio::decay_t;
using mxasio::declval;
using mxasio::enable_if_t;
using mxasio::is_applicable_property;
using mxasio::traits::prefer_free;
using mxasio::traits::prefer_member;
using mxasio::traits::require_free;
using mxasio::traits::require_member;
using mxasio::traits::static_require;
...
struct impl
{
  ...
  && defined(MXASIO_HAS_DEDUCED_PREFER_MEMBER_TRAIT)
    struct type
    {
      template <typename P>
      auto require(P&& p)
...
#else // defined(MXASIO_HAS_DEDUCED_REQUIRE_MEMBER_TRAIT)
      //   && defined(MXASIO_HAS_DEDUCED_PREFER_MEMBER_TRAIT)
    typedef T type;
  ...
  MXASIO_NODISCARD constexpr enable_if_t<
...
static constexpr const mxasio_prefer_fn::impl&
  prefer = mxasio_prefer_fn::static_instance<>::instance;

} // namespace

typedef mxasio_prefer_fn::impl prefer_t;

template <typename T, typename... Properties>
struct can_prefer :
  integral_constant<bool,
    mxasio_prefer_fn::call_traits<
      prefer_t, T, void(Properties...)>::overload
        != mxasio_prefer_fn::ill_formed>
{
};
...
struct prefer_result
{
  typedef typename mxasio_prefer_fn::call_traits<

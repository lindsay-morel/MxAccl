...
#ifndef MXASIO_ANY_COMPLETION_HANDLER_HPP
#define MXASIO_ANY_COMPLETION_HANDLER_HPP
  ...
  struct uninit_deleter
  {
    typename std::allocator_traits<
      associated_allocator_t<Handler,
        mxasio::recycling_allocator<void>>>::template
  ...
  static any_completion_handler_impl* create(S&& slot, H&& h)
  {
    uninit_deleter d{
        (get_associated_allocator)(h,
          mxasio::recycling_allocator<void>())};
...
#endif // MXASIO_ANY_COMPLETION_HANDLER_HPP

...
#ifndef MXASIO_BASIC_READABLE_PIPE_HPP
#define MXASIO_BASIC_READABLE_PIPE_HPP
...
public:
   ...
   * @code
   * basic_readable_pipe.read_some(mxasio::buffer(data, size));
   * @endcode
...
#endif // MXASIO_BASIC_READABLE_PIPE_HPP

...
#ifndef MXASIO_SYSTEM_EXECUTOR_HPP
#define MXASIO_SYSTEM_EXECUTOR_HPP
...
private:
   ...
   *
   * For example:
   * @code mxasio::system_executor ex1;
...
private:
   ...
   *
   * For example:
   * @code mxasio::system_executor ex;
   ...
   * For example:
   * @code mxasio::system_executor ex;
   * mxasio::system_context& pool = mxasio::query(
...
struct equality_comparable<
    mxasio::basic_system_executor<Blocking, Relationship, Allocator>
  >
{
  ...
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
  typedef mxasio::basic_system_executor<
      mxasio::execution::blocking_t::possibly_t,
  ...
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
  typedef mxasio::basic_system_executor<Blocking,
      mxasio::execution::relationship_t::fork_t,
  ...
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
  typedef mxasio::system_context& result_type;
};
...
struct query_member<
    mxasio::basic_system_executor<Blocking, Relationship, Allocator>,
    mxasio::execution::allocator_t<Allocator>
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
...
#include "mxasio/impl/system_executor.hpp"

#endif // MXASIO_SYSTEM_EXECUTOR_HPP

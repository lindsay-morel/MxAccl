...
#ifndef MXASIO_POSIX_BASIC_DESCRIPTOR_HPP
#define MXASIO_POSIX_BASIC_DESCRIPTOR_HPP
...
public:
   ...
   */
  MXASIO_SYNC_OP_VOID assign(const native_handle_type& native_descriptor,
      mxasio::error_code& ec)
  {
   ...
   * mxasio::error::operation_aborted error.
   *
   ...
   * passed the mxasio::error::operation_aborted error.
   *
   * @throws mxasio::system_error Thrown on failure.
   */
  void cancel()
   ...
   * mxasio::posix::descriptor_base::bytes_readable @n
   * mxasio::posix::descriptor_base::non_blocking_io
   *
   * @par Example
   * Getting the number of bytes ready to read:
   * @code
   * mxasio::posix::stream_descriptor descriptor(my_context);
   * ...
   * mxasio::posix::stream_descriptor::bytes_readable command;
   ...
   * mxasio::posix::stream_descriptor descriptor(my_context);
   * ...
   * descriptor.wait(mxasio::posix::stream_descriptor::wait_read);
   * @endcode
   */
   ...
   * ...
   * mxasio::error_code ec;
   * descriptor.wait(mxasio::posix::stream_descriptor::wait_read, ec);
   * @endcode
   */
   ...
   *     mxasio::posix::stream_descriptor::wait_read,
   *     wait_handler);
   * @endcode
   *
   * @par Per-Operation Cancellation
   * This asynchronous operation supports cancellation for the following
   * mxasio::cancellation_type values:
   *
...
#endif // MXASIO_POSIX_BASIC_DESCRIPTOR_HPP

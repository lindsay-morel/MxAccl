...
#ifndef MXASIO_POSIX_DESCRIPTOR_BASE_HPP
#define MXASIO_POSIX_DESCRIPTOR_BASE_HPP
...
public:
   ...
   * ...
   * mxasio::descriptor_base::bytes_readable command(true);
...
#endif // MXASIO_POSIX_DESCRIPTOR_BASE_HPP

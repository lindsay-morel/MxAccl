...
#ifndef MXASIO_EXECUTOR_HPP
#define MXASIO_EXECUTOR_HPP
...
public:
   ...
   */
#if !defined(MXASIO_NO_TYPEID) || defined(GENERATING_DOCUMENTATION)
  const std::type_info& target_type() const noexcept
  {
    return impl_ ? impl_->target_type() : typeid(void);
  }
#else // !defined(MXASIO_NO_TYPEID) || defined(GENERATING_DOCUMENTATION)
  const void* target_type() const noexcept
  {
    return impl_ ? impl_->target_type() : 0;
  }
#endif // !defined(MXASIO_NO_TYPEID) || defined(GENERATING_DOCUMENTATION)
...
MXASIO_USES_ALLOCATOR(mxasio::executor)

#include "mxasio/detail/pop_options.hpp"

#include "mxasio/impl/executor.hpp"

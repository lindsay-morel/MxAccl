...
#ifndef MXASIO_THREAD_POOL_HPP
#define MXASIO_THREAD_POOL_HPP
...
#include "mxasio/detail/atomic_count.hpp"
#include "mxasio/detail/scheduler.hpp"
#include "mxasio/detail/thread_group.hpp"
 ...
 *
 * To submit functions to the thread pool, use the @ref mxasio::dispatch,
 ...
 * mxasio::thread_pool pool(4);
 *
 * // Submit a function to the pool.
 * mxasio::post(pool, my_task);
 *
...
public:
  ...
  MXASIO_DECL thread_pool();
#endif // !defined(MXASIO_NO_TS_EXECUTORS)

  /// Constructs a pool with a specified number of threads.
  MXASIO_DECL thread_pool(std::size_t num_threads);
...
private:
  ...
  MXASIO_DECL detail::scheduler& add_scheduler(detail::scheduler* s);
...
private:
  ...
  constexpr basic_executor_type<Allocator,
      MXASIO_UNSPECIFIED(Bits & ~blocking_mask)>
   ...
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = mxasio::require(ex1,
   *     mxasio::execution::blocking.always); @endcode
   */
  constexpr basic_executor_type<Allocator,
      MXASIO_UNSPECIFIED((Bits & ~blocking_mask) | blocking_always)>
...
private:
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * mxasio::thread_pool& pool = mxasio::query(
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * std::size_t occupancy = mxasio::query(
   *     ex, mxasio::execution::occupancy); @endcode
   */
...
struct equality_comparable<
    mxasio::thread_pool::basic_executor_type<Allocator, Bits>
  >
{
...
struct require_member<
  ...
  > : mxasio::detail::thread_pool_bits
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
  typedef mxasio::thread_pool::basic_executor_type<
...
struct require_member<
    mxasio::thread_pool::basic_executor_type<Allocator, Bits>,
    mxasio::execution::blocking_t::always_t
  > : mxasio::detail::thread_pool_bits
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
  typedef mxasio::thread_pool::basic_executor_type<Allocator,
  ...
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
  typedef mxasio::thread_pool& result_type;
};

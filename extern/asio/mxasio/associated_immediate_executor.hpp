...
#ifndef MXASIO_ASSOCIATED_IMMEDIATE_EXECUTOR_HPP
#define MXASIO_ASSOCIATED_IMMEDIATE_EXECUTOR_HPP
...
struct default_immediate_executor
{
  ...
  {
    return mxasio::require(e, execution::blocking.never);
  }
};
...
#endif // !defined(GENERATING_DOCUMENTATION)
{
  ...
  /// <tt>mxasio::require(ex, mxasio::execution::blocking.never)</tt>.
 ...
 */
template <typename T, typename Executor>
MXASIO_NODISCARD inline auto get_associated_immediate_executor(
...
MXASIO_NODISCARD inline typename associated_immediate_executor<T,
...
#endif // MXASIO_ASSOCIATED_IMMEDIATE_EXECUTOR_HPP

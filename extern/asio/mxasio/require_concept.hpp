...
#ifndef MXASIO_REQUIRE_CONCEPT_HPP
#define MXASIO_REQUIRE_CONCEPT_HPP
...
#include "mxasio/traits/require_concept_member.hpp"
#include "mxasio/traits/require_concept_free.hpp"
#include "mxasio/traits/static_require_concept.hpp"
 ...
 * expression <tt>mxasio::require_concept(E, P)</tt> for some
 ...
 *   with value <tt>true</tt>, <tt>mxasio::require_concept(E, P)</tt> is
 *   ill-formed.
 *
 ...
 *
 * @li Otherwise, <tt>mxasio::require_concept(E, P)</tt> is ill-formed.
 */
 ...
 * <tt>mxasio::require_concept(std::declval<T>(),
...
namespace mxasio_require_concept_fn {
...
using mxasio::traits::require_concept_free;
using mxasio::traits::require_concept_member;
using mxasio::traits::static_require_concept;
...
struct impl
{
  ...
  struct proxy
  {
#if defined(MXASIO_HAS_DEDUCED_REQUIRE_CONCEPT_MEMBER_TRAIT)
    struct type
    {
      template <typename P>
...
#else // defined(MXASIO_HAS_DEDUCED_REQUIRE_CONCEPT_MEMBER_TRAIT)
    typedef T type;
#endif // defined(MXASIO_HAS_DEDUCED_REQUIRE_CONCEPT_MEMBER_TRAIT)
  };
...
static constexpr const mxasio_require_concept_fn::impl&
  require_concept = mxasio_require_concept_fn::static_instance<>::instance;

} // namespace

typedef mxasio_require_concept_fn::impl require_concept_t;

template <typename T, typename Property>
struct can_require_concept :
  integral_constant<bool,
    mxasio_require_concept_fn::call_traits<
      require_concept_t, T, void(Property)>::overload !=
        mxasio_require_concept_fn::ill_formed>
{
};
...
struct require_concept_result
{
  typedef typename mxasio_require_concept_fn::call_traits<
...
#endif // MXASIO_REQUIRE_CONCEPT_HPP
